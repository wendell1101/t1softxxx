 ...
 */
//$parent_id = 0; // for Level 0 agents
$parent_name = $conditions['parent_name'];
?>

<!-- form create-agent {{{1 -->
<form method="POST" id="agency_main_form"
    action="<?=site_url('agency/verify_batch_agents')?>" accept-charset="utf-8">
        ...
        <div class="panel panel-body" id="create-agent_panel_body">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-6" style="padding: 10px;">
                    <?php $reset_url=site_url('agency/batch_create_sub_agent/'.$conditions['parent_id']);?>
