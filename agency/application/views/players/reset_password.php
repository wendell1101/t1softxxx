<div class="content-container">
    <div class="panel panel-primary">
        <div class="panel-heading">
            ...
            <a href="<?= BASEURL . 'agency/player_information/' . $player_id ?>" 
        ...
        <div class="panel panel-body" id="player_panel_body">
            <form method="POST" action="<?= BASEURL . 'agency/verify_reset_player_password/' . $player_id ?>" 
                autocomplete="off">
                    ...
                    <div class="col-md-offset-3 col-md-6">
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                <input type="hidden" name="player_id" id="player_id" class="form-control" value="<?= $player_id?>">
                            </table>
                            <center>
                                <a href="<?= BASEURL . 'agency/player_information/' . $player_id ?>" 
                                ...
                                <input type="submit" class="btn btn-info" value="<?= lang('lang.save'); ?>">
                            </center>
                        </div>
                    </div>
                </div>
