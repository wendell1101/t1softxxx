	...
	<div class="row">
		<div class="panel panel-primary">
			<div class="panel-heading">
				<h4 class="panel-title pull-left"><i class="glyphicon glyphicon-cog"></i> <?= lang('pay.modacc'); ?> </h4>
			...
			<div class="panel panel-body" id="info_panel_body">
				<form action="<?= BASEURL . 'affiliate/verifyModifyPayment/' . $payment['affiliatePaymentId'] ?>" method="POST">
					<div class="row">
