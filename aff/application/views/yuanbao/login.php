				...
				<div class="panel panel-primary">
					<div class="panel-heading">
						<h3 class="panel-title">
							<b>
								<img class="brand-img" width="49%" height="45" src="yuanbao/images/logo.png">
				                <?=lang('reg.affilate');?>
			                </b>
		                </h3>
					</div>
					<div class="panel-body">
						<?php if ($this->session->userdata('result')) {?>
					        <div class="alert alert-<?=$this->session->userdata('result')?> alert-dismissible" role="alert" style="background-color: #cfcfcf; border-color: #cfcfcf; color: #2c3e50;">
...
?>
						<form method="POST" action="<?=site_url('affiliate/login')?>">
							...
							<?php endif;?>
							<div class="form-group">
								<input type="submit" id="submit" class="btn btn-primary text-uppercase col-md-4 col-md-offset-4" value="<?=lang('lang.logIn');?>">
							</div>
						</form>
