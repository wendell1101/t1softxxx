	...
	<div class="row">
		<div class="panel panel-primary">
			<div class="panel-heading">
				...
				<!-- <button class="btn btn-info btn-xs pull-right" id="change_password_toggle"><span class="glyphicon-chevron-up glyphicon" id="button_span_password_up"></span></button> -->
			...
			<div class="panel panel-body" id="change_password_panel_body">
				<form method="POST" action="<?= BASEURL . 'affiliate/verifyChangePassword'?>" accept-charset="utf-8">
					<div class="row">
						<div class="col-md-12">
							<div class="col-md-4">
						...
						<center>
							<input type="submit" name="submit" id="submit" class="btn btn-primary" value="<?= lang('cp.changePass'); ?>">
						</center>
					</div>
				</form>
			</div>
