	...
	<div class="row">
		<div class="panel panel-primary">
			...
			<div class="panel panel-body">
				<form method="POST" action="<?= BASEURL . 'affiliate/verifyAddReadOnlyAccount'?>" accept-charset="utf-8">
					<div class="row">
						<div class="col-md-4">
							<label for="username"><?= lang('Username'); ?>: </label>
							<div class="input-group">
								<div class="input-group-addon"><?=$affiliate['username']?>_</div>
								<input type="text" name="username" id="username" class="form-control" placeholder="<?= lang('Username'); ?>" value="<?= set_value('username') ?>">
							</div>
