...
<style>
	...
	<?php if ($this->config->item('affiliate_view_template') == 'xcbet'): ?>
        .nav-head{
...
<nav class="navbar navbar-default" style="margin-bottom: 0px; border-radius: 0px;background-color: #434343;">
    <div class="container">
        <div class="navbar-header">
            <a class="navbar-brand" style='margin-top:-10px;' href="<?=site_url('affiliate')?>">
                ...
                <?php if($logo == '') { ?>
                    <img class="brand-img" style="display:inline;height: 215%;" src="../../xcbet/images/logo.png"> &nbsp&nbsp&nbsp&nbsp&nbsp<?=$site; ?>
                <?php } else { ?>
