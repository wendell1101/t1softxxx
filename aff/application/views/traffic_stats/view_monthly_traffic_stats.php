...
foreach ($stats as $value) {
	?>
										<tr>
											<td></td>
											<td class="input-sm"><a href="<?=BASEURL . 'affiliate/viewTrafficStatisticsWeekly/' . $value['first_date'] . "/" . $value['last_date']?>"><?=date('F Y', strtotime($value['first_date']))?></a></td>
