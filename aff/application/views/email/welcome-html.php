...
<br />
<big style="font: 16px/18px Arial, Helvetica, sans-serif;"><b><a href="<?= BASEURL ?>" style="color: #3366cc;">Go to <?php echo $site_name; ?> now!</a></b></big><br />
<br />
Link doesn't work? Copy the following link to your browser address bar:<br />
<nobr><a href="<?= BASEURL ?>" style="color: #3366cc;"><?= BASEURL ?></a></nobr><br />
<br />
<br />
