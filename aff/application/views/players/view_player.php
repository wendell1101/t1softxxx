		...
		<div class="panel panel-info">
			...
			<div class="panel panel-body" id="code_panel_body">
				<table class="table">
					<tbody>
						<tr>
							<th style="width:25%;"><?=lang('Fullname');?></th>
							<td style="width:25%;"><?=$player_account_info['lastName'];?><?=$player_account_info['firstName'];?></td>
							<th style="width:25%;"><?=lang('aff.as03');?></th>
							<td style="width:25%;"><?=empty($player_direct_affiliate) ? lang('N/A') :  $player_direct_affiliate ?></td>
						</tr>
						<tr>
...
function gamesHistory(player_id) {
    var dataTable = $('#gamehistory-table').DataTable({
        ...
        columnDefs: [
            ...
            { visible: false, targets: [ 0, 2, 3, 4, 5, 6, 7, 12, 15, 16, 19, 20, 21 ] }
        ],
        ...
        ajax: function (data, callback, settings) {
            ...
            $.post(base_url + 'api/gamesHistory/' + player_id + '/0/1', data, function(data) {
