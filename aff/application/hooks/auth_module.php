...
class Auth_module {
	...
	public function index() {
        ...
        $isSiteBlock = $this->CI->country_rules->getBlockedStatus($ip, 'is_affiliate');
        if ($isSiteBlock && $this->CI->utils->isEnabledFeature('enable_country_blocking_affiliate')) {
            ...
            $this->CI->utils->checkAffBlockIp();
            $this->CI->utils->logAffAction();
        }
	}
