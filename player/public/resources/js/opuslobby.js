...
$(function() {
    ...
    $("#cards_btn").click(function(){
       loadGames($("#cards_btn").attr('category'));
    });
    $("#vidpoker_btn").click(function(){
       loadGames($("#vidpoker_btn").attr('category'));
    });
    $("#jackpot_btn").click(function(){
       loadGames($("#jackpot_btn").attr('category'));
    });
    ...
    function loadGames(gameType){
        $.getJSON(host + '/game_description/allGames/'+OPUS_API+'/'+gameType, function(data) {
