...
$(function(){
	...
	$('.avatar').on('mouseover', function(){
		$(this).find('img').addClass('avatar_hover');
		$(this).find('span').removeClass('hide');
	}).mouseout(function(){
		$(this).find('img').removeClass('avatar_hover');
		$(this).find('span').addClass('hide');
	});

	generateUpgradeProgressBar();
...
function refreshMainBalance(){
	...
	$.ajax({
		url: base_url + 'api/refreshMainBalance', 
		type: 'GET',
		success: function(data){
			$('label[id="playerTotalBalance"]').html(data.rec);
		}
	});

}

function generateUpgradeProgressBar(){

	$.ajax({
		url: base_url + 'api/getVIPSettingRulesUpgrade', 
		type: 'GET',
		success: function(data){	
