...
class MY_Exceptions extends CI_Exceptions {
    ...
    {
        parent::__construct();
        log_message('error', 'MY_Exceptions.player.9.__construct'. $this->generateCallTrace());
    }
    public function show_wait_reload($wait_sec = 2){
        ...
        if($isAjaxCall){
            ...
            $this->CI->output->set_content_type('application/json')
                            /// 200, for dataTable in player site.
            ...
            $this->CI->output->set_header($_header)
                            ...
                            ->set_status_header(200) // the server is busy, overloaded, or down for maintenance
                            ->set_output($message);
        }
