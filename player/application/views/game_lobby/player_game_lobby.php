...
<body>
    ...
    <script type="text/javascript">
		...
		var cashier_link = <?= json_encode($cashier_link); ?>;
    	...
    	var disable_newtab= "<?=$disable_newtab ? '' : " target='_blank' ";?>";
		    		...
		    		$( ".game_container" ).append(  '<div data-aos-once="true" data-aos="zoom-in" data-aos-offset="200" data-aos-delay="100" class="game_item col-xl-2 col-lg-3 col-md-3 col-sm-6 col-xs-12">'+
													'<div class="game_thumb">'+
														...
														'<div class="game_hover">'+
															'<a '+disable_newtab+' class="real"  href="'+value.game_web_url+'">'+static_details.real+'</a>'+
															'<a '+disable_newtab+' class="trial '+value.display_trial+'" href="'+value.game_trial_url+'">'+static_details.demo+'</a>'+
														'</div>'+
													'</div>'+
												'</div>'
					);
