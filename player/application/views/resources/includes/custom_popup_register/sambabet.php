        ...
        <?php if ($this->operatorglobalsettings->getSettingJson('registered_success_popup') == 1) { ?>
            ...
            <div class="modal-title text-center">
                <div class="title">
                    ...
                    <p class="sec-title"><?=lang('Welcome to SAMBA, you can enjoy the following exclusive offers for new players! Go and collect your prize!');?></p>
            <?php } ?>
                </div>
            <div class="platforms">
                    ...
                    <div class="platform-item item2">
                        <div class="plat-title">
                            <p><?=lang('Single Deposit');?><span class="keypoints">≥R$20</span></p>
                        </div>
                        <div class="plat-details">
                            <p class="event-rate">15<span>%</span></p>
                            <p class="detail"><?=lang('First time only')?></p>
                        </div>
                    </div>
