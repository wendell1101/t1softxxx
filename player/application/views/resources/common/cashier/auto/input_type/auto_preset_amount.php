...
<script type="text/javascript">
	function add_preset_amount_buttons(val){
		if(enable_thousands_separator_in_the_deposit_amount){
	        $('input[name="thousands_separator_amount"]').val(val);
	        display_thousands_separator();
	    }
		$('.deposit-form input[name=deposit_amount]').val(val).change();
		$('#auto_payment_submit').attr('disabled', false);
	}

	function add_accumulate_preset_amount_buttons(val) {
		var original_amt = $('.deposit-form input[name=deposit_amount]').val();
		...
		if(enable_thousands_separator_in_the_deposit_amount){
	        $('input[name="thousands_separator_amount"]').val(total_amt);
	        display_thousands_separator();
	    }
		$('.deposit-form input[name=deposit_amount]').val(total_amt).change();
		$('#auto_payment_submit').attr('disabled', false);
	}
	...
	function reset_amt_val(){
		...
		$('.deposit-form input[name=deposit_amount]').val('').change();
	}
</script>