...
<div  class="container <?=$this->utils->getConfig('remove_register_mt100_class') ? '' : 'mt100' ?>" >
    ...
    <div class="reg__left__wrapper" data-ticket="OGP-27600">
        <h3><?=lang('lang.registration_mod_promo_title_html_in_pc')?></h3>
        <div class="img__center"></div>
        <div class="welcome__text"><?=lang('lang.registration_mod_promo_welcome_html')?></div>
        <div class="gamling__license__wrapper">
            <div class="gambling__text">
                <?=lang('lang.registration_mod_promo_gambling_html_in_pc')?>
            </div>
            <div class="antillephone__wrapper"></div>
        </div>
    </div>

    <div class="cstm-mod registration-mod" role="document" style="max-width: 100% !important;" data-tpl="register_recommended4igmbet">
...
.registration-field-note .icon-checked{
