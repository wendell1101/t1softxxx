...
<span class="game_history_sport">Odd Type: <?php echo $this->CI->utils->extractLangFromData($_data, 'odd_type'); ?></span><br>
<span class="game_history_sport">Odds: <?php echo $this->CI->utils->extractLangFromData($_data, 'odds'); ?></span><br>
<?php
