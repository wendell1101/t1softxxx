...
?>
    <div class="cstm-mod login-mod" role="document">
        <div class="modal-content">
            <?php if($this->utils->getConfig('ole_login_page_img_path')): ?>
                <?php $ole_login_page_img_path = $this->CI->utils->getSystemUrl("www", $this->utils->getConfig('ole_login_page_img_path')) ?>
                <div class="login-right-img-container">
                    <img src="<?=$ole_login_page_img_path?>">
                </div>
            <?php endif; ?>
            ...
            <div class="modal-body">
                <form method="POST" action="<?=site_url('iframe/auth/login')?>" role="form" id="frm_login" data-tpl="stable_center2/auth/login">
                    ...
                    <?php if(isset($username_error) || (isset($_GET['username_error']) && $_GET['username_error'] !== '')): ?>
                        <div class="fcname-note mb20">
                            <p class="pl15 mb0">
                                <i class="icon-warning red f16 mr5"></i>
                                <?php echo (isset($_GET['username_error']) && $_GET['username_error'] !== '') ? $_GET['username_error'] : $username_error; ?>
                            </p>
                        </div>
                    <?php endif; ?>
                    <div class="form-group form-inline relative">
                    ...
                    <?php if(isset($password_error) || (isset($_GET['password_error']) && $_GET['password_error'] !== '')): ?>
                        <div class="fcpass-note mb20">
                            <p class="pl15 mb0">
                                <i class="icon-warning red f16 mr5"></i>
                                <?php echo (isset($_GET['password_error']) && $_GET['password_error'] !== '') ? $_GET['password_error'] : $password_error; ?>
                            </p>
                        </div>
                    <?php endif; ?>
                   ...
                   <?php endif; ?>
                    ...
                    <div class="show">
                        ...
                        <div class="register-container">
                            <a href="<?=site_url('player_center/iframe_register')?>" class="block text-right"><?=lang('Free Registration');?></a>
                        </div>
                        <div class="clearfix"></div>
                        <?php endif; ?>
                    </div>
...
<?php if (!isset($preview) || !$preview): ?>
    ...
    <script type="text/javascript">
        ...
        $(function(){
            ...
            if(urlSearchParams.has('username_error')){
                var usernameError = urlSearchParams.get('username_error');
                console.log('Username Error:', usernameError);
            }
            if (urlSearchParams.has('password_error')) {
                var passwordError = urlSearchParams.get('password_error');
