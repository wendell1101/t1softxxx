<?php if($system_feature_use_self_pick_promotion): ?>
<div class="row deposit-process-mode-<?=in_array($deposit_process_mode, array('2','3')) ? '2' : $deposit_process_mode ?> setup-deposit-promo">
    <div class="form-group has-feedback">
        <p class="step"><span class="step-icon"><?=$deposit_step++?></span><label class="control-label"><?=lang('Select Promo')?></label></p>
        <div class="col col-xs-12 col-sm-12 col-md-4 nopadding">
