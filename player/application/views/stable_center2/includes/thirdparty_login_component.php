...
if( empty( $_lang_thirdparty_login_component_in_or__wrapper) ){
    $_lang_thirdparty_login_component_in_or__wrapper = lang('lang.thirdparty_login_component_in_or__wrapper');
}
?>
<div class="row">
    <div class="col-md-12 col-lg-12">
        ...
        <div class="sso-btn-wrapper">
            <?php
            $thirdparty_sso_type = $this->config->item('thirdparty_sso_type');
            foreach ($thirdparty_sso_type as $type) {
                ...
                <?php   break;
                    case 'ole': ?>
                        <div class="sso-btn-group">
                            <a href="/iframe/auth/ole_login">
                                <div class="sso-btn sso-btn-ole" title="Ole">
                                </div>
                            </a>
                        </div>
                <?php   break;
