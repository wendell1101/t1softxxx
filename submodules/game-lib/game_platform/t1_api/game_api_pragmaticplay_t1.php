...
/*
*	This class will integrate game_gateway api for T1PRAGMATICPLAY_API
*
...
class Game_api_pragmaticplay_t1 extends Game_api_t1_common {

	public function getPlatformCode(){
        return T1PRAGMATICPLAY_API;
    }

    public function getOriginalPlatformCode(){
        return $this->getSystemInfo('original_platform_code', PRAGMATICPLAY_API);
    }
