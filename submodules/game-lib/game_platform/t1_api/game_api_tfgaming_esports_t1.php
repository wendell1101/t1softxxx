...
/*
*   This class will integrate game_gateway api for T1 TFGAMING ESPORTS
*
...
class Game_api_tfgaming_esports_t1 extends Game_api_t1_common {

    public function getPlatformCode(){
        return T1TFGAMING_ESPORTS_API;
    }
