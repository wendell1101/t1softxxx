...
class Game_api_ezugi_red_tiger_seamless_api extends Game_api_ezugi_seamless_api {
    ...
    public function __construct(){     
        ...
        if($this->use_ezugi_seamless_wallet_transactions){
            $this->original_transaction_table = 'ezugi_redtiger_seamless_wallet_transactions';
            $this->ymt_init();
        }else{
