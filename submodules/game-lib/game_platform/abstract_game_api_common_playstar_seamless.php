...
abstract class Abstract_game_api_common_playstar_seamless extends Abstract_game_api {
    ...
    public function __construct() {
        ...
        $this->host_id                             = $this->getSystemInfo('host_id', '93aada0ab1cfeaa90f4e9f8b3b8bcb85');
        $this->language                             = $this->getSystemInfo('language', 'en-US');
        ...
        $this->showHints                            = $this->getSystemInfo('showHints', '');
        $this->original_transactions_table          = $this->getSystemInfo('original_transactions_table', 'playstar_seamless_wallet_transactions');
    ...
    public function generateUrl($apiName, $params)
    {
        ...
        $this->utils->debug_log("PLAYSTAR_SEAMLESS: (generateUrl)", [
            '$uri' => $uri,
    ...
    {   
        ...
        $this->utils->debug_log("PLAYSTAR_SEAMLESS: (queryForwardGame)", $extra);
    ...
    public function processResultForQueryForwardGame($params)
	{
        ...
        $this->utils->debug_log("PLAYSTAR_SEAMLESS: (processResultForQueryForwardGame)", [
            '$resultArr'    => $resultArr,
            '$success'      => $success,
        ]);
    ...
    public function processResultBoolean($responseResultId, $resultArr, $playerName = null, $is_querytransaction = false)
    {
        ...
        if (!$success) {
            ...
            $this->CI->utils->debug_log('PLAYSTAR_SEAMLESS got error ', $responseResultId, 'playerName', $playerName, 'result', $resultArr);
        }
        return $success;
    }  
    ...
    public function createPlayer($playerName, $playerId, $password, $email = null, $extra = null){
        $this->utils->debug_log("PLAYSTAR_SEAMLESS: (createPlayer)");

        # create player on game provider auth
        $return = parent::createPlayer($playerName, $playerId, $password, $email, $extra); 
        $success = false;
        $message = "Unable to create account for PLAYSTAR seamless GAME API api";
        if($return){
            $success = true;
            $this->updateRegisterFlag($playerId, Abstract_game_api::FLAG_TRUE);
            $message = "Successfull create account for PLAYSTAR seamless GAME API api";
        }
    ...
    public function queryOriginalGameLogs($dateFrom, $dateTo, $use_bet_time) {
        $original_transactions_table = $this->original_transactions_table;
        ...
        $this->CI->utils->debug_log("PLAYSTAR_SEAMLESS: (queryOriginalGameLogs) tables used", 'original_transactions_table', $original_transactions_table);
    ...
    public function queryOriginalGameLogsWithTable($transactionTable, $dateFrom, $dateTo, $use_bet_time) {
        ...
        $this->utils->debug_log('PLAYSTAR_SEAMLESS-syncOrig', $transactionTable, $dateFrom, $dateTo);
        $this->CI->utils->debug_log('PLAYSTAR_SEAMLESS GAME sqlTime', $sqlTime);
...
EOD;
        ...
        $this->CI->utils->debug_log('PLAYSTAR_SEAMLESS-syncSQL', $sql, 'params', $params);
    
        // Execute query and log the result
        $result = $this->CI->original_game_logs_model->commonGetOriginalGameLogs($sql, $params);
        $this->CI->utils->debug_log('PLAYSTAR_SEAMLESS-rlt', $result);
    ...
    public function makeParamsForInsertOrUpdateGameLogsRow(array $row) {
        ...
        $win_amount = isset($row['total_win']) ? $row['total_win'] : 0;
        $bet_amount = isset($row['total_bet']) ? $row['total_bet'] : 0;
        $result_amount = $win_amount - $bet_amount;

        $this->CI->utils->debug_log('PLAYSTAR_SEAMLESS (makeParamsForInsertOrUpdateGameLogsRow)', [
            '$row' => $row,
        ...
        $data = [
            ...
            'amount_info' => [
                'bet_amount'            => $row['total_bet'],
                'result_amount'         => $result_amount,
                'bet_for_cashback'      => $row['total_bet'],
                'real_betting_amount'   => $row['total_bet'],
                'win_amount'            => $win_amount,
                'loss_amount'           => null,
        ...
        $this->utils->debug_log('PLAYSTAR_SEAMLESS data ', $data);
        return $data;
    ...
    */
    public function preprocessOriginalRowForGameLogs(array &$row){
        ...
        $this->CI->utils->debug_log('PLAYSTAR_SEAMLESS (preprocessOriginalRowForGameLogs)', 'before-row', $row);
        ...
        $this->CI->utils->debug_log('PLAYSTAR_SEAMLESS (preprocessOriginalRowForGameLogs)', 'after-row', $row);
    ...
    public function formatBetDetails($details){
        ...
        if($details){
            $bet_details = [
                ...
                'bet_amount'            => $details['total_win'],
                'win_amount'            => $details['total_bet'],
...
EOD;
        ...
        // Log SQL and parameters for debugging
        $this->CI->utils->debug_log('PLAYSTAR_SEAMLESS (queryTransactionByDateTime)', 'sql', $sql, 'params', $params);
    
        // Execute the query and return the result
        $result = $this->CI->original_game_logs_model->commonGetOriginalGameLogs($sql, $params);
        $this->CI->utils->debug_log('PLAYSTAR_SEAMLESS (queryTransactionByDateTime) Result', $result);
    ...
    public function getPlayerBalanceById($player_id){
        ...
        $this->CI->utils->debug_log('PLAYSTAR_SEAMLESS (getPlayerBalanceById)', [
    ...
    public function ymt_init() {
        ...
        $this->initialize_monthly_transactions_table = $this->getSystemInfo('initialize_monthly_transactions_table', false);
