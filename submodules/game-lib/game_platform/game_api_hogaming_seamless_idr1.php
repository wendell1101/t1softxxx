...
class Game_api_hogaming_seamless_idr1 extends Abstract_game_api_common_hogaming_seamless
{
    const ORIGINAL_GAMELOGS_TABLE = 'hogaming_seamless_idr1_game_logs';
    const TRANSACTION_LOGS_TABLE = 'hogaming_seamless_idr1_transaction_logs';
    const CURRENCY = 'IDR';
    const LANGUAGE = 'id';

    public function getPlatformCode()
    {
        return HOGAMING_SEAMLESS_IDR1_GAME_API;
    }
