...
class Game_api_beter_seamless extends Abstract_game_api {
    public $CI;
    public $api_url;
    public $lang;
    public $currency;
    ...
    public function __construct() {
        ...
        $this->api_url = $this->getSystemInfo('url', 'https://client.stage.beter.live/');
        $this->lang = $this->getSystemInfo('lang', 'id');
        $this->currency = $this->getSystemInfo('currency', 'IDR');
        $this->country = $this->getSystemInfo('country', 'ID');

        $this->cid = $this->getSystemInfo('cid', 'indobet');
        $this->api_key = $this->getSystemInfo('secret_api_key', '1da771f3123d6641eeccf65fbb90ddc44fa8dd598dd20f26b2e742c742c4f47b');
       
        $this->original_transaction_table_name = 'beter_seamless_wallet_transactions';
    ...
    public function createPlayer($playerName, $playerId, $password, $email = null, $extra = null) {
        ...
        $success = false;
        $message = "Unable to create account for Beter Seamless";
        if($return){
            $success = true;
            $message = "Successfull create account for Beter Seamless";
        }

        return array("success" => $success, "message" => $message);
    }

    // use queryPlayerBalance from abstract_game_api
    ...
    public function queryForwardGame($playerName,$extra=[]) {
        ...
        $url = $this->api_url."?cid=".$this->cid."&token=".$token."&lang=".$lang."&launchalias=".$game_code."&homepage=".$homepage."&funMode=".$funMode."&username=".$gameUsername;
    ...
    public function processResultBoolean($responseResultId, $resultArr, $playerName = null, $apiName = '') {
        ...
        $this->CI->utils->debug_log('Beter: (' . __FUNCTION__ . ')', $resultArr);
