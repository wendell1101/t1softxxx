...
class Game_api_idn_slots_mgplus_seamless_api extends Game_api_mgplus_seamless_api {
    ...
    public function __construct(){
        ...
        if ($this->use_mgplus_seamless_wallet_transactions_table) {
            $this->original_transactions_table = 'idn_slots_mgplus_seamless_wallet_transactions';
        }
    }
