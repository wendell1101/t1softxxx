...
class Game_api_sbobet_seamless extends Game_api_common_sbobet {

	const ORIGINAL_GAMELOGS_TABLE = 'sbobet_seamless_thb_game_logs';
...
SELECT
  ...
  gamelogs.result_amount as result_amount,
  ...
  trans.sbe_external_game_id as game_name,
  trans.sbe_external_game_id as game_code,
...
FROM
  ...
  JOIN player as p ON trans.gameusername = p.username
  LEFT JOIN game_description as gd ON trans.sbe_external_game_id = gd.external_game_id AND gd.game_platform_id = ?
WHERE
  gamelogs.updated_at >= ?
