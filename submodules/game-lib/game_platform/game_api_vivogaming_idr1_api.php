...
class Game_api_vivogaming_idr1_api extends Abstract_game_api_common_vivo_gaming{
    ...
    */
    ...
    {
        // return 'vivo_gaming_idr1_game_logs';
       return  $this->getSystemInfo('original_table', 'vivo_gaming_idr1_game_logs');
    }
}
/** end of file */