...
class Game_api_redgenn_playson_seamless extends Game_api_redgenn_seamless_api {
    ...
    public function __construct(){
        parent::__construct();
        $this->original_transactions_table = 'redgenn_playson_seamless_wallet_transactions';
