...
class Game_api_ebet_thb extends Game_api_ebet
{
    const ORIGINAL_LOGS_TABLE_NAME = 'ebet_th_game_logs';
    ...
    public function __construct(){
        ...
        $this->CI->load->model('ebet_th_game_logs');
        $this->ebet_th_game_logs=$this->CI->ebet_th_game_logs;
    }
    ...
    public function syncMergeToGameLogs($token) {
        ...
        $result = $this->ebet_th_game_logs->getebetGameLogStatistics($dateTimeFrom, $dateTimeTo);
