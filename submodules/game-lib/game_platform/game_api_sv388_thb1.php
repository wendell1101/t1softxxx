...
class Game_api_sv388_thb1 extends Game_api_common_nttech_v2 {
	const CURRENCY_TYPE = "THB";
	const DEDAULT_LANG = "th";
    const SV388_THB_B1_ORIG_GAMELOGS_TABLE = "king_maker_thb2_game_logs";
	...
	public function getPlatformCode(){
		return SV388_GAMING_THB_B1_API;
    }
    ...
    public function __construct(){
        ...
        $this->original_gamelogs_table = self::SV388_THB_B1_ORIG_GAMELOGS_TABLE;
    }
	 ...
	 *  ~~~~~~~~~~~~~~~
	 *
	 *  player_center/goto_kingmaker_game/2432/<game_code>/<language>/<is_mobile>/<is_redirect>/<game_type>
	 *  Desktop: player_center/goto_sv388_game/2432/SV-LIVE-001
	 *  Mobile: player_center/goto_sv388_game/2432/SV-LIVE-001/en/true/true
	 *
	 */
	public function queryForwardGame($playerName, $extra = null) 
	{
		...
		if($result["success"])
		{
			$this->CI->utils->debug_log('SV388_GAMING_THB_B1_API queryForwardgame URL:', $result['url']);
