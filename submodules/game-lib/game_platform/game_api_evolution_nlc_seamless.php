 ...
 */
 ...
 class Game_api_evolution_nlc_seamless extends Game_api_evolution_seamless_thb1_api
 {
    public $original_seamless_wallet_transactions_table = 'evolution_nlc_seamless_wallet_transactions';
    ...
    */
    ...
    {
        // return 'evolution_nlc_seamless_game_logs';
        $tableName = 'evolution_nlc_seamless_game_logs';
