...
class Game_api_habanero_seamless extends Abstract_game_api_common_habanero_seamless {
    const ORIGINAL_GAME_LOGS = 'habanero_seamless_game_logs';
    const ORIGINAL_TRANSACTIONS = 'habanero_transactions';
