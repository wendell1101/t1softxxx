<?php
trait game_description_sportsbook {

	public function sync_game_description_sportsbook(){
        $cnt=0;
        $cntInsert = 0;
        $cntUpdate = 0;
        ...
        $game_types = [
            $game_type_code_sports => [
                ...
                'game_type_lang' => '_json:{"1":"Sports","2":"街机游戏","3":"Sports","4":"Sports"}',
		...
		$game_descriptions = array(
            ...
            [
                'game_code' => 'Weight Lifting',
                'external_game_id' => 'Weight Lifting',
            ...
            [
                'game_code' => 'parlay',
                'external_game_id' => 'parlay',
                'english_name' => 'Parlay',
                'game_name' => '_json:{"1":"Parlay","2":"串关","3":"Parlay","4":"Parlay","5":"Parlay"}',
                'game_platform_id' => $api_id,
                'game_type_id' => $gameTypeCodeMaps[$game_type_code_sports],
            ],
            [
