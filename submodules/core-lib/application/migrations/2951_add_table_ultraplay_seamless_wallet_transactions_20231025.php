...
class Migration_add_table_ultraplay_seamless_wallet_transactions_20231025 extends CI_Migration {
    private $tableName = 'ultraplay_seamless_wallet_transactions';
    ...
    public function up() {
        ...
        if (!$this->db->table_exists($this->tableName)) {
            ...
            $this->player_model->addIndex($this->tableName, 'idx_IsAccepted', 'IsAccepted');
            $this->player_model->addIndex($this->tableName, 'idx_GroupTicketID', 'GroupTicketID');
            $this->player_model->addIndex($this->tableName, 'idx_Selections', 'Selections');
            $this->player_model->addIndex($this->tableName, 'idx_PayoutStatus', 'PayoutStatus');
            $this->player_model->addIndex($this->tableName, 'idx_SettleBetStatus', 'SettleBetStatus');
