...
class Migration_add_rfupay_alipay_to_external_system_list_201610040805 extends CI_Migration {

	private $tableName = 'external_system_list';

	public function up() {
		// $this->db->insert($this->tableName, array(
		// 	"id" => RFUPAY_ALIPAY_PAYMENT_API,
		// 	"system_name" => "RFUPAY_ALIPAY_PAYMENT_API",
		// 	"system_code" => "RFUPAY",
		// 	"system_type" => SYSTEM_PAYMENT,
		// 	"live_mode" => 0,
		// 	"class_name" => "payment_api_rfupay_alipay",
		// 	"local_path" => "payment",
	...
	public function down() {
		// $this->db->delete($this->tableName, array('id' => RFUPAY_ALIPAY_PAYMENT_API));
	}
}
