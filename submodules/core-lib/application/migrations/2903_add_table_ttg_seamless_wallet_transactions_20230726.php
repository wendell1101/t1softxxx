...
class Migration_add_table_ttg_seamless_wallet_transactions_20230726 extends CI_Migration {
    private $tableName = 'ttg_seamless_wallet_transactions';
    ...
    public function up() {
        ...
        if (!$this->db->table_exists($this->tableName)) {
            ...
            // additional
            $this->player_model->addIndex($this->tableName, 'idx_txnsubtypeid', 'txnsubtypeid');
            $this->player_model->addIndex($this->tableName, 'idx_handid', 'handid');
            $this->player_model->addIndex($this->tableName, 'idx_playerhandle', 'playerhandle');
            $this->player_model->addIndex($this->tableName, 'idx_gameplayid', 'gameplayid');
            $this->player_model->addIndex($this->tableName, 'idx_transactions', 'transactions');
            $this->player_model->addIndex($this->tableName, 'idx_canceltxnid', 'canceltxnid');
