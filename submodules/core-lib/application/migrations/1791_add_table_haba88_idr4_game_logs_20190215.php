...
class Migration_add_table_haba88_idr4_game_logs_20190215 extends CI_Migration {
	private $tableName = 'haba88_idr4_game_logs';
	public function up() {
        ...
        $this->player_model->addIndex($this->tableName, 'idx_haba88_idr4_game_logs_external_uniqueid', 'external_uniqueid',true);
	}
