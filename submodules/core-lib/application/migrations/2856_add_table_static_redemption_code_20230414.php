...
class Migration_add_table_static_redemption_code_20230414 extends CI_Migration
{

    private $tableName = 'static_redemption_code';
    ...
    public function up()
    {
        ...
        if (!$this->utils->table_really_exists($this->tableName)) {
            ...
            $this->player_model->addIndex($this->tableName, 'idx_redemption_code', 'redemption_code');
