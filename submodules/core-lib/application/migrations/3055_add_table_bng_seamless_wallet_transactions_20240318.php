...
class Migration_add_table_bng_seamless_wallet_transactions_20240318 extends CI_Migration {
    private $tableName = 'bng_seamless_wallet_transactions';
    ...
    public function up() {
        ...
        if (!$this->db->table_exists($this->tableName)) {
            ...
            // additional
            $this->player_model->addIndex($this->tableName, 'idx_provider_id', 'provider_id');
            $this->player_model->addIndex($this->tableName, 'idx_session', 'session');
            $this->player_model->addIndex($this->tableName, 'idx_tag', 'tag');
            $this->player_model->addIndex($this->tableName, 'idx_campaign', 'campaign');
            $this->player_model->addIndex($this->tableName, 'idx_bonus_id', 'bonus_id');
            $this->player_model->addIndex($this->tableName, 'idx_ext_bonus_id', 'ext_bonus_id');
            $this->player_model->addIndex($this->tableName, 'idx_transaction_uid', 'transaction_uid');
