...
class Migration_add_table_cmd_seamless_wallet_transactions_20230512 extends CI_Migration {
    private $tableName = 'cmd_seamless_wallet_transactions';
    ...
    public function up() {
        ...
        if (!$this->db->table_exists($this->tableName)) {
            ...
            $this->player_model->addIndex($this->tableName, 'idx_package_id', 'package_id');
