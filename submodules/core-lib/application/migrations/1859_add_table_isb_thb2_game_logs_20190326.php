...
class Migration_add_table_isb_thb2_game_logs_20190326 extends CI_Migration {

	private $tableName = 'isb_thb2_game_logs';
	...
	public function up() {
        ...
        $this->player_model->addIndex($this->tableName, 'idx_isb_thb2_game_logs_external_uniqueid', 'external_uniqueid',true);
