...
class Migration_add_table_smartsoft_seamless_wallet_transactions_20231024 extends CI_Migration {
    
	private $tableName = 'smartsoft_seamless_wallet_transactions';
	public function up() {
		$fields = array(
			'id' => array(
				'type' => 'BIGINT',
		...
		if(!$this->db->table_exists($this->tableName)){
            ...
            $this->player_model->addIndex($this->tableName, 'idx_game_number', 'game_number');	        
            $this->player_model->addIndex($this->tableName, 'idx_cashier_transaction_id', 'cashier_transaction_id');	        
