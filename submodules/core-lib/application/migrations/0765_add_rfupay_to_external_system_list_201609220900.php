...
class Migration_add_rfupay_to_external_system_list_201609220900 extends CI_Migration {

	private $tableName = 'external_system_list';

	public function up() {
		// $this->db->insert($this->tableName, array(
		// 	"id" => RFUPAY_PAYMENT_API,
		// 	"system_name" => "RFUPAY_PAYMENT_API",
		// 	"system_code" => "RFUPAY",
		// 	"system_type" => SYSTEM_PAYMENT,
		// 	"live_mode" => 0,
		// 	"class_name" => "payment_api_rfupay",
		// 	"local_path" => "payment",
	...
	public function down() {
		// $this->db->delete($this->tableName, array('id' => RFUPAY_PAYMENT_API));
	}
}
