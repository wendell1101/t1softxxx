...
class Migration_add_table_oneapi_seamless_wallet_transactions_20240703 extends CI_Migration {
	private $tableName = 'oneapi_seamless_wallet_transactions';
	public function up() {
		$fields = array(
			'id' => array(
				'type' => 'BIGINT',
		...
		if(!$this->db->table_exists($this->tableName)){
            ...
            $this->player_model->addIndex($this->tableName, 'idx_trace_id', 'trace_id');	        
