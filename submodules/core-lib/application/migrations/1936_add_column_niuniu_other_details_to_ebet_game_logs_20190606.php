...
class Migration_add_column_niuniu_other_details_to_ebet_game_logs_20190606 extends CI_Migration {
    ...
    public function down() {
        ...
        $this->dbforge->drop_column($this->tableName2, 'niuniuWithHoldingTotal');
        $this->dbforge->drop_column($this->tableName2, 'niuniuWithHoldingDetail');
        $this->dbforge->drop_column($this->tableName2, 'niuniuResult');
    }
}