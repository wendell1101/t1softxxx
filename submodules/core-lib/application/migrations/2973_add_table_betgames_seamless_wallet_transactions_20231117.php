...
class Migration_add_table_betgames_seamless_wallet_transactions_20231117 extends CI_Migration {
    private $tableName = 'betgames_seamless_wallet_transactions';
    ...
    public function up() {
        ...
        if (!$this->db->table_exists($this->tableName)) {
            ...
            $this->player_model->addIndex($this->tableName, 'idx_promo_type', 'promo_type');
