...
class Migration_add_table_million_poker_seamless_wallet_transactions_20240531 extends CI_Migration {
    private $tableName = 'million_poker_seamless_wallet_transactions';
    ...
    public function up() {
        ...
        if (!$this->db->table_exists($this->tableName)) {
            ...
            // additional
            $this->player_model->addIndex($this->tableName, 'idx_channel_id', 'channel_id');
