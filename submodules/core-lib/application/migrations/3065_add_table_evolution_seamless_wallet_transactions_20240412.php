...
class Migration_add_table_evolution_seamless_wallet_transactions_20240412 extends CI_Migration
{
    private $tableName = "evolution_seamless_wallet_transactions";
    ...
    public function up()
    {
        ...
        if (! $this->db->table_exists($this->tableName))
        {
            ...
            $this->player_model->addIndex($this->tableName,"idx_refundedTransactionId", "refundedTransactionId");
