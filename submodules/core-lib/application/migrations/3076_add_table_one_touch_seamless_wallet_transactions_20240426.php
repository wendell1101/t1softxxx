...
class Migration_add_table_one_touch_seamless_wallet_transactions_20240426 extends CI_Migration {
    private $tableName = 'one_touch_seamless_wallet_transactions';
    ...
    public function up() {
        ...
        if (!$this->db->table_exists($this->tableName)) {
            ...
            // additional
            $this->player_model->addIndex($this->tableName, 'idx_request_uuid', 'request_uuid');
