...
class Migration_add_duplicate_account_report_to_functions_201604271623 extends CI_Migration {

	// const FUNC_ID = 107;
	// const PARENT_ID = 40;
	// const FUNC_CODE = 'duplicate_account_report';
	// const FUNC_NAME = 'Duplicate Account Report';
