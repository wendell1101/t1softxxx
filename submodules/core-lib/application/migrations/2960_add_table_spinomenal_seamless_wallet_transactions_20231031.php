...
class Migration_add_table_spinomenal_seamless_wallet_transactions_20231031 extends CI_Migration {
    
	private $tableName = 'spinomenal_seamless_wallet_transactions';
	...
	public function up() {
		...
		if(!$this->db->table_exists($this->tableName)){
            ...
            $this->player_model->addIndex($this->tableName, 'idx_spinomenal_player_id', 'spinomenal_player_id');	 
            $this->player_model->addIndex($this->tableName, 'idx_transaction_id', 'transaction_id');	 
            $this->player_model->addIndex($this->tableName, 'idx_ref_transaction_id', 'ref_transaction_id');	 
