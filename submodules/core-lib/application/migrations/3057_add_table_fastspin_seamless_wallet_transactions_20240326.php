...
class Migration_add_table_fastspin_seamless_wallet_transactions_20240326 extends CI_Migration {
	private $tableName = 'fastspin_seamless_wallet_transactions';
	public function up() {
		$fields = array(
			'id' => array(
				'type' => 'BIGINT',
			...
			'ref_ticket_ids' => array( #Varchar(2048)
				'type' => 'VARCHAR',
				'constraint' => '2048',
				'null' => true,
			),
