...
class Migration_add_table_pragmaticplay_idr10_gamelogs_20220304 extends CI_Migration {

	private $tableName = 'pragmaticplay_idr10_game_logs';
	...
	public function up() {
        ...
        if(!$this->utils->table_really_exists($this->tableName)){
            ...
            $this->player_model->addIndex($this->tableName,'idx_sbeplayerid' , 'sbeplayerid');
