...
class Migration_add_opus_in_game_type_and_game_description_201603192016 extends CI_Migration {
	const FLAG_TRUE = 1;
	const FLAG_FALSE = 0;
	private $tableName = 'game_description';

	public function up() {
		// $sql = "SELECT game_platform_id FROM game_type where game_platform_id = " . OPUS_API;
