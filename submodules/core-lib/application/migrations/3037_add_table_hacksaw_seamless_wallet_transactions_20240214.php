...
class Migration_add_table_hacksaw_seamless_wallet_transactions_20240214 extends CI_Migration {
    private $tableName = 'hacksaw_seamless_wallet_transactions';
    ...
    public function up() {
        ...
        if (!$this->db->table_exists($this->tableName)) {
            ...
            // additional
            $this->player_model->addIndex($this->tableName, 'idx_game_session_id', 'game_session_id');
            $this->player_model->addIndex($this->tableName, 'idx_external_session_id', 'external_session_id');
            $this->player_model->addIndex($this->tableName, 'idx_free_round_activation_id', 'free_round_activation_id');
            $this->player_model->addIndex($this->tableName, 'idx_campaign_id', 'campaign_id');
            $this->player_model->addIndex($this->tableName, 'idx_offer_id', 'offer_id');
            $this->player_model->addIndex($this->tableName, 'idx_bet_transaction_id', 'bet_transaction_id');
            $this->player_model->addIndex($this->tableName, 'idx_rolled_back_transaction_id', 'rolled_back_transaction_id');
            $this->player_model->addIndex($this->tableName, 'idx_promotion_id', 'promotion_id');
            $this->player_model->addIndex($this->tableName, 'idx_promo_payout_id', 'promo_payout_id');
            $this->player_model->addIndex($this->tableName, 'idx_external_promo_id', 'external_promo_id');
