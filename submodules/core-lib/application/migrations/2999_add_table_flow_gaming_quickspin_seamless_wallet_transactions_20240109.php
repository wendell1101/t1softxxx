...
class Migration_add_table_flow_gaming_quickspin_seamless_wallet_transactions_20240109 extends CI_Migration {
    private $tableName = 'flow_gaming_quickspin_seamless_wallet_transactions';
    ...
    public function up() {
        ...
        if (!$this->db->table_exists($this->tableName)) {
            ...
            $this->player_model->addIndex($this->tableName, 'idx_sub_category', 'sub_category');
            $this->player_model->addIndex($this->tableName, 'idx_account_id', 'account_id');
            $this->player_model->addIndex($this->tableName, 'idx_tx_round_id', 'tx_round_id');
            ...
            $this->player_model->addIndex($this->tableName, 'idx_campaign_ext_ref', 'campaign_ext_ref');
