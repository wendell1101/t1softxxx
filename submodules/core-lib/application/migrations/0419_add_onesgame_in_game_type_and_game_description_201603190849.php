...
class Migration_add_onesgame_in_game_type_and_game_description_201603190849 extends CI_Migration {
	const FLAG_TRUE = 1;
	const FLAG_FALSE = 0;
	private $tableName = 'game_description';

	public function up() {
		// $sql = "SELECT game_platform_id FROM game_type where game_platform_id = " . ONESGAME_API;
		...
		// 			'game_description_list' => array(
		// 				array('game_name' => 'onesgame.unknown',
		// 					'english_name' => 'Unknown 1sgame Game',
	...
	public function down() {
		// $this->db->trans_start();
		// $this->db->delete('game_type', array('game_platform_id' => ONESGAME_API));
		// $this->db->delete('game_description', array('game_platform_id' => ONESGAME_API));
		// $this->db->trans_complete();
	}
}