...
class Migration_add_table_fa_ws168_seamless_wallet_transactions_20250310 extends CI_Migration {
    private $tableName = 'fa_ws168_seamless_wallet_transactions';
    ...
    public function up() {
        ...
        if (!$this->db->table_exists($this->tableName)) {
            ...
            $this->player_model->addIndex($this->tableName, 'idx_is_end_round', 'is_end_round');
