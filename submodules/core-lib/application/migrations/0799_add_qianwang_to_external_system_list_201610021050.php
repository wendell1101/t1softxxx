...
class Migration_add_qianwang_to_external_system_list_201610021050 extends CI_Migration {

	private $tableName = 'external_system_list';

	public function up() {
		// $this->db->insert($this->tableName, array(
		// 	"id" => QIANWANG_PAYMENT_API,
		// 	"system_name" => "QIANWANG_PAYMENT_API",
		// 	"system_code" => "QIANWANG",
		...
		// 	"class_name" => "Payment_api_qianwang",
		// 	"local_path" => "payment",
	...
	public function down() {
		// $this->db->delete($this->tableName, array('id' => QIANWANG_PAYMENT_API));
	}
}
