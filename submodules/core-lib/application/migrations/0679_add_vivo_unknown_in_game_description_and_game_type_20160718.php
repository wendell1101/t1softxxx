...
class Migration_add_vivo_unknown_in_game_description_and_game_type_20160718 extends CI_Migration {
	...
	public function up() {
		...
		$this->db->insert('game_description', array(
			...
			'game_name' 		=> 'vivo.unknown',
			'english_name' 		=> 'Unknown VIVO Game',
