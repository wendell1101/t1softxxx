...
class Migration_add_table_cq9_seamless_wallet_transactions_20220913 extends CI_Migration
{
    private $tableName = 'cq9_seamless_wallet_transactions';
    ...
    public function up()
    {
        ...
        if (!$this->db->table_exists($this->tableName)) {
            ...
            $this->player_model->addIndex($this->tableName, 'idx_ucode', 'ucode');
            ...
            $this->player_model->addIndex($this->tableName, 'idx_event_time', 'event_time');
