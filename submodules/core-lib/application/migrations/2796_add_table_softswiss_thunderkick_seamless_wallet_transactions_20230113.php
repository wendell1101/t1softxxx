...
class Migration_add_table_softswiss_thunderkick_seamless_wallet_transactions_20230113 extends CI_Migration {

    private $tableName = 'softswiss_thunderkick_seamless_wallet_transactions';
    ...
    public function up() {
        ...
        if (!$this->db->table_exists($this->tableName)) {
            ...
            $this->player_model->addIndex($this->tableName, 'idx_casino_id', 'casino_id');
            $this->player_model->addIndex($this->tableName, 'idx_provider', 'provider');
            $this->player_model->addIndex($this->tableName, 'idx_provider_identifier', 'provider_identifier');
            $this->player_model->addIndex($this->tableName, 'idx_rollback_action', 'rollback_action');
            $this->player_model->addIndex($this->tableName, 'idx_rollback_original_action_id', 'rollback_original_action_id');
