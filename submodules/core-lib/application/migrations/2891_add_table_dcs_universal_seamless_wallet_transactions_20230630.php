...
class Migration_add_table_dcs_universal_seamless_wallet_transactions_20230630 extends CI_Migration {
    private $tableName = 'dcs_universal_seamless_wallet_transactions';
    ...
    public function up() {
        ...
        if (!$this->db->table_exists($this->tableName)) {
            ...
            $this->player_model->addIndex($this->tableName, 'idx_brand_id', 'brand_id');
            $this->player_model->addIndex($this->tableName, 'idx_bet_type', 'bet_type');
            $this->player_model->addIndex($this->tableName, 'idx_wager_type', 'wager_type');
            $this->player_model->addIndex($this->tableName, 'idx_is_endround', 'is_endround');
