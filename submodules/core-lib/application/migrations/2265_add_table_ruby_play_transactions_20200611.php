...
class Migration_add_table_ruby_play_transactions_20200611 extends CI_Migration
{
    ...
    public function up()
    {
        ...
        if(! $this->db->table_exists($this->tableName)){
            ...
            $this->player_model->addUniqueIndex($this->tableName,"idx_referenceTransactionId","referenceTransactionId");
