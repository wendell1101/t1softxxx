 ...
 * paybus
 *
 * * PAYBUS_V8PAY_VIETTEL_PAYMENT_API, ID: 6590
 *
 * Field Values:
 ...
 */
class Payment_api_paybus_v8pay_viettel extends Abstract_payment_api_paybus {

    const CHANNEL_V8PAY_VIETTEL = 'v8pay.zalo';

    public function getPlatformCode() {
        return PAYBUS_V8PAY_VIETTEL_PAYMENT_API;
    }

    public function getPrefix() {
        return 'paybus_v8pay_viettel';
    }
    ...
    protected function configParams(&$params, $direct_pay_extra_info) {
        ...
        $params['channel_input'] = json_decode(json_encode([
            self::CHANNEL_V8PAY_VIETTEL => array(
