 ...
 */
class Payment_api_yangpay_alipay_h5 extends Abstract_payment_api_yangpay {
	...
	public function getPlatformCode() {
		...
		// return YANGPAY_ALIPAY_H5_PAYMENT_API;
...
$this->CI->utils->debug_log("=====================YANGPAY getPrefix", $preFixStr);
		return $preFixStr; // 'yangpay_alipay_h5'; // @todo 待驗證
	}
