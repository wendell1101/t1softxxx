 ...
 */
class Payment_api_cocozf_alipay_h5 extends Abstract_payment_api_cocozf {

	public function getPlatformCode() {
		return COCOZF_ALIPAY_H5_PAYMENT_API;
	}

	public function getPrefix() {
		return 'cocozf_alipay_h5';
	}

	protected function configParams(&$params, $direct_pay_extra_info) {
        	//$params['pay_mode'] = self::PAY_MODE_H5;
           	$params['tranType'] = self::PAYTYPE_ALIPAY_H5;
	}
