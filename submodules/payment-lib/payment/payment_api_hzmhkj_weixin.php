 ...
 */
class Payment_api_hzmhkj_weixin extends Abstract_payment_api_hzmhkj {

	public function getPlatformCode() {
		return HZMHKJ_WEIXIN_PAYMENT_API;
	}

	public function getPrefix() {
		return 'hzmhkj_weixin';
	}
	...
	protected function configParams(&$params, $direct_pay_extra_info) {
        if($this->CI->utils->is_mobile()) {
			...
			$params['paytype'] = self::PAYTYPE_WEIXIN_QR;
			$params['bankcode'] = '';
		}
	}
