 ...
 */
class Payment_api_wonderfulsky_weixin_h5 extends Abstract_payment_api_wonderfulsky {

    public function getPlatformCode() {
        return WONDERFULSKY_WEIXIN_H5_PAYMENT_API;
    }

    public function getPrefix() {
        return 'wonderfulsky_weixin_h5';
    }

    protected function configParams(&$params, $direct_pay_extra_info) {
        $params['channel'] = self::CHANNEL_WEIXIN_H5;
    }
