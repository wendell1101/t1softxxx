 ...
 */
class Payment_api_dynastypay_alipay extends Abstract_payment_api_dynastypay
{
     public function getPlatformCode()
     {
          return DYNASTYPAY_ALIPAY_PAYMENT_API;
     }
     public function getPrefix()
     {
          return 'dynastypay_alipay';
     }

    protected function configParams(&$params, $direct_pay_extra_info) {
        $params['PayTypr'] = self::PAYTYPE_ALIPAY;
    }
