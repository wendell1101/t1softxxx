 ...
 */
class Payment_api_tonfords_alipay extends Abstract_payment_api_tonfords {

	public function getPlatformCode() {
		return TONFORDS_ALIPAY_PAYMENT_API;
	}

	public function getPrefix() {
		return 'tonfords_alipay';
    }
	...
	protected function configParams(&$params, $direct_pay_extra_info) {
		...
		return $params['pay_way'] = $payWay ? $payWay: self::PAYMENT_WAY_ALIPAY;
	}
