...
/**
 *
 * * PAYBUS_CLOUDPAY_THB_BANK_WITHDRAWAL_PAYMENT_API
 *
 * Field Values:
 * * Account: ## User ID ##
 * * Key: ## Secret Key ##
 ...
 */
class Payment_api_paybus_cloudpay_thb_bank_withdrawal extends Abstract_payment_api_paybus {
    const CHANNEL_CLOUDPAY_THB_BANK_WITHDRAWA = 'cloudpay_thb.bank';

    public function getPlatformCode() {
        return PAYBUS_CLOUDPAY_THB_BANK_WITHDRAWAL_PAYMENT_API;
    }

    public function getPrefix() {
        return 'paybus_cloudpay_thb_bank_withdrawal';
    }
    ...
    public function getWithdrawParams($bank, $accNum, $name, $amount, $transId) {
        ...
        $params['channel_input'] = json_decode(json_encode([
            self::CHANNEL_CLOUDPAY_THB_BANK_WITHDRAWA => [
                'bank_code' => $bankCode,
                'acc_no' => $accNum,
                'acc_name' => $name,
            ]]));
