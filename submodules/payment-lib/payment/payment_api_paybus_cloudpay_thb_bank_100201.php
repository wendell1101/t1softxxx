 ...
 */
class Payment_api_paybus_cloudpay_thb_bank_100201 extends Abstract_payment_api_paybus {

    const CHANNEL_CLOUDPAY_THB_BANK_100201 = 'cloudpay_thb.bank_100201';

    public function getPlatformCode() {
        return PAYBUS_CLOUDPAY_THB_BANK_100201_PAYMENT_API;
    }

    public function getPrefix() {
        return 'paybus_cloudpay_thb_bank_100201';
    }
    ...
    protected function configParams(&$params, $direct_pay_extra_info) {
		if(!empty($direct_pay_extra_info)) {
            ...
            $params['channel_input'] = json_decode(json_encode([
                self::CHANNEL_CLOUDPAY_THB_BANK_100201 => array(
