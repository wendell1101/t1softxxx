 ...
 * PAYBUS_WITHDRAWAL
 *
 * * PAYBUS_SUNPAY_BANK_WITHDRAWAL_PAYMENT_API, ID: 6511
 *
 * Field Values:
 * * Account: ## User ID ##
 * * Key: ## Secret Key ##
 ...
 */
class Payment_api_paybus_sunpay_bank_withdrawal extends Abstract_payment_api_paybus {

    public function getPlatformCode() {
        return PAYBUS_SUNPAY_BANK_WITHDRAWAL_PAYMENT_API;
    }

    public function getPrefix() {
        return 'paybus_sunpay_bank_withdrawal';
    }
    ...
    public function getWithdrawParams($bank, $accNum, $name, $amount, $transId) {
        ...
        $params['channel_input'] = json_decode(json_encode([
            self::CHANNEL_SUNPAY_BANK_WITHDRAWAL => [
                'bankCode'       => $bankCode,
