 ...
 *
 * LEPAYLE_ALIPAY_PAYMENT_API, ID: 268
 *
 * Required Fields:
 *
 * * URL
 ...
 * @copyright 2022 tot
 */
class Payment_api_lepayle_alipay extends Abstract_payment_api_lepayle {

	public function getPlatformCode() {
		return LEPAYLE_ALIPAY_PAYMENT_API;
	}

	public function getPrefix() {
		return 'lepayle_alipay';
	}

	protected function configParams(&$params, $direct_pay_extra_info) {
		$params['service'] = 'ali_pay';
		$params['ali_pay_type'] = 'ali_sm';
