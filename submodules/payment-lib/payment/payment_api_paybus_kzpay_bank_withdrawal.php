...
/**
 * PAYBUS_KZPAY_BANK_WITHDRAWAL_PAYMENT_API
 *
 * * PAYBUS_KZPAY_BANK_WITHDRAWAL_PAYMENT_API, ID: 6475
 *
 * Field Values:
 * * Account: ## User ID ##
 * * Key: ## Secret Key ##
 ...
 */
class Payment_api_paybus_kzpay_bank_withdrawal extends Abstract_payment_api_paybus {

    public function getPlatformCode() {
        return PAYBUS_KZPAY_BANK_WITHDRAWAL_PAYMENT_API;
    }

    public function getPrefix() {
        return 'paybus_kzpay_bank_withdrawal';
    }
    ...
    public function getWithdrawParams($bank, $accNum, $name, $amount, $transId) {
        ...
        $paymentCode = $this->getSystemInfo('paymentCode', '1098');
