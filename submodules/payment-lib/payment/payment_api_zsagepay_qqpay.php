 ...
 */
class Payment_api_zsagepay_qqpay extends Abstract_payment_api_zsagepay {

	public function getPlatformCode() {
		return ZSAGEPAY_QQPAY_PAYMENT_API;
	}

	public function getPrefix() {
		return 'zsagepay_qqpay';
	}
	...
	protected function configParams(&$params, $direct_pay_extra_info) {
		...
		$params['payChannel'] = '31';  //21 微信，30-支付宝，31-QQ 钱包
