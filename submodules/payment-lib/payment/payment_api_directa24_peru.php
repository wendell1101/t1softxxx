 ...
 */
class Payment_api_directa24_peru extends Abstract_payment_api_directa24 {

	public function getPlatformCode() {
		return DIRECTA24_PERU_PAYMENT_API;
	}

	public function getPrefix() {
		return 'directa24_peru';
	}

	protected function configParams(&$params, $direct_pay_extra_info) {
		$extraInfo = json_decode($direct_pay_extra_info, true);
        $params['country']        = $this->getSystemInfo('payment_country') ? $this->getSystemInfo('payment_country') : self::PAYMENT_COUNTRY_PE;
	...
	public function getPlayerInputInfo() {
		...
		$country = $this->getSystemInfo('payment_country') ? $this->getSystemInfo('payment_country') : self::PAYMENT_COUNTRY_PE;
