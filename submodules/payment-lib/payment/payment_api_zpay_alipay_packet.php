 ...
 *
 * Field Values:
 * * URL: http://api.payba.top/order/scanPay
 * * Account: ## MerchantID ##
 * * Key: ## Token ##
 *
 *
 ...
 */
class Payment_api_zpay_alipay_packet extends Abstract_payment_api_zpay {

    public function getPlatformCode() {
        return ZPAY_ALIPAY_PACKET_PAYMENT_API;
    }

    public function getPrefix() {
        return 'zpay_alipay_packet';
    }
