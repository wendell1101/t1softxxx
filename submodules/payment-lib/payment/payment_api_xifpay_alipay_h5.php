...
/**
 *
 * * XIFPAY_ALIPAY_H5_PAYMENT_API, ID: 734
 *
 * Required Fields:
 * * URL
 * * Account
 ...
 */
class Payment_api_xifpay_alipay_h5 extends Abstract_payment_api_xifpay {

	public function getPlatformCode() {
		return XIFPAY_ALIPAY_H5_PAYMENT_API;
	}

	public function getPrefix() {
		return 'xifpay_alipay_h5';
	}
