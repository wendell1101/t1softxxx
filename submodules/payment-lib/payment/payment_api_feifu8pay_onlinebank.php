 ...
 * 
 * 
 * * FEIFU8PAY_ONLINEBANK_PAYMENT_API, ID: 757
 *
 * Required Fields:
 * * URL
 * * Account
 ...
 */
class Payment_api_feifu8pay_onlinebank extends Abstract_payment_api_feifu8pay {

	public function getPlatformCode() {
		return FEIFU8PAY_ONLINEBANK_PAYMENT_API;
	}

	public function getPrefix() {
		return 'feifu8pay_onlinebank';
	}

	protected function configParams(&$params, $direct_pay_extra_info) {
       
			$params['pay_bankcode'] = self::SCANTYPE_ONLINE_BANK;
