 ...
 */
class Payment_api_islpay_alipay extends Abstract_payment_api_islpay {

	public function getPlatformCode() {
		return ISLPAY_ALIPAY_PAYMENT_API;
	}

	public function getPrefix() {
		return 'islpay_alipay';
    }
	...
	protected function configParams(&$params, $direct_pay_extra_info) {
		...
		switch ($islpay_way) {
			case "SCAN":
				$params['service_type'] = self::SERVICETYPE_ALIPAY_SCAN;
				$params['interface_version'] = 'V3.1';
				break;
			case "H5":
				$params['service_type'] = self::SERVICETYPE_ALIPAY_H5;
				$params['interface_version'] = 'V3.1';
				break;
			case "B2C":
				...
				$params['pay_type']          = self::PAYTYPE_B2C_ALIPAY;
				$params['redo_flag']         = 1; #当值为1时不允许商户订单号重复提交；当值为 0或空时允许商户订单号重复提交
				break;
			case "B2CH5":
				$params['service_type'] = self::SERVICETYPE_ALIPAY_B2CH5;
				$params['interface_version'] = 'V3.0';
				$params['input_charset'] = 'UTF-8';
				break;
		}
