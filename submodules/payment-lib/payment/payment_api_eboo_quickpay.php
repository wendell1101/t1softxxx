 ...
 */
class Payment_api_eboo_quickpay extends Abstract_payment_api_eboo {

    public function getPlatformCode() {
        return EBOO_QUICKPAY_PAYMENT_API;
    }

    public function getPrefix() {
        return 'eboo_quickpay';
    }

    protected function getBankCode() {
        return $this->getSystemInfo("bankcode", self::BANKCODE_QUICKPAY);
    }
