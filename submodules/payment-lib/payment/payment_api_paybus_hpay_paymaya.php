 ...
 * paybus
 *
 * * PAYBUS_HPAY_PAYMENT_API, ID: 6379
 *
 * Field Values:
 ...
 */
class Payment_api_paybus_hpay_paymaya extends Abstract_payment_api_paybus {

    public function getPlatformCode() {
        return PAYBUS_HPAY_PAYMAYA_PAYMENT_API;
    }

    public function getPrefix() {
        return 'paybus_hpay_paymaya';
    }
    ...
    protected function configParams(&$params, $direct_pay_extra_info) {
        ...
        $params['channel_input'] = json_decode(json_encode([self::CHANNEL_HPAY_PAYMAYA => $inputobject]));
