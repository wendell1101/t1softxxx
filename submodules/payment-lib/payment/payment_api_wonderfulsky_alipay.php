 ...
 */
class Payment_api_wonderfulsky_alipay extends Abstract_payment_api_wonderfulsky {

    public function getPlatformCode() {
        return WONDERFULSKY_ALIPAY_PAYMENT_API;
    }

    public function getPrefix() {
        return 'wonderfulsky_alipay';
    }

    protected function configParams(&$params, $direct_pay_extra_info) {
        $params['channel'] = $this->utils->is_mobile() ? self::CHANNEL_ALIPAY_H5 : self::CHANNEL_ALIPAY;
    }
