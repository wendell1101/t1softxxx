 ...
 */
class Payment_api_yifutongvip_quickpay extends Abstract_payment_api_yifutongvip {

	public function getPlatformCode() {
		return YIFUTONGVIP_QUICKPAY_PAYMENT_API;
	}

	public function getPrefix() {
		return 'yifutongvip_quickpay';
	}

	protected function configParams(&$params, $direct_pay_extra_info) {
		$params['pay_type'] = self::PAYTYPE_QUICKPAY;
	}
