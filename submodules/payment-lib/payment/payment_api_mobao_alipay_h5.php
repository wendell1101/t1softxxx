...
class Payment_api_mobao_alipay_h5 extends Abstract_payment_api_mobao {
/*
	private $info;
...
*/
	public function getPlatformCode() {
		return MOBAO_ALIPAY_H5_PAYMENT_API;
	}

	public function getPrefix() {
		return 'mobao_alipay_h5';
	}

	protected function configParams(&$params, $direct_pay_extra_info) {
		$params['apiName'] = self::MOBAO_APINAME_ALIPAY_WAP;
