 ...
 */
class Payment_api_asiapay_weixin extends Abstract_payment_api_hcpay {

    public function getPlatformCode() {
        return ASIAPAY_WEIXIN_PAYMENT_API;
    }

    public function getPrefix() {
        return 'asiapay_weixin';
    }

    protected function configParams(&$params, $direct_pay_extra_info) {
        $params['pay_passcode'] = $this->getSystemInfo('passcode_pc', self::PASSCODE_WEIXIN);
    }
