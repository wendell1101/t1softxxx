 ...
 */
class Payment_api_goldenpay88_bdpay extends Abstract_payment_api_goldenpay88 {

	public function getPlatformCode() {
		return GOLDENPAY88_BDPAY_PAYMENT_API;
	}

	public function getPrefix() {
		return 'goldenpay88_bdpay';
	}
	...
	protected function configParams(&$params, $direct_pay_extra_info) {
		$params['payType'] = self::PAY_TYPE_CODE_BDPAY;
