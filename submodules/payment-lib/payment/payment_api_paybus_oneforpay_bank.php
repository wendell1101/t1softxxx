 ...
 * paybus
 *
 * * PAYBUS_ONEFORPAY_BANK_PAYMENT_API, ID: 6430
 *
 * Field Values:
 ...
 */
class Payment_api_paybus_oneforpay_bank extends Abstract_payment_api_paybus {

    public function getPlatformCode() {
        return PAYBUS_ONEFORPAY_BANK_PAYMENT_API;
    }

    public function getPrefix() {
        return 'paybus_oneforpay_bank';
    }
