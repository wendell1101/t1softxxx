 ...
 * PAYBUS_WITHDRAWAL
 *
 * * PAYBUS_HPAY_WITHDRAWAL_PAYMENT_API, ID: 6379
 *
 * Field Values:
 ...
 */
class Payment_api_paybus_hpay_withdrawal extends Abstract_payment_api_paybus {

    public function getPlatformCode() {
        return PAYBUS_HPAY_WITHDRAWAL_PAYMENT_API;
    }

    public function getPrefix() {
        return 'paybus_hpay_withdrawal';
    }
    ...
    public function getWithdrawParams($bank, $accNum, $name, $amount, $transId) {
        ...
        $params['channel_input'] = json_decode(json_encode([
            self::CHANNEL_HPAY_GCASH => [
                'bank_card_name' => $accNum, 
                "bank_card_account"=>(int)$accNum,
                'bank_card_remark' => $accNum]
            ]));
