 ...
 */
class Payment_api_paybus_cloudpay_paymaya_withdrawal extends Abstract_payment_api_paybus {

    public function getPlatformCode() {
        return PAYBUS_CLOUDPAY_PAYMAYA_WITHDRAWAL_PAYMENT_API;
    }

    public function getPrefix() {
        return 'paybus_cloudpay_paymaya_withdrawal';
    }
