 ...
 * PAYBUS_WITHDRAWAL
 *
 * * PAYBUS_BCPAY_WITHDRAWAL_PAYMENT_API, ID: 6357
 *
 * Field Values:
 ...
 */
class Payment_api_paybus_bcpay_withdrawal extends Abstract_payment_api_paybus {

    public function getPlatformCode() {
        return PAYBUS_BCPAY_WITHDRAWAL_PAYMENT_API;
    }

    public function getPrefix() {
        return 'paybus_bcpay_withdrawal_withdrawal';
    }
    ...
    public function getWithdrawParams($bank, $accNum, $name, $amount, $transId) {
        ...
        $player_info=$this->getPlayerInfoByTransactionCode($transId,$bankCode);

        $params = array();
        $params['client_id']     = $transId;
        $params['amount']        = (double)$this->convertAmountToCurrency($amount);
        $params['channel_input'] = json_decode(json_encode([self::CHANNEL_BCPAY_PIX => ['pix_type' => $bankCode, "account_number"=>$player_info['cpfNumber'],'account_name' => $player_info['firstName'].$player_info['lastName']]]));
