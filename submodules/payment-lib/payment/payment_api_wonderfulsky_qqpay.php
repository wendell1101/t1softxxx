 ...
 */
class Payment_api_wonderfulsky_qqpay extends Abstract_payment_api_wonderfulsky {

    public function getPlatformCode() {
        return WONDERFULSKY_QQPAY_PAYMENT_API;
    }

    public function getPrefix() {
        return 'wonderfulsky_qqpay';
    }

    protected function configParams(&$params, $direct_pay_extra_info) {
        $params['channel'] = $this->utils->is_mobile() ? self::CHANNEL_QQPAY_H5 : self::CHANNEL_QQPAY;
    }
