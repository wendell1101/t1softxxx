 ...
 *
 * Field Values:
 * * URL: http://pay.yafupay.com/weixin_pay.do
 * * Extra Info:
 * > {
 ...
 */
class Payment_api_yafu_wechat extends Abstract_payment_api_yafu {
	...
	public function getPlatformCode() {
		return YAFU_WECHAT_PAYMENT_API;
	}
