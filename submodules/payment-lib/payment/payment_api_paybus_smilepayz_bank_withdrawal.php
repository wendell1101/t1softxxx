...
/**
 *
 * * PAYBUS_SMILEPAYZ_BANK_WITHDRAWAL_PAYMENT_API
 *
 * Field Values:
 * * Account: ## User ID ##
 * * Key: ## Secret Key ##
 ...
 */
class Payment_api_paybus_smilepayz_bank_withdrawal extends Abstract_payment_api_paybus {
    const CHANNEL_SMILEPAYZ_BANK_WITHDRAWA = 'smilepayz.BANK';

    public function getPlatformCode() {
        return PAYBUS_SMILEPAYZ_BANK_WITHDRAWAL_PAYMENT_API;
    }

    public function getPrefix() {
        return 'paybus_smilepayz_bank_withdrawal';
    }
    ...
    public function getWithdrawParams($bank, $accNum, $name, $amount, $transId) {
        ...
        $params['channel_input'] = json_decode(json_encode([
            self::CHANNEL_SMILEPAYZ_BANK_WITHDRAWA => [
                'bankCode' => $bankCode,
                'cashAccount' => $accNum,
                'purpose' => "withdraw"
            ]]));
