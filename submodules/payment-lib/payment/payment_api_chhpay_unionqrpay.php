 ...
 * @copyright 2022 tot
 */
class Payment_api_chhpay_unionqrpay extends Abstract_payment_api_chhpay {

	public function getPlatformCode() {
		return CHHPAY_UNIONQRPAY_PAYMENT_API;
	}

	public function getPrefix() {
		return 'chhpay_unionqrpay';
	}

	protected function configParams(&$params, $direct_pay_extra_info) {
		$params['pa_FrpId'] = self::PAYTYPE_UNIONQRPAY;
