 ...
 */
class Payment_api_yantongyifu_quickpay_h5 extends Abstract_payment_api_yantongyifu {

	public function getPlatformCode() {
		return YANTONGYIFU_QUICKPAY_H5_PAYMENT_API;
	}

	public function getPrefix() {
		return 'yantongyifu_quickpay_h5';
	}
