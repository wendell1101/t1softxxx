 ...
 * PAYBUS_WITHDRAWAL
 *
 * * PAYBUS_BIOPAY_BANK_WITHDRAWAL_PAYMENT_API
 *
 * Field Values:
 * * Account: ## User ID ##
 * * Key: ## Secret Key ##
 ...
 */
class Payment_api_paybus_biopay_bank_withdrawal extends Abstract_payment_api_paybus {

    public function getPlatformCode() {
        return PAYBUS_BIOPAY_BANK_WITHDRAWAL_PAYMENT_API;
    }

    public function getPrefix() {
        return 'paybus_biopay_bank_withdrawal';
    }
    ...
    public function getWithdrawParams($bank, $accNum, $name, $amount, $transId) {
        ...
        $params['channel_input'] = json_decode(json_encode([self::CHANNEL_BIOPAY_BANK_WITHDRAWAL => ['bankName' => $bankCode,"bankOwner" =>$name,"bankAccount"=>$accNum]]));
    ...
    public function getBankInfo() {
        ...
        if(!empty($bankInfoArr)) {
            ...
            $bankInfo =  array(
                ...
                "58" => [
                    "name" => "NGAN HANG TMCP KY THUONG VIET NAM (TCB)",
                    "code" => "TCB"
                ],
                "59" => [
                ...
                "64" => [
                    "name" => "NGAN HANG TMCP HANG HAI VIET NAM (MARITIME BANK)",
                    "code" => "MSB"
                ],
                "65" => [
                ...
                "66" => [
                    "name" => "Ngân Hàng TMCP Đông Á  (DONG A BANK)",
                    "code" => "DONGABANK"
                ],
                "67" => [
                ...
                "68" => [
                    "name" => "NGAN HANG BUU DIEN LIEN VIET (LIENVIETPOSTBANK)",
                    "code" => "LPB"
                ],
                "70" => [
                ...
                "72" => [
                    "name" => "NGAN HANG TMCP PHAT TRIEN TP.HCM (HDBANK)",
                    "code" => "HDB"
                ],
                "73" => [
                ...
                "81" => [
                    "name" => "Ngân hàng thương mại cổ phần Việt Á (VIET A BANK)",
                    "code" => "VAB"
                ],
                "82" => [
