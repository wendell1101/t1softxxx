 ...
 * paybus
 *
 * * PAYBUS_NETZPAY_QRIS36_PAYMENT_API
 *
 * Field Values:
 ...
 */
class Payment_api_paybus_netzpay_qris36 extends Abstract_payment_api_paybus {
    const CHANNEL_NETZPAY_QRIS36 = 36;
    public function getPlatformCode() {
        return PAYBUS_NETZPAY_QRIS36_PAYMENT_API;
    }

    public function getPrefix() {
        return 'paybus_netzpay_qris36';
    }

    protected function configParams(&$params, $direct_pay_extra_info) {
        $params['binding_id'] = self::CHANNEL_NETZPAY_QRIS36;
