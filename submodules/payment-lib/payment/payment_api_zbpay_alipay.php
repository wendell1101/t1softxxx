 ...
 */
class Payment_api_zbpay_alipay extends Abstract_payment_api_zbpay {

	public function getPlatformCode() {
		return ZBPAY_ALIPAY_PAYMENT_API;
	}
	...
	protected function configParams(&$params, $direct_pay_extra_info) {
		$params['paytype'] = $this->utils->is_mobile() ? self::PAYTYPE_ALIPAY_H5 : self::PAYTYPE_ALIPAY;
	}
