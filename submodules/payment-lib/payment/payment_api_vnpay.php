 ...
 */
class Payment_api_vnpay extends Abstract_payment_api_vnpay {

    public function getPlatformCode() {
        return VNPAY_PAYMENT_API;
    }
    ...
    protected function configParams(&$params, $direct_pay_extra_info) {
        $params['channel'] = self::CHANNEL_DEPOSIT_ONLINEBANK;
    }
