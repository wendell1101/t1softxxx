 ...
 */
class Payment_api_zypay_alipay_h5 extends Abstract_payment_api_zypay {

    public function getPlatformCode() {
        return ZYPAY_ALIPAY_H5_PAYMENT_API;
    }

    public function getPrefix() {
        return 'zypay_alipay_h5';
    }

    protected function configParams(&$params, $direct_pay_extra_info) {
        $params['pay_code'] = self::PAY_CODE_ALIPAY;
    }
