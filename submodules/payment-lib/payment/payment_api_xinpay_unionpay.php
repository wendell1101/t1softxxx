 ...
 */
class Payment_api_xinpay_unionpay extends Abstract_payment_api_xinpay {

    public function getPlatformCode() {
        return XINPAY_UNIONPAY_PAYMENT_API;
    }

    public function getPrefix() {
        return 'xinpay_unionpay';
    }

    protected function configParams(&$params, $direct_pay_extra_info) {
        $params['busi_code'] = self::BUSICODE_UNIONPAY;
    }
