 ...
 * PAYBUS_WITHDRAWAL
 *
 * * PAYBUS_PTYPAY_BANK_WITHDRAWAL_PAYMENT_API
 *
 * Field Values:
 * * Account: ## User ID ##
 * * Key: ## Secret Key ##
 ...
 */
class Payment_api_paybus_ptypay_bank_withdrawal extends Abstract_payment_api_paybus {

    const CHANNEL_PTYPAY_BANK_WITHDRAWAL = 'ptypay.bank';

    public function getPlatformCode() {
        return PAYBUS_PTYPAY_BANK_WITHDRAWAL_PAYMENT_API;
    }

    public function getPrefix() {
        return 'paybus_ptypay_bank_withdrawal';
    }
    ...
    public function getWithdrawParams($bank, $accNum, $name, $amount, $transId) {
        ...
        $this->utils->debug_log("===============================paybus Get playerDetail using [$transId]", $playerDetail);
        ...
        $params['channel_input'] = json_decode(json_encode([
            self::CHANNEL_PTYPAY_BANK_WITHDRAWAL => [
                'bankname' => $bankCode,
                'cardname' => trim($name),
                'cardno'   => $accNum,
        ]]));
