 ...
 * paybus
 *
 * * PAYBUS_SPAY_TRUEMONEY_PAYMENT_API, ID: 6496
 *
 * Field Values:
 ...
 */
class Payment_api_paybus_spay_p2pdeposit extends Abstract_payment_api_paybus {

    public function getPlatformCode() {
        return PAYBUS_SPAY_P2PDEPOSIT_PAYMENT_API;
    }

    public function getPrefix() {
        return 'paybus_spay_p2pdeposit';
    }
