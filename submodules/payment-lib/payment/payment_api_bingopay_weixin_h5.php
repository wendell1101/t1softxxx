 ...
 * 
 *
 * bingopay_WEIXIN_PAYMENT_API, ID: 657
 *
 * Required Fields:
 * * URL
 * * Account
 ...
 */
class Payment_api_bingopay_weixin_h5 extends Abstract_payment_api_bingopay {

	public function getPlatformCode() {
		return BINGOPAY_WEIXIN_PAYMENT_API;
	}

	public function getPrefix() {
		return 'bingopay_weixin';
	}
