 ...
 */
class Payment_api_aobangpay_weixin_h5 extends Abstract_payment_api_aobangpay {

	public function getPlatformCode() {
		return AOBANGPAY_WEIXIN_H5_PAYMENT_API;
	}

	public function getPrefix() {
		return 'aobangpay_weixin_h5';
	}

	protected function configParams(&$params, $direct_pay_extra_info) {
        $params['product_type'] = self::PRODUCT_TYPE_WEIXIN_H5;
	}
