 ...
 */
class Payment_api_paybus_heropay_bank_8002 extends Abstract_payment_api_paybus {

    public function getPlatformCode() {
        return PAYBUS_HEROPAY_BANK_8002_PAYMENT_API;
    }

    public function getPrefix() {
        return 'paybus_heropay_bank_8002';
    }

    protected function configParams(&$params, $direct_pay_extra_info) {
        $params['channel_input'] = json_decode(json_encode([
            self::CHANNEL_HEROPAY_BANK_8002 => array(
