<?php
require_once dirname(__FILE__) . '/abstract_payment_api_69ya.php';

/**
 * _69YA
 *
 * * _69YA_ALIPAY_H5_PAYMENT_API, ID:
 *
 * Required Fields:
 * * URL
 * * Account
 ...
 */
class Payment_api_69ya_alipay_h5 extends Abstract_payment_api_69ya {

    public function getPlatformCode() {
        return _69YA_ALIPAY_H5_PAYMENT_API;
    }

    public function getPrefix() {
        return '69ya_alipay_h5';
    }

    protected function configParams(&$params, $direct_pay_extra_info) {
        $params['payMethod'] = self::PAYMETHOD_ALIPAY;
        $params['haveH5'] = 1;
    }
