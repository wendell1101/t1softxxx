 ...
 */
class Payment_api_pppay_weixin extends Abstract_payment_api_pppay {

    public function getPlatformCode() {
        return PPPAY_WEIXIN_PAYMENT_API;
    }
    ...
    protected function configParams(&$params, $direct_pay_extra_info) {
        ...
        if($this->CI->utils->is_mobile()){
            ...
            $params['payment_1'] = self::PAYTYPE_WEIXIN.$params['requestAmount'];
        }
    }
