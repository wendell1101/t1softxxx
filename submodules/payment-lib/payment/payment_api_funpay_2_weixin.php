 ...
 * FUNPAY_2
 *
 * * FUNPAY_2_WEIXIN_PAYMENT_API, ID: 5221
 *
 * Required Fields:
 * * URL
 * * Account
 ...
 *
 * Field Values:
 * * URL: http://paypaul.385mall.top/onlinepay/scanPayApi
 * * Account: ## User ID ##
 * * Key: ## Secret Key ##
 *
 *
 ...
 */
class Payment_api_funpay_2_weixin extends Abstract_payment_api_funpay_2
{
     public function getPlatformCode()
     {
          return FUNPAY_2_WEIXIN_PAYMENT_API;
     }

     public function getPrefix()
     {
          return 'funpay_2_weixin';
     }

     protected function configParams(&$params, $direct_pay_extra_info)
     {
          if ($this->CI->utils->is_mobile()) {
               $params['transCode'] = self::TRANSCODE_MOBILE;
          }
          $params['service'] = self::SERVICE_WEIXIN;
     }
          ...
          if ($type == 'float_amount_limit') {
               return array(
                    array(
                         ...
                         'float_amount_limit' => $this->getSystemInfo('float_amount_limit'),
                         'float_amount_limit_msg' => $float_amount_limit_msg
                    )
               );
          } else {
               return array(array('name' => 'deposit_amount', 'type' => $type, 'label_lang' => 'cashier.09'));
          }
     }
