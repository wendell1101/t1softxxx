 ...
 * VNPAY
 *
 * * VNPAY_ZALO_PAYMENT_API, ID: 5816
 *
 * Required Fields:
 * * URL
 * * Key
 ...
 */
class Payment_api_vnpay_zalo extends Abstract_payment_api_vnpay {

    public function getPlatformCode() {
        return VNPAY_ZALO_PAYMENT_API;
    }
    ...
    protected function configParams(&$params, $direct_pay_extra_info) {
        $params['channel'] = self::CHANNEL_DEPOSIT_ZALO;
    }
