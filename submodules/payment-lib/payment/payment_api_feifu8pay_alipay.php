 ...
 * 
 * 
 * * FEIFU8PAY_ALIPAY_PAYMENT_API, ID: 754
 *
 * Required Fields:
 * * URL
 * * Account
 ...
 */
class Payment_api_feifu8pay_alipay extends Abstract_payment_api_feifu8pay {

	public function getPlatformCode() {
		return FEIFU8PAY_ALIPAY_PAYMENT_API;
	}

	public function getPrefix() {
		return 'feifu8pay_alipay';
	}

	protected function configParams(&$params, $direct_pay_extra_info) {
        if($this->CI->utils->is_mobile()) {

            $params['pay_bankcode'] =($this->getSystemInfo('usepcali')) ?self::SCANTYPE_ALIPAY : self::SCANTYPE_ALIPAY_H5;
		}
		else {
			$params['pay_bankcode'] = self::SCANTYPE_ALIPAY;
		}
	}
