 ...
 */
class Payment_api_paybus_heropay_bank_withdrawal extends Abstract_payment_api_paybus {

    public function getPlatformCode() {
        return PAYBUS_HEROPAY_BANK_WITHDRAWAL_PAYMENT_API;
    }

    public function getPrefix() {
        return 'paybus_heropay_bank_withdrawal';
    }
    ...
    public function getWithdrawParams($bank, $accNum, $name, $amount, $transId) {
        ...
        $params['channel_input'] = json_decode(json_encode([
            self::CHANNEL_HEROPAY_BANK_WITHDRAWAL => [
                'clientIp'    => $this->CI->utils->getIP(),
                "bankCode"    => $bankCode,
                "bankNetName" => $playerBankDetails['branch'],
                "accountType" => "1",
                "accountName" => $name,
                "accountNo"   => $accNum,
            ]]));
