 ...
 */
class Payment_api_paybus_hpay_paymaya_withdrawal extends Abstract_payment_api_paybus {

    public function getPlatformCode() {
        return PAYBUS_HPAY_PAYMAYA_WITHDRAWAL_PAYMENT_API;
    }

    public function getPrefix() {
        return 'paybus_hpay_paymaya_withdrawal';
    }
    ...
    public function getWithdrawParams($bank, $accNum, $name, $amount, $transId) {
        ...
        $params['channel_input'] = json_decode(json_encode([self::CHANNEL_HPAY_PAYMAYA => ['bank_card_name' => $name, "bank_card_account"=>(int)$accNum,'bank_card_remark' => "no"]]));
