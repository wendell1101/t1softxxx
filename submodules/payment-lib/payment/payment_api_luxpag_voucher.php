 ...
 */
class Payment_api_luxpag_voucher extends Abstract_payment_api_luxpag {

	public function getPlatformCode() {
		return LUXPAG_VOUCHER_PAYMENT_API;
	}

	public function getPrefix() {
		return 'luxpag_voucher';
	}

	protected function configParams(&$params, $direct_pay_extra_info) {
        $params['method'] = self::CHANNEL_VOUCHER;
	}
