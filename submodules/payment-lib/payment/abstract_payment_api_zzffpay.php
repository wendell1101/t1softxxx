 ...
 *
 * * ZZFFPAY_PAYMENT_API, ID: 151
 * * ZZFFPAY_ALIPAY_PAYMENT_API, ID: 152
 * * ZZFFPAY_WECHAT_PAYMENT_API, ID: 153
 *
 * Required Fields:
 *
 * * URL
 ...
 */
abstract class Abstract_payment_api_zzffpay extends Abstract_payment_api {
	...
	public function generatePaymentUrlForm($orderId, $playerId, $amount, $orderDateTime, $playerPromoId = null, $enabledSecondUrl = true, $bankId = null) {
		...
		# Fixed values
		$params['PayType'] = 'ZFDT'; # fixed value
		$params['CurCode'] = 'RMB';
