 ...
 * TONGBAO
 *
 * * TONGBAO_ALIPAY_PAYMENT_API, ID: 5802
 *
 * Required Fields:
 * * URL
 * * Account
 ...
 */
class Payment_api_tongbao_alipay extends Abstract_payment_api_tongbao {

    public function getPlatformCode() {
        return TONGBAO_ALIPAY_PAYMENT_API;
    }

    public function getPrefix() {
        return 'tongbao_alipay';
    }

    protected function configParams(&$params, $direct_pay_extra_info) {
        $params['payment_type'] = self::PAYMENT_TYPE_ALIPAY;
    }
