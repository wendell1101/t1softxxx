 ...
 *
 * Field Values:
 * * URL: http://www.goldegg.com.cn/GateWay/ReceiveBank.aspx
 * * Account: ## Merchant ID ##
 * * Key: ## Secret Key ##
 *
 * @category Payment
 ...
 */
class Payment_api_gm_qqpay extends Abstract_payment_api_gm {

	public function getPlatformCode() {
		return GM_QQPAY_PAYMENT_API;
	}
