 ...
 */
class Payment_api_xinyitong_alipay extends Abstract_payment_api_xinyitong {

	public function getPlatformCode() {
		return XINYITONG_ALIPAY_PAYMENT_API;
	}

	public function getPrefix() {
		return 'xinyitong_alipay';
	}
	...
	protected function configParams(&$params, $direct_pay_extra_info) {
        if($this->CI->utils->is_mobile()) {
            ...
            $params['pd_FrpId'] = self::PD_FRPID_ALIPAY;
        }
	}
