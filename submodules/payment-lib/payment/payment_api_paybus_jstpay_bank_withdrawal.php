...
/**
 *
 * * PAYBUS_JSTPAY_BANK_WITHDRAWAL_PAYMENT_API
 *
 * Field Values:
 * * Account: ## User ID ##
 * * Key: ## Secret Key ##
 ...
 */
class Payment_api_paybus_jstpay_bank_withdrawal extends Abstract_payment_api_paybus {
    const CHANNEL_JSTPAY_BANK_WITHDRAWA = 'jstpay.bank';

    public function getPlatformCode() {
        return PAYBUS_JSTPAY_BANK_WITHDRAWAL_PAYMENT_API;
    }

    public function getPrefix() {
        return 'paybus_jstpay_bank_withdrawal';
    }
    ...
    public function getWithdrawParams($bank, $accNum, $name, $amount, $transId) {
        ...
        $params['channel_input'] = json_decode(json_encode([
            self::CHANNEL_JSTPAY_BANK_WITHDRAWA => [
                'RealName' => $lastname.' '.$firstname,
                'CashCardNumber' => $accNum,
                'BankName' => $bankCode,
