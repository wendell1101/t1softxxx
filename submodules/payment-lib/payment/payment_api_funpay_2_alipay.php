 ...
 */
class Payment_api_funpay_2_alipay extends Abstract_payment_api_funpay_2 {

    public function getPlatformCode() {
        return FUNPAY_2_ALIPAY_PAYMENT_API;
    }

    public function getPrefix() {
        return 'funpay_2_alipay';
    }
    ...
    protected function configParams(&$params, $direct_pay_extra_info) {
        ...
        $params['service'] = self::SERVICE_ALIPAY;
    }
