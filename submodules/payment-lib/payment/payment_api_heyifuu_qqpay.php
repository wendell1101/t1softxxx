 ...
 *
 * HEYIFUU_QQPAY_PAYMENT_API, ID: 361
 *
 ...
 */
class Payment_api_heyifuu_qqpay extends Abstract_payment_api_heyifuu {
	...
	public function getPlatformCode() {
		return HEYIFUU_QQPAY_PAYMENT_API;
	}

	public function getPrefix() {
		return 'heyifuu_qqpay';
	}
