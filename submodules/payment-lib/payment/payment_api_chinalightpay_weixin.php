 ...
 *
 * CHINALIGHTPAY_WEIXIN_PAYMENT_API, ID: 604
 *
 * Required Fields:
 *
 * * URL
 ...
 * @copyright 2022 tot
 */
class Payment_api_chinalightpay_weixin extends Abstract_payment_api_ddbill {

	public function getPlatformCode() {
		return CHINALIGHTPAY_WEIXIN_PAYMENT_API;
	}

	public function getPrefix() {
		return 'chinalightpay_weixin';
	}
	...
	protected function configParams(&$params, $direct_pay_extra_info) {
		...
		if($this->utils->is_mobile() && $this->getSystemInfo('h5_url')) {
			$params['service_type'] = 'weixin_h5api';
		}
