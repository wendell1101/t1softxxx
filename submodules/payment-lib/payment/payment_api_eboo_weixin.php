 ...
 */
class Payment_api_eboo_weixin extends Abstract_payment_api_eboo {

	public function getPlatformCode() {
		return EBOO_WEIXIN_PAYMENT_API;
	}
    ...
    protected function getBankCode() {
        if($this->CI->utils->is_mobile()) {
            return $this->getSystemInfo("mobile_bankcode", self::BANKCODE_WEIXIN_H5);
        }
        else{
