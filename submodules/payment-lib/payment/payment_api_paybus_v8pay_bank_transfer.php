 ...
 * paybus
 *
 * * PAYBUS_V8PAY_BANK_TRANSFER_PAYMENT_API, ID: 6586
 *
 * Field Values:
 ...
 */
class Payment_api_paybus_v8pay_bank_transfer extends Abstract_payment_api_paybus {

    const CHANNEL_V8PAY_BANK_TRANSFER = 'v8pay.bank_transfer';

    public function getPlatformCode() {
        return PAYBUS_V8PAY_BANK_TRANSFER_PAYMENT_API;
    }

    public function getPrefix() {
        return 'paybus_v8pay_bank_transfer';
    }
    ...
    protected function configParams(&$params, $direct_pay_extra_info) {
        ...
        $params['channel_input'] = json_decode(json_encode([
            self::CHANNEL_V8PAY_BANK_TRANSFER => array(
