...
/**
 * PAYBUS_DGMAYA_WITHDRAWAL_
 *
 * * PAYBUS_DGMAYA_WITHDRAWAL_PAYMENT_API ID: 6459
 *
 * Field Values:
 * * Account: ## User ID ##
 * * Key: ## Secret Key ##
 ...
 */
class Payment_api_paybus_dgmaya_withdrawal extends Abstract_payment_api_paybus {

    public function getPlatformCode() {
        return PAYBUS_DGMAYA_WITHDRAWAL_PAYMENT_API;
    }

    public function getPrefix() {
        return 'paybus_dgmaya_withdrawal';
    }
    ...
    public function getWithdrawParams($bank, $accNum, $name, $amount, $transId) {
        ...
        $params['channel_input'] = [
            self::CHANNEL_DGMAYA_WITHDRAWAL => [
                'bank_id' => $bankInfo[$bank]['code'], 
