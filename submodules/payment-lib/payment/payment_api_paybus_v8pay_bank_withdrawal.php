...
/**
 *
 * * PAYBUS_V8PAY_BANK_WITHDRAWAL_PAYMENT_API
 *
 * Field Values:
 * * Account: ## User ID ##
 * * Key: ## Secret Key ##
 ...
 */
class Payment_api_paybus_v8pay_bank_withdrawal extends Abstract_payment_api_paybus {
    const CHANNEL_V8PAY_BANK_WITHDRAWAL = 'v8pay.bank';

    public function getPlatformCode() {
        return PAYBUS_V8PAY_BANK_WITHDRAWAL_PAYMENT_API;
    }

    public function getPrefix() {
        return 'paybus_v8pay_bank_withdrawal';
    }
    ...
    public function getWithdrawParams($bank, $accNum, $name, $amount, $transId) {
        ...
        $params['channel_input'] = json_decode(json_encode([
            self::CHANNEL_V8PAY_BANK_WITHDRAWAL => [
    ...
    public function getBankInfo() {
        ...
        if(!empty($bankInfoArr)) {
            ...
            $bankInfo =  array(
                "37" => [
                    "name" => "KBank - Ngân hàng Đại chúng TNHH Kasikornbank (KASIKORNBANK)",
                    "code" => "8040"
                ]
            );
