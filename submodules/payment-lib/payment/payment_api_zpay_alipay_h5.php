<?php
require_once dirname(__FILE__) . '/abstract_payment_api_zpay.php';
 ...
 *
 * Field Values:
 * * URL: http://api.payba.top/order/pay
 * * Account: ## MerchantID ##
 * * Key: ## Token ##
 *
 *
 ...
 */
class Payment_api_zpay_alipay_h5 extends Abstract_payment_api_zpay {

    public function getPlatformCode() {
        return ZPAY_ALIPAY_H5_PAYMENT_API;
    }

    public function getPrefix() {
        return 'zpay_alipay_h5';
    }

    protected function configParams(&$params, $direct_pay_extra_info) {
        $params['transtype'] = self::TYPE_ALIPAY;
    }
