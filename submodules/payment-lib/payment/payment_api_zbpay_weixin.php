 ...
 */
class Payment_api_zbpay_weixin extends Abstract_payment_api_zbpay {

	public function getPlatformCode() {
		return ZBPAY_WEIXIN_PAYMENT_API;
	}
	...
	protected function configParams(&$params, $direct_pay_extra_info) {
		$params['paytype'] = $this->utils->is_mobile() ? self::PAYTYPE_WEIXIN_H5 : self::PAYTYPE_WEIXIN;
	}
