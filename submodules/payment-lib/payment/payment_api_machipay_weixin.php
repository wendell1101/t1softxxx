 ...
 */
class Payment_api_machipay_weixin extends Abstract_payment_api_machipay {

    public function getPlatformCode() {
        return MACHIPAY_WEIXIN_PAYMENT_API;
    }

    public function getPrefix() {
        return 'machipay_weixin';
    }

    protected function configParams(&$params, $direct_pay_extra_info) {
        $params['txnSubType'] = self::SUBTYPE_WEIXIN;
    }
