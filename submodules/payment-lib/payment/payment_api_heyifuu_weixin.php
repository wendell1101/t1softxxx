 ...
 *
 * HEYIFUU_WEIXIN_PAYMENT_API, ID: 360
 *
 ...
 */
class Payment_api_heyifuu_weixin extends Abstract_payment_api_heyifuu {
	...
	public function getPlatformCode() {
		return HEYIFUU_WEIXIN_PAYMENT_API;
	}

	public function getPrefix() {
		return 'heyifuu_weixin';
	}
