 ...
 * paybus
 *
 * * PAYBUS_JSTPAY_ZALO_PAY_PAYMENT_API, ID: 6604
 *
 * Field Values:
 * * URL: 
 * * Account: ## User ID ##
 ...
 */
class Payment_api_paybus_jstpay_zalo_pay extends Abstract_payment_api_paybus {

    const CHANNEL_JSTPAY_ZALO_PAY = 'jstpay.zalo_pay';

    public function getPlatformCode() {
        return PAYBUS_JSTPAY_ZALO_PAY_PAYMENT_API;
    }

    public function getPrefix() {
        return 'paybus_jstpay_zalo_pay';
    }
