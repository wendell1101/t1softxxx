 ...
 */
class Payment_api_jhp_alipay_h5 extends Abstract_payment_api_jhp {

	public function getPlatformCode() {
		return JHP_ALIPAY_H5_PAYMENT_API;
	}

	public function getPrefix() {
		return 'jhp_alipay_h5';		
	}

	protected function configParams(&$params, $direct_pay_extra_info) {			
		$params['payTypeId'] = self::PAY_TYPE_ID_ALIPAY_H5;
		$params['wap']= true;
	}
