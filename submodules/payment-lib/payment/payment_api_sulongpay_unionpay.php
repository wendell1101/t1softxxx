 ...
 * SULONGPAY 
 *
 * * SULONGPAY_UNIONPAY_PAYMENT_API,  ID: 5277
 *
 * Required Fields:
 * * Account
 * * Extra Info
 ...
 */
class Payment_api_sulongpay_unionpay extends Abstract_payment_api_sulongpay {

	public function getPlatformCode() {
		return SULONGPAY_UNIONPAY_PAYMENT_API;
	}

	public function getPrefix() {
		return 'sulongpay_unionpay';
	}
