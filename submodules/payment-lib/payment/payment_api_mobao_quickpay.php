...
class Payment_api_mobao_quickpay extends Abstract_payment_api_mobao {

	public function getPlatformCode() {
		return MOBAO_QUICKPAY_PAYMENT_API;
	}

	public function getPrefix() {
		return 'mobao_quickpay';
	}

	protected function configParams(&$params, $direct_pay_extra_info) {
		$params['apiName'] = self::MOBAO_APINAME_QUICKPAY;
	}
