 ...
 */
class Payment_api_paybus_asiapay_zaloqr extends Abstract_payment_api_paybus {

    public function getPlatformCode() {
        return PAYBUS_ASIAPAY_ZALOQR_PAYMENT_API;
    }

    public function getPrefix() {
        return 'paybus_asiapay_zaloqr';
    }

    protected function configParams(&$params, $direct_pay_extra_info) {
        $params['channel_input'] = json_decode(json_encode([
            self::CHANNEL_ASIAPAY_ZALOQR => null
        ]));
    }
