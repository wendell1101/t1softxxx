 ...
 *
 * Field Values:
 * * URL: https://or.7xinpy.com/forward/orderPay
 * * Account: ## Merchant ID ##
 * * Key: ## Secret Key ##
 *
 *
 ...
 */
class Payment_api_xinpay_quickpay extends Abstract_payment_api_xinpay {

    public function getPlatformCode() {
        return XINPAY_QUICKPAY_PAYMENT_API;
    }

    public function getPrefix() {
        return 'xinpay_quickpay';
    }

    protected function configParams(&$params, $direct_pay_extra_info) {
        $params['busi_code'] = self::BUSICODE_QUICKPAY;
    }
