...
/**
 *
 * * LGVPAY_WEIXIN_PAYMENT_API, ID: 473
 *
 * Required Fields:
 * * URL
 * * Account
 ...
 */
class Payment_api_lgvpay_weixin extends Abstract_payment_api_lgvpay {

	public function getPlatformCode() {
		return LGVPAY_WEIXIN_PAYMENT_API;
	}

	public function getPrefix() {
		return 'lgvpay_weixin';
	}
