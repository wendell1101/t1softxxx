 ...
 * 
 *
 * BAOLIANPAY_WEIXIN_H5_PAYMENT_API, ID: 5036
 *
 * Required Fields:
 * * URL
 * * Account
 ...
 */
class Payment_api_baolianpay_weixin_h5 extends Abstract_payment_api_bingopay {

	public function getPlatformCode() {
		return BAOLIANPAY_WEIXIN_H5_PAYMENT_API;
	}

	public function getPrefix() {
		return 'baolianpay_weixin_h5';
	}

	protected function configParams(&$params,&$data, $direct_pay_extra_info) {
				
		$params['bus_no'] = self::DEFAULTNANK_WEIXIN_H5;
