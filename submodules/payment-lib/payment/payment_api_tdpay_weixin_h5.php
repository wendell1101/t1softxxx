 ...
 */
class Payment_api_tdpay_weixin_h5 extends Abstract_payment_api_tdpay {

    public function getPlatformCode() {
        return TDPAY_WEIXIN_H5_PAYMENT_API;
    }

    public function getPrefix() {
        return 'tdpay_weixin_h5';
    }
    ...
    protected function configParams(&$params, $direct_pay_extra_info) {
        ...
        $params['currency']  = 'CNY';
        $params['appType']   = self::APPTYPE_WEIXIN;
