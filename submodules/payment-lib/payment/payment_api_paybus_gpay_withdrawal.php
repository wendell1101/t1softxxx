 ...
 * paybus
 *
 * * PAYBUS_GPAY_WITHDRAWAL_PAYMENT_API = 6650;
 *
 * Field Values:
 ...
 *     name*: string,
 *     bankMark*: string,
 *          enum: SCB┃BAAC┃BAY┃BBL┃CIMB┃CITI┃DB┃GHB┃GSB┃HSBC┃ICBC┃ISBT┃KBANK┃KK┃KTB┃LHBANK┃MHCB┃SCBT┃SMBC┃TCRB┃TTB┃TBANK┃TSCO┃UOB
 *     recAcc*: string,
 *  }
 *
 * @category Payment
 ...
 */
class Payment_api_paybus_gpay_withdrawal extends Abstract_payment_api_paybus {

    const CHANNEL_TYPE = 'gpay.bank';
    public function getPlatformCode() {
        return PAYBUS_GPAY_WITHDRAWAL_PAYMENT_API;
    }

    public function getPrefix() {
        return 'paybus_gpay_withdrawal';
    }
    ...
    public function submitWithdrawRequest($bank, $accNum, $name, $amount, $transId) {
        ...
        if(!array_key_exists($bank, $this->getBankInfo())) {
            ...
            return array('success' => false, 'message' => 'Bank not supported by gateway');
        }
