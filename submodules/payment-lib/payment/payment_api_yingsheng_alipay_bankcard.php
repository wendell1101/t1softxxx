 ...
 */
class Payment_api_yingsheng_alipay_bankcard extends Payment_api_yingsheng_alipay {

    public function getPlatformCode() {
        return YINGSHENG_ALIPAY_BANKCARD_PAYMENT_API;
    }

    public function getPrefix() {
        return 'yingsheng_alipay_bankcard';
    }
