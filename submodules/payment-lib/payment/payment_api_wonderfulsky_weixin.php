 ...
 */
class Payment_api_wonderfulsky_weixin extends Abstract_payment_api_wonderfulsky {

    public function getPlatformCode() {
        return WONDERFULSKY_WEIXIN_PAYMENT_API;
    }

    public function getPrefix() {
        return 'wonderfulsky_weixin';
    }

    protected function configParams(&$params, $direct_pay_extra_info) {
        $params['channel'] = $this->utils->is_mobile() ? self::CHANNEL_WEIXIN_H5 : self::CHANNEL_WEIXIN;
    }
