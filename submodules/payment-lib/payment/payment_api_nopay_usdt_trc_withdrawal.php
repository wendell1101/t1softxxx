 ...
 */
class Payment_api_nopay_usdt_trc_withdrawal extends Abstract_payment_api_nopay {
    public function getPlatformCode() {
        return NOPAY_USDT_TRC_WITHDRAWAL_PAYMENT_API;
    }

    public function getPrefix() {
        return 'nopay_usdt_trc_withdrawal';
    }
