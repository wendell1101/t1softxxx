 ...
 */
class Payment_api_tdpay_unionpay extends Abstract_payment_api_tdpay {

    public function getPlatformCode() {
        return TDPAY_UNIONPAY_PAYMENT_API;
    }

    public function getPrefix() {
        return 'tdpay_unionpay';
    }
    ...
    protected function configParams(&$params, $direct_pay_extra_info) {
        ...
        $params['isGuarant']    = '0';
        $params['merPayType']   = self::MERPAYTYPE_UNIONPAY;
        unset($params['temp']);
    }
