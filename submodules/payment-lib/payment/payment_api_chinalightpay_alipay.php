 ...
 *
 * CHINALIGHTPAY_ALIPAY_PAYMENT_API, ID: 603
 *
 * Required Fields:
 *
 * * URL
 ...
 * @copyright 2022 tot
 */
class Payment_api_chinalightpay_alipay extends Abstract_payment_api_ddbill {

	public function getPlatformCode() {
		return CHINALIGHTPAY_ALIPAY_PAYMENT_API;
	}

	public function getPrefix() {
		return 'chinalightpay_alipay';
	}
	...
	protected function configParams(&$params, $direct_pay_extra_info) {
		...
		if($this->utils->is_mobile() && $this->getSystemInfo('h5_url')) {
			$params['service_type'] = 'alipay_h5api';
		}
