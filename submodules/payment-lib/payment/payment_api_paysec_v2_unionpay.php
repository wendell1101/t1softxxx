 ...
 */
class Payment_api_paysec_v2_unionpay extends Abstract_payment_api_paysec_v2 {

    public function getPlatformCode() {
        return PAYSEC_V2_UNIONPAY_PAYMENT_API;
    }

    public function getPrefix() {
        return 'paysec_v2_unionpay';
    }

    protected function configParams(&$params, $direct_pay_extra_info) {
        $params['channelCode'] = self::CHANNEL_UNIONPAY;
    }
