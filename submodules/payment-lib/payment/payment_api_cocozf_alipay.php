 ...
 */
class Payment_api_cocozf_alipay extends Abstract_payment_api_cocozf {

	public function getPlatformCode() {
		return COCOZF_ALIPAY_PAYMENT_API;
	}

	public function getPrefix() {
		return 'cocozf_alipay';
	}

	protected function configParams(&$params, $direct_pay_extra_info) {
            $params['tranType'] = self::PAYTYPE_ALIPAY;
	}
