 ...
 */
class Payment_api_paybus_asiapay_usdtqr extends Abstract_payment_api_paybus {

    public function getPlatformCode() {
        return PAYBUS_ASIAPAY_USDTQR_PAYMENT_API;
    }

    public function getPrefix() {
        return 'paybus_asiapay_usdtqr';
    }

    protected function configParams(&$params, $direct_pay_extra_info) {
        $params['channel_input'] = json_decode(json_encode([
            self::CHANNEL_ASIAPAY_USDTQR => null
        ]));
    }
