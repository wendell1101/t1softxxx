 ...
 * PAYBUS_WITHDRAWAL
 *
 * * PAYBUS_GOLDPAY_MAYA_WITHDRAWAL_PAYMENT_API
 *
 * Field Values:
 * * Account: ## User ID ##
 * * Key: ## Secret Key ##
 ...
 */
class Payment_api_paybus_goldpay_maya_withdrawal extends Abstract_payment_api_paybus {

    public function getPlatformCode() {
        return PAYBUS_GOLDPAY_MAYA_WITHDRAWAL_PAYMENT_API;
    }

    public function getPrefix() {
        return 'paybus_goldpay_maya_withdrawal';
    }
    ...
    public function submitWithdrawRequest($bank, $accNum, $name, $amount, $transId) {
        ...
        $this->utils->debug_log("=======================111111====", array_key_exists($bank, $this->getBankInfo()));
    ...
    public function getWithdrawParams($bank, $accNum, $name, $amount, $transId) {
        ...
        $this->utils->debug_log("===============================paybus Get playerDetail using [$bank] + [$accNum]", $playerDetail);
        $firstname = (!empty($playerDetail['firstName'])) ? $playerDetail['firstName'] : 'none';
        $lastname  = (!empty($playerDetail['lastName']))  ? $playerDetail['lastName']  : 'none';
        ...
        $params['channel_input'] = json_decode(json_encode([
            self::CHANNEL_GOLDPAY_MAYA_WITHDRAWAL => [
                "mobile_no" => $accNum,
                "merchant_user" => $lastname.' '.$firstname
        ]]));
    ...
    public function getBankInfo() {
        ...
        if(!empty($bankInfoArr)) {
            ...
            $bankInfo =  array(
                "50" => [
                    "name" => "Asia Commercial Joint Stock Bank (ACB)",
                    "code" => "ACB"
                ]                
            )
            ;
