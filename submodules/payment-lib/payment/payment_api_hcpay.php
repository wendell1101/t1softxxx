 ...
 */
class Payment_api_hcpay extends Abstract_payment_api_hcpay {

    public function getPlatformCode() {
        return HCPAY_PAYMENT_API;
    }
    ...
    protected function configParams(&$params, $direct_pay_extra_info) {
        $params['pay_passcode'] = $this->getSystemInfo('passcode_pc', self::PASSCODE_ONLINEBANK);
    }
