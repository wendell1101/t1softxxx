 ...
 * Field Values:
 * * Account: ## Merchant ID ##
 * * URL: https://api.fpglink.com/payment/otoSoft/v3/h5.html
 * * Extra Info:
 * > {
 ...
 */
class Payment_api_fpgpay_alipay_h5 extends Abstract_payment_api_onepay {

    public function getPlatformCode() {
        return FPGPAY_ALIPAY_H5_PAYMENT_API;
    }

    public function getPrefix() {
        return 'fpgpay_alipay_h5';
    }
