 ...
 * 
 * 
 * * FEIFU8PAY_WEIXIN_PAYMENT_API, ID: 755
 *
 * Required Fields:
 * * URL
 * * Account
 ...
 */
class Payment_api_feifu8pay_weixin extends Abstract_payment_api_feifu8pay {

	public function getPlatformCode() {
		return FEIFU8PAY_WEIXIN_PAYMENT_API;
	}

	public function getPrefix() {
		return 'feifu8pay_weixin';
	}

	protected function configParams(&$params, $direct_pay_extra_info) {
        
			$params['pay_bankcode'] = self::SCANTYPE_WEIXIN;
