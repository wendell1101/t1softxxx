 ...
 * 
 * 
 * * HOGZBO_ALIPAY_PAYMENT_API, ID: 740
 *
 * Required Fields:
 * * URL
 * * Account
 ...
 */
class Payment_api_hogzbo_alipay_h5 extends Abstract_payment_api_hogzbo {

	public function getPlatformCode() {
		return HOGZBO_ALIPAY_H5_PAYMENT_API;
	}

	public function getPrefix() {
		return 'hogzbo_alipay_h5';
	}
