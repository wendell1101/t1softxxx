 ...
 * 
 *
 * LFBPAY_ALIPAY_H5_PAYMENT_API, ID: 530
 *
 * Required Fields:
 * * URL
 * * Account
 ...
 */
class Payment_api_lfbpay_alipay_h5 extends Abstract_payment_api_lfbpay {

	public function getPlatformCode() {
		return LFBPAY_ALIPAY_H5_PAYMENT_API;
	}

	public function getPrefix() {
		return 'lfbpay_alipay_h5';
	}

	protected function configParams(&$params, $direct_pay_extra_info) {
		$params['typeId'] = self::PAYTYPE_ALIPAY;
