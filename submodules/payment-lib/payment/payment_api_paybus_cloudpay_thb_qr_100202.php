 ...
 * paybus
 *
 * * PAYBUS_CLOUDPAY_THB_QR_100202_PAYMENT_API, ID: 6566
 *
 * Field Values:
 * * Account: ## User ID ##
 * * Key: ## Secret Key ##
 ...
 */
class Payment_api_paybus_cloudpay_thb_qr_100202 extends Abstract_payment_api_paybus {

    const CHANNEL_CLOUDPAY_THB_QR_100202 = 'cloudpay_thb.qr_100202';

    public function getPlatformCode() {
        return PAYBUS_CLOUDPAY_THB_QR_100202_PAYMENT_API;
    }

    public function getPrefix() {
        return 'paybus_cloudpay_thb_qr_100202';
    }
    ...
    protected function configParams(&$params, $direct_pay_extra_info) {
		if(!empty($direct_pay_extra_info)) {
            ...
            $params['channel_input'] = json_decode(json_encode([
                self::CHANNEL_CLOUDPAY_THB_QR_100202 => array(
