 ...
 */
class Payment_api_32pay_quickpay extends Abstract_payment_api_32pay {

	public function getPlatformCode() {
		return _32PAY_QUICKPAY_PAYMENT_API;
	}

	public function getPrefix() {
		return '32pay_quickpay';
	}

	protected function configParams(&$params, $direct_pay_extra_info) {
		if($this->utils->is_mobile()) {
			$params['P_ChannelId'] = self::P_CHANNEL_QUICKPAY_WAP;
		}
		else {
