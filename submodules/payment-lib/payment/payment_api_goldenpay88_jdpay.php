 ...
 */
class Payment_api_goldenpay88_jdpay extends Abstract_payment_api_goldenpay88 {

	public function getPlatformCode() {
		return GOLDENPAY88_JDPAY_PAYMENT_API;
	}

	public function getPrefix() {
		return 'goldenpay88_jdpay';
	}
	...
	protected function configParams(&$params, $direct_pay_extra_info) {
		$params['payType'] = self::PAY_TYPE_CODE_JDPAY;
