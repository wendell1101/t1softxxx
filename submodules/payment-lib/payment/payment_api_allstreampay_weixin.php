 ...
 */
class Payment_api_allstreampay_weixin extends Abstract_payment_api_allstreampay {

	public function getPlatformCode() {
		return ALLSTREAMPAY_WEIXIN_PAYMENT_API;
	}

	public function getPrefix() {
		return 'allstreampay_weixin';
	}
	...
	protected function configParams(&$params, $direct_pay_extra_info) {
		$params['payType'] = self::PAY_TYPE_CODE_WEIXIN;
