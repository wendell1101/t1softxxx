 ...
 */
class Payment_api_paybus_onedpay_momo extends Abstract_payment_api_paybus {

    public function getPlatformCode() {
        return PAYBUS_ONEDPAY_MOMO_PAYMENT_API;
    }

    public function getPrefix() {
        return 'paybus_onedpay_momo';
    }

    protected function configParams(&$params, $direct_pay_extra_info) {
        $params['channel_input'] = json_decode(json_encode([
            self::CHANNEL_ONEDPAY_MOMO => array(
