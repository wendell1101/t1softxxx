<?php
require_once dirname(__FILE__) . '/payment_api_yspay_alipay.php';
 ...
 */
class Payment_api_yspay_alipay_2 extends Payment_api_yspay_alipay {

    public function getPlatformCode() {
        return YSPAY_ALIPAY_2_PAYMENT_API;
    }

    public function getPrefix() {
        return 'yspay_alipay_2';
    }

    protected function configParams(&$params, $direct_pay_extra_info) {
        if($this->CI->utils->is_mobile()) {
            $params['zftd'] = $this->getSystemInfo("yspay_mobile_channel") ? $this->getSystemInfo("yspay_mobile_channel") : self::PAYTYPE_ALIPAY_2_H5;
        }else{
            $params['zftd'] = $this->getSystemInfo("yspay_channel") ? $this->getSystemInfo("yspay_channel") : self::PAYTYPE_ALIPAY_2;
        }
    }
