 ...
 * PAYBUS_WITHDRAWAL
 *
 * * PAYBUS_ZPAYS_PIX_WITHDRAWAL_PAYMENT_API
 *
 * Field Values:
 * * Account: ## User ID ##
 * * Key: ## Secret Key ##
 ...
 */
class Payment_api_paybus_zpays_pix_withdrawal extends Abstract_payment_api_paybus {

    public function getPlatformCode() {
        return PAYBUS_ZPAYS_PIX_WITHDRAWAL_PAYMENT_API;
    }

    public function getPrefix() {
        return 'paybus_zpays_pix_withdrawal';
    }
    ...
    public function getWithdrawParams($bank, $accNum, $name, $amount, $transId) {
        ...
        $params['channel_input'] = json_decode(json_encode([self::CHANNEL_ZPAYS_PIX => ['pix_type' => $bankCode, 'account_number' => $player_info['cpfNumber'],'account_name' => $player_info['firstName']." ".$player_info['lastName']]]));
