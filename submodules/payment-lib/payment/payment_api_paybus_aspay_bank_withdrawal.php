 ...
 * PAYBUS_WITHDRAWAL
 *
 * * PAYBUS_ASPAY_BANK_WITHDRAWAL_PAYMENT_API
 *
 * Field Values:
 * * Account: ## User ID ##
 * * Key: ## Secret Key ##
 ...
 */
class Payment_api_paybus_aspay_bank_withdrawal extends Abstract_payment_api_paybus {

    public function getPlatformCode() {
        return PAYBUS_ASPAY_BANK_WITHDRAWAL_PAYMENT_API;
    }

    public function getPrefix() {
        return 'paybus_aspay_bank_withdrawal';
    }
    ...
    public function getWithdrawParams($bank, $accNum, $name, $amount, $transId) {
        ...
        $params['channel_input'] = json_decode(json_encode([
            self::CHANNEL_ASPAY_BANK_WITHDRAWAL => [
                'pay_bank_name'    => $bankCode,
                "pay_account_name" => $name,
                "pay_card_no"      => $accNum,
        ]]));
