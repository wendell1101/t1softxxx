...
/**
 *
 * * XIFPAY_WEIXIN_H5_PAYMENT_API, ID: 735
 *
 * Required Fields:
 * * URL
 * * Account
 ...
 */
class Payment_api_xifpay_weixin_h5 extends Abstract_payment_api_xifpay {

	public function getPlatformCode() {
		return XIFPAY_WEIXIN_H5_PAYMENT_API;
	}

	public function getPrefix() {
		return 'xifpay_weixin_h5';
	}
