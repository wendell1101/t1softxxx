 ...
 */
class Payment_api_unp_jdpay extends Abstract_payment_api_unp {

	public function getPlatformCode() {
		return UNP_JDPAY_PAYMENT_API;
	}
	...
	protected function configParams(&$params, $direct_pay_extra_info) {
		$params['tyid'] = self::PAYMENT_TYPE_JDPAY ;
	}
