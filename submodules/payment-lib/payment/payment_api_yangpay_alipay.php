 ...
 */
class Payment_api_yangpay_alipay extends Abstract_payment_api_yangpay {
	...
	public function getPlatformCode() {
		// return YANGPAY_ALIPAY_PAYMENT_API;
...
$this->CI->utils->debug_log("=====================YANGPAY getPrefix", $preFixStr);
		return $preFixStr; // 'yangpay_alipay'; // @todo 待驗證
	}
	// public function getPrefix() {
	// 	return 'yangpay_alipay';
	// }
