 ...
 */
class Payment_api_machipay_alipay_h5 extends Abstract_payment_api_machipay {

    public function getPlatformCode() {
        return MACHIPAY_ALIPAY_H5_PAYMENT_API;
    }

    public function getPrefix() {
        return 'machipay_alipay_h5';
    }

    protected function configParams(&$params, $direct_pay_extra_info) {
        $params['txnSubType'] = self::SUBTYPE_ALIPAY_H5;
    }
