 ...
 *
 * * GM_QUICKPAY_PAYMENT_API, ID: 717
 *
 * Required Fields:
 * * URL
 * * Account
 ...
 */
class Payment_api_gm_quickpay extends Abstract_payment_api_gm {

	public function getPlatformCode() {
		return GM_QUICKPAY_PAYMENT_API;
	}
	...
	public function getBankType($direct_pay_extra_info) {
		return parent::BANK_TYPE_QUICKPAY;
	}
