 ...
 *
 * * PAYBUS_MBMPAY_VNCARD_WITHDRAWAL_PAYMENT_API
 *
 * Field Values:
 * * Account: ## User ID ##
 * * Key: ## Secret Key ##
 ...
 */
class Payment_api_paybus_mbmpay_vncard_withdrawal extends Abstract_payment_api_paybus {

    public function getPlatformCode() {
        return PAYBUS_MBMPAY_VNCARD_WITHDRAWAL_PAYMENT_API;
    }

    public function getPrefix() {
        return 'paybus_mbmpay_vncard_withdrawal';
    }
    ...
    public function getWithdrawParams($bank, $accNum, $name, $amount, $transId) {
        ...
        $params['channel_input'] = json_decode(json_encode([
            self::CHANNEL_MBMPAY_VNCARD_WITHDRAWAL => [
                'bankName' => $bankName,
                'bankCode' => $bankCode,
                'cardName' => trim($name), 
                'cardNo' => $accNum,
