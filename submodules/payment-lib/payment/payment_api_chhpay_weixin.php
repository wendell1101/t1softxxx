 ...
 * @copyright 2022 tot
 */
class Payment_api_chhpay_weixin extends Abstract_payment_api_chhpay {

	public function getPlatformCode() {
		return CHHPAY_WEIXIN_PAYMENT_API;
	}

	public function getPrefix() {
		return 'chhpay_weixin';
	}

	protected function configParams(&$params, $direct_pay_extra_info) {
		if($this->CI->utils->is_mobile()) {
			$params['pa_FrpId'] = self::PAYTYPE_WEIXIN_WAP;
		}
		else {
			$params['pa_FrpId'] = self::PAYTYPE_WEIXIN;
		}	
