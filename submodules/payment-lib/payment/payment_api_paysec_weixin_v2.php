...
Class Payment_api_paysec_weixin_v2 extends Abstract_payment_api_paysec {
	public $payType = 'WECHAT_V2';

    public function getPrefix() {
        return 'paysec_weixin_v2';
	}
    ...
    protected function configParams(&$params, $direct_pay_extra_info) {
        $params['version'] = '3.0';
        $params['channelCode'] = self::FIELD_CHANNEL_CODE_WECHAT_V2;
