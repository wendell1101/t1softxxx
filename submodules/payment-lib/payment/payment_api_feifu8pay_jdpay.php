 ...
 * 
 * 
 * * FEIFU8PAY_JDPAY_PAYMENT_API, ID: 759
 *
 * Required Fields:
 * * URL
 * * Account
 ...
 */
class Payment_api_feifu8pay_jdpay extends Abstract_payment_api_feifu8pay {

	public function getPlatformCode() {
		return FEIFU8PAY_JDPAY_PAYMENT_API;
	}

	public function getPrefix() {
		return 'feifu8pay_jdpay';
	}

	protected function configParams(&$params, $direct_pay_extra_info) {
        
			$params['pay_bankcode'] = self::SCANTYPE_JDPAY;
	}
