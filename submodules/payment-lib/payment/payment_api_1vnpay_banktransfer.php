 ...
 */
class Payment_api_1vnpay_banktransfer extends Abstract_payment_api_1vnpay {

	public function getPlatformCode() {
		return _1VNPAY_BANKTRANSFER_PAYMENT_API;
	}

	public function getPrefix() {
		return '1vnpay_banktransfer';
	}
	...
	protected function configParams(&$params, $direct_pay_extra_info) {
		...
		$params['channel'] = self::CHANNEL_BANK_TRANSFER;
	}
