 ...
 * PAYBUS_WITHDRAWAL
 *
 * * PAYBUS_TFHPAY_BANK_WITHDRAWAL_PAYMENT_API, ID: 6617
 *
 * Field Values:
 * * Account: ## User ID ##
 * * Key: ## Secret Key ##
 ...
 */
class Payment_api_paybus_tfhpay_bank_withdrawal extends Abstract_payment_api_paybus {

    const CHANNEL_TFHPAY_BANK_WITHDRAWA = 'tfhpay.bank';

    public function getPlatformCode() {
        return PAYBUS_TFHPAY_BANK_WITHDRAWAL_PAYMENT_API;
    }

    public function getPrefix() {
        return 'paybus_tfhpay_bank_withdrawal';
    }
    ...
    public function getWithdrawParams($bank, $accNum, $name, $amount, $transId) {
        ...
        $params['channel_input'] = json_decode(json_encode([
            self::CHANNEL_TFHPAY_BANK_WITHDRAWA => [
                'bankCode'       => $bankCode,
                'bankCardNumber' => $accNum,
