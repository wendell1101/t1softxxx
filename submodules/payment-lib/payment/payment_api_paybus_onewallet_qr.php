 ...
 * paybus
 *
 * * PAYBUS_ONEWALLET_QR_PAYMENT_API, ID: 6476
 *
 * Field Values:
 ...
 */
class Payment_api_paybus_onewallet_qr extends Abstract_payment_api_paybus {

    public function getPlatformCode() {
        return PAYBUS_ONEWALLET_QR_PAYMENT_API;
    }

    public function getPrefix() {
        return 'paybus_onewallet_qr';
    }

    protected function configParams(&$params, $direct_pay_extra_info) {
        $params['channel_input'] = json_decode(json_encode([
            self::CHANNEL_ONEWALLET_QRPAY => [
