 ...
 */
class Payment_api_aobangpay_weixin extends Abstract_payment_api_aobangpay {

	public function getPlatformCode() {
		return AOBANGPAY_WEIXIN_PAYMENT_API;
	}

	public function getPrefix() {
		return 'aobangpay_weixin';
	}

	protected function configParams(&$params, $direct_pay_extra_info) {
        $params['product_type'] = self::PRODUCT_TYPE_WEIXIN;
	}
