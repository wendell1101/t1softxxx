 ...
 */
class Payment_api_yangpay_weixin_qr extends Abstract_payment_api_yangpay {
	...
	public function getPlatformCode() {
		...
		// return YANGPAY_WEIXIN_QR_PAYMENT_API;
...
$this->CI->utils->debug_log("=====================". $this->payUpperStr. " getPrefix", $preFixStr);
		return $preFixStr; // 'yangpay_weixin_qr'; // @todo 待驗證
	}
