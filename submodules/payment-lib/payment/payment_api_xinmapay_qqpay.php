 ...
 */
class Payment_api_xinmapay_qqpay extends Abstract_payment_api_xinmapay {

	public function getPlatformCode() {
		return XINMAPAY_QQPAY_PAYMENT_API;
	}

	public function getPrefix() {
		return 'xinmapay_qqpay';
	}
	...
	protected function configParams(&$params, $direct_pay_extra_info) {
		...
		$params['pay_type'] = self::PAYTYPE_QQPAY;
