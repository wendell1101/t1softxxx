<?php
require_once dirname(__FILE__) . '/abstract_payment_api_hcpay.php';
/**
 * ASIAPAY
 * *
 ...
 *
 * Field Values:
 * * URL: https://asiapay.cash/User_Huan_index.html
 * * Account: ## Merchant ID ##
 * * Key: ## Secret Key ##
 *
 *
 ...
 */
class Payment_api_asiapay_weixin_h5 extends Abstract_payment_api_hcpay {

    public function getPlatformCode() {
        return ASIAPAY_WEIXIN_H5_PAYMENT_API;
    }

    public function getPrefix() {
        return 'asiapay_weixin_h5';
    }

    protected function configParams(&$params, $direct_pay_extra_info) {
        $params['pay_passcode'] = $this->getSystemInfo('passcode_mobile', self::PASSCODE_WEIXIN);
    }
