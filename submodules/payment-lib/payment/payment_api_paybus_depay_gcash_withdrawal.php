...
/**
 * * PAYBUS_DEPAY_GCASH_WITHDRAWAL_PAYMENT_API
 *
 * Field Values:
 * * Account: ## User ID ##
 * * Key: ## Secret Key ##
 ...
 */
class Payment_api_paybus_depay_gcash_withdrawal extends Abstract_payment_api_paybus {

    public function getPlatformCode() {
        return PAYBUS_DEPAY_GCASH_WITHDRAWAL_PAYMENT_API;
    }

    public function getPrefix() {
        return 'paybus_depay_gcash_withdrawal';
    }
    ...
    public function getWithdrawParams($bank, $accNum, $name, $amount, $transId) {
        ...
        $params['channel_input'] = json_decode(json_encode([
            self::CHANNEL_DEPAY_GCASH_WITHDRAWAL => [
                'gcash_mobile' => $accNum
            ]]));
