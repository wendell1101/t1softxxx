 ...
 */
class Payment_api_bingopay_jdpay extends Abstract_payment_api_bingopay {

	public function getPlatformCode() {
		return BINGOPAY_JDPAY_PAYMENT_API;
	}

	public function getPrefix() {
		return 'bingopay_jdpay';
    }
	...
	protected function configParams(&$params,&$data, $direct_pay_extra_info) {
		...
		$params['bus_no'] = self::DEFAULTNANK_JDPAY;
