 ...
 */
class Payment_api_yunsheng_alipay extends Abstract_payment_api_yunsheng {

    public function getPlatformCode() {
        return YUNSHENG_ALIPAY_PAYMENT_API;
    }

    public function getPrefix() {
        return 'yunsheng_alipay';
    }

    protected function configParams(&$params, $direct_pay_extra_info) {
        $params['transtype'] = self::TRANSTYPE_ALIPAY;
    }
