 ...
 *
 * Field Values:
 * * URL: http://pay.pay9528.com/gateway/index/checkpoint.do
 * * Account: ## Merchant ID ##
 * * Key: ## Secret Key ##
 *
 *
 ...
 */
class Payment_api_minfu_weixin_h5 extends Abstract_payment_api_minfu {

    public function getPlatformCode() {
        return MINFU_WEIXIN_H5_PAYMENT_API;
    }

    public function getPrefix() {
        return 'minfu_weixin_h5';
    }

    protected function configParams(&$params, $direct_pay_extra_info) {
        $params['thoroughfare'] = self::THOROUGHFARE_CLOUDPAY;
        $params['method'] = self::METHOD_WEIXIN;
