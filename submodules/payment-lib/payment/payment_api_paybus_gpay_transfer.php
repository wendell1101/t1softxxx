 ...
 */
class Payment_api_paybus_gpay_transfer extends Abstract_payment_api_paybus {

    const CHANNEL_TYPE = 'gpay.transfer';
    private $playerId;
    private $bankCodeUse;
    ...
    public function getPlatformCode() {
        return PAYBUS_GPAY_TRANSFER_PAYMENT_API;
    }

    public function getPrefix() {
        return 'paybus_gpay_transfer';
    }
