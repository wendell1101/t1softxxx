 ...
 */
class Payment_api_beibeiso_weixin extends Abstract_payment_api_beibeiso {

	public function getPlatformCode() {
		return BEIBEISO_WEIXIN_PAYMENT_API;
	}

	public function getPrefix() {
		return 'beibeiso_weixin';
	}

	protected function configParams(&$params, $direct_pay_extra_info) {
        if($this->CI->utils->is_mobile()) {
            $params['type'] = self::P_CHANNEL_WEIXIN_H5;
        }
        else {
