<?php
require_once dirname(__FILE__) . '/abstract_payment_api_feimapay.php';
 ...
 */
class Payment_api_feimapay_alipay extends Abstract_payment_api_feimapay {

    public function getPlatformCode() {
        return FEIMAPAY_ALIPAY_PAYMENT_API;
    }

    public function getPrefix() {
        return 'feimapay_alipay';
    }

    protected function configParams(&$params, $direct_pay_extra_info) {
        $params['bank_id'] = self::BANKID_ALIPAY;
    }
