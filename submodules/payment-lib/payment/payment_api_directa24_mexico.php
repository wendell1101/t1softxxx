 ...
 */
class Payment_api_directa24_mexico extends Abstract_payment_api_directa24 {

	public function getPlatformCode() {
		return DIRECTA24_MEXICO_PAYMENT_API;
	}

	public function getPrefix() {
		return 'directa24_mexico';
	}

	protected function configParams(&$params, $direct_pay_extra_info) {
		// $params['payment_method'] = self::PAYWAY_UPI;
		$extraInfo = json_decode($direct_pay_extra_info, true);
        $params['country']        = $this->getSystemInfo('payment_country') ? $this->getSystemInfo('payment_country') : self::PAYMENT_COUNTRY_MX;
	...
	public function getPlayerInputInfo() {
		...
		$country = $this->getSystemInfo('payment_country') ? $this->getSystemInfo('payment_country') : self::PAYMENT_COUNTRY_MX;
