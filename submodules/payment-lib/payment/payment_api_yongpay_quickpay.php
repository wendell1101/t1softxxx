 ...
 */
class Payment_api_yongpay_quickpay extends Abstract_payment_api_yongpay {

	public function getPlatformCode() {
		return YONGPAY_QUICKPAY_PAYMENT_API;
	}

	public function getPrefix() {
		return 'yongpay_quickpay';
    }

	protected function configParams(&$params, $direct_pay_extra_info) {
        $params['pay_channelCode'] = self::DEFAULTNANK_QUICKPAY;
	}
