 ...
 */
class Payment_api_paybus_goldpay_gcash_direct extends Abstract_payment_api_paybus {

    public function getPlatformCode() {
        return PAYBUS_GOLDPAY_GCASH_DIRECT_PAYMENT_API;
    }

    public function getPrefix() {
        return 'paybus_goldpay_gcash_direct';
    }
    ...
    protected function configParams(&$params, $direct_pay_extra_info) {
        ...
        $params['channel_input'] = json_decode(json_encode([
            self::CHANNEL_GOLDPAY_GCASH_DIRECT => array(
