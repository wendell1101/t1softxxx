 ...
 */
class Payment_api_yongpay_alipay extends Abstract_payment_api_yongpay {

	public function getPlatformCode() {
		return YONGPAY_ALIPAY_PAYMENT_API;
	}

	public function getPrefix() {
		return 'yongpay_alipay';
    }
	...
	protected function configParams(&$params, $direct_pay_extra_info) {
        if($this->CI->utils->is_mobile()) {
            ...
            $params['pay_channelCode'] = self::DEFAULTNANK_ALIPAY;
        }
	}
