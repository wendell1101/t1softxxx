...
/**
 * PAYBUS_WWWPAGO_PIX_WITHDRAWAL
 *
 * * PAYBUS_WWWPAGO_PIX_WITHDRAWAL_PAYMENT_API
 *
 * Field Values:
 * * Account: ## User ID ##
 * * Key: ## Secret Key ##
 ...
 */
class Payment_api_paybus_wwwpago_pix_withdrawal extends Abstract_payment_api_paybus {

    public function getPlatformCode() {
        return PAYBUS_WWWPAGO_PIX_WITHDRAWAL_PAYMENT_API;
    }

    public function getPrefix() {
        return 'paybus_wwwpago_pix_withdrawal';
    }
    ...
    public function getWithdrawParams($bank, $accNum, $name, $amount, $transId) {
        ...
        $params['channel_input'] = json_decode(json_encode([self::CHANNEL_WWWPAGO_PIX => ['account_type' => $bank_name, 'account_no' => $player_info['pixAccount'], 'account_name' => trim($name), 'cpf' => $player_info['cpfNumber']]]));
