 ...
 */
class Payment_api_kaituo_weixin_h5 extends Abstract_payment_api_kaituo {

    public function getPlatformCode() {
        return KAITUO_WEIXIN_H5_PAYMENT_API;
    }

    public function getPrefix() {
        return 'kaituo_weixin_h5';
    }

    protected function configParams(&$params, $direct_pay_extra_info) {
        $params['trade_type'] = self::TRADE_TYPE_H5;
        $params['payment']    = self::PAYMENT_WEIXIN_H5;
