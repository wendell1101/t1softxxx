 ...
 */
class Payment_api_bingopay_alipay extends Abstract_payment_api_bingopay {

	public function getPlatformCode() {
		return BINGOPAY_ALIPAY_PAYMENT_API;
	}

	public function getPrefix() {
		return 'bingopay_alipay';
    }
	...
	protected function configParams(&$params,&$data, $direct_pay_extra_info) {
		...
		$params['bus_no'] = self::DEFAULTNANK_ALIPAY;
