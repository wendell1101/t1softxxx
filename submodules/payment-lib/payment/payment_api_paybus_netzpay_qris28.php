 ...
 * paybus
 *
 * * PAYBUS_NETZPAY_QRIS28_PAYMENT_API
 *
 * Field Values:
 ...
 */
class Payment_api_paybus_netzpay_qris28 extends Abstract_payment_api_paybus {
    const CHANNEL_NETZPAY_QRIS28 = 28;
    public function getPlatformCode() {
        return PAYBUS_NETZPAY_QRIS28_PAYMENT_API;
    }

    public function getPrefix() {
        return 'paybus_netzpay_qris28';
    }

    protected function configParams(&$params, $direct_pay_extra_info) {
        $params['binding_id'] = self::CHANNEL_NETZPAY_QRIS28;
