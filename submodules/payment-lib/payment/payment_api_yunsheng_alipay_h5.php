<?php
require_once dirname(__FILE__) . '/abstract_payment_api_yunsheng.php';
 ...
 */
class Payment_api_yunsheng_alipay_h5 extends Abstract_payment_api_yunsheng {

    public function getPlatformCode() {
        return YUNSHENG_ALIPAY_H5_PAYMENT_API;
    }

    public function getPrefix() {
        return 'yunsheng_alipay_h5';
    }

    protected function configParams(&$params, $direct_pay_extra_info) {
        $params['transtype'] = self::TRANSTYPE_ALIPAY_H5;
    }
