 ...
 */
class Payment_api_paybus_payga_phqr extends Abstract_payment_api_paybus {

    public function getPlatformCode() {
        return PAYBUS_PAYGA_PHQR_PAYMENT_API;
    }

    public function getPrefix() {
        return 'paybus_payga_phqr';
    }
