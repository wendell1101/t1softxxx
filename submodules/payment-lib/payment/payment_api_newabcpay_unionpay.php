<?php
require_once dirname(__FILE__) . '/abstract_payment_api_newabcpay.php';
 ...
 */
class Payment_api_newabcpay_unionpay extends Abstract_payment_api_newabcpay {

	public function getPlatformCode() {
		return NEWABCPAY_UNIONPAY_PAYMENT_API;
	}

	public function getPrefix() {
		return 'newabcpay_unionpay';
	}

	protected function configParams(&$params, $direct_pay_extra_info) {
           	$params['paySign'] = self::PAYSIGN_UNIONPAY;
	}
