 ...
 * VNPAY
 *
 * * VNPAY_MOMO_PAYMENT_API, ID: 5817
 *
 * Required Fields:
 * * URL
 * * Key
 ...
 */
class Payment_api_vnpay_momo extends Abstract_payment_api_vnpay {

    public function getPlatformCode() {
        return VNPAY_MOMO_PAYMENT_API;
    }
    ...
    protected function configParams(&$params, $direct_pay_extra_info) {
        $params['channel'] = self::CHANNEL_DEPOSIT_MOMO;
    }
