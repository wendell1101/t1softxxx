<?php
require_once dirname(__FILE__) . '/abstract_payment_api_huanyu.php';
 ...
 */
class Payment_api_huanyu_weixin_h5 extends Abstract_payment_api_huanyu {

    public function getPlatformCode() {
        return HUANYU_WEIXIN_H5_PAYMENT_API;
    }

    public function getPrefix() {
        return 'huanyu_weixin_h5';
    }

    protected function configParams(&$params, $direct_pay_extra_info) {
        $params['trade_type'] = $this->utils->is_mobile() ? self::TRADE_TYPE_H5 : self::TRADE_TYPE_SCAN;
    }
