...
/**
 * PAYBUS_ONEFORPAY_BANK_WITHDRAWAL
 *
 * * PAYBUS_ONEFORPAY_BANK_WITHDRAWAL_PAYMENT_API
 *
 * Field Values:
 * * Account: ## User ID ##
 * * Key: ## Secret Key ##
 ...
 */
class Payment_api_paybus_oneforpay_bank_withdrawal extends Abstract_payment_api_paybus {

    public function getPlatformCode() {
        return PAYBUS_ONEFORPAY_BANK_WITHDRAWAL_PAYMENT_API;
    }

    public function getPrefix() {
        return 'paybus_oneforpay_bank_withdrawal';
    }
    ...
    public function getWithdrawParams($bank, $accNum, $name, $amount, $transId) {
        ...
        $params['channel_input'] = json_decode(json_encode([self::CHANNEL_ONEFORPAY_BANK_WITHDRAWAL => ['membercode' => $username, 'fullname' => trim($name), 'bankcode' => $bankCode, 'accountno' => $accNum]]));
        ...
        if(!empty($bankInfoArr)) {
            ...
            $bankInfo =  array(
                "28"=>  array(
                    ...
                    "code"=>  "BANGKOK BANK PUBLIC COMPANY LTD."
                ),
                "29"=>  array(
                    "name"=>  "Krung Thai Bank (KTB)",
                    "code"=>  "KRUNG THAI BANK PUBLIC COMPANY LTD."
                ),
                "30"=>  array(
                    "name"=>  "Siam Commerical Bank (SCB)",
                    "code"=>  "SIAM COMMERCIAL BANK PUBLIC COMPANY LTD."
                ),
                "31"=>  array(
                    "name"=>  "Kasikorn Thai Bank (KBANK)",
                    "code"=>  "KASIKORNBANK PUBLIC COMPANY LIMITED"
                ),
                "32"=>  array(
                    "name"=>  "TMBThanachart Bank (TTB)",
                    "code"=>  "THANACHART BANK PUBLIC COMPANY LIMITED"
                ),
                "33"=>  array(
                    "name"=>  "Krungsri Ayudhya Bank (BAY)",
                    "code"=>  "BANK OF AYUDHYA"
                ),
                "34"=>  array(
                    "name"=>  "CIMB Thai Bank",
                    "code"=>  "CIMB (THAI) PUBLIC COMPANY LIMITED"
                ),
                "35"=>  array(
                    "name"=>  "Citi Bank",
                    "code"=>  "CITIBANK, N.A. (CITI), BANGKOK BRANCH"
                ),
                "36"=>  array(
                    "name"=>  "The Hongkong and Shanghai Banking Corporation Limited (HSBC)",
                    "code"=>  "HONGKONG and SHANGHAI CORPORATION LTD."
                ),
                "37"=>  array(
                    "name"=>  "Kiatnakin Bank",
                    "code"=>  "KIATNAKIN PHATRA BANK PUBLIC COMPANY LIMITED"
                ),
                "38"=>  array(
                    "name"=>  "Standard Chartered Bank (SCBT)",
                    "code"=>  "STANDARD CHARTERED BANK (THAI) PUBLIC COMPANY LTD."
                ),
                "40"=>  array(
                    "name"=>  "United Overseas Bank (UOB)",
                    "code"=>  "UNITED OVERSEAS BANK (THAI) PUBLIC COMPANY LIMITED"
                ),
                "43"=>  array(
                ...
                "44"=>  array(
                    ...
                    "code"=>  "BANK FOR AGRICULTURE AND AGRICULTURAL CO-OPERATIVES"
                ),
                "47"=>  array(
                    "name"=>  "Government Housing Bank (GHB)",
                    "code"=>  "GOVERNMENT HOUSING BANK"
                ),
                "56"=>  array(
                    "name"=>  "Sumitomo Mitsui Banking Corporation",
                    "code"=>  "SUMITOMO MITSUI BANKING CORPORATION (SMBC)"
                ),
                "62"=>  array(
                ...
                "63"=>  array(
                    ...
                    "code"=>  "ISLAMIC BANK OF THAILAND (ISBT)"
                ),
                "65"=>  array(
                    "name"=>  "Industrial and Commercial Bank of China",
                    "code"=>  "INDUSTRIAL AND COMMERCIAL BANK OF CHAINA (THAI)"
                ),
                "66"=>  array(
                    "name"=>  "The Thai Credit Retail Bank",
                    "code"=>  "THAI CREDIT RETAIL BANK PUBLIC COMPANY LIMITED (TCRB)"
                ),
                "67"=>  array(
                    "name"=>  "Land and House Bank",
                    "code"=>  "LAND AND HOUSES RETAIL BANK PUBLIC COMPANY LIMITED"
                ),
            )
            ;
