 ...
 */
class Payment_api_machipay_quickpay extends Abstract_payment_api_machipay {

    public function getPlatformCode() {
        return MACHIPAY_QUICKPAY_PAYMENT_API;
    }

    public function getPrefix() {
        return 'machipay_quickpay';
    }

    protected function configParams(&$params, $direct_pay_extra_info) {
        $params['txnSubType'] = self::SUBTYPE_QUICKPAY;
    }
