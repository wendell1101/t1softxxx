<?php
require_once dirname(__FILE__) . '/abstract_payment_api_zypay.php';
 ...
 */
class Payment_api_zypay_alipay_packet extends Abstract_payment_api_zypay {

    public function getPlatformCode() {
        return ZYPAY_ALIPAY_PACKET_PAYMENT_API;
    }

    public function getPrefix() {
        return 'zypay_alipay_packet';
    }

    protected function configParams(&$params, $direct_pay_extra_info) {
        $params['pay_code'] = self::PAY_CODE_ALIPAY_PACKET;
    }
