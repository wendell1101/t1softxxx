 ...
 */
class Payment_api_angelpay_qqpay extends Abstract_payment_api_angelpay {

    public function getPlatformCode() {
        return ANGELPAY_QQPAY_PAYMENT_API;
    }

    public function getPrefix() {
        return 'angelpay_qqpay';
    }
    ...
    protected function configParams(&$params, $direct_pay_extra_info) {
        if($this->CI->utils->is_mobile()) {
            ...
            $params['channeltype'] = self::CHANNEL_QQPAY;
        }
    }
