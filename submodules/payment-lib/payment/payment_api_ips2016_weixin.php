 ...
 */
class Payment_api_ips2016_weixin extends Abstract_payment_api_ips2016 {
	public function getPlatformCode() {
		return IPS2016_WEIXIN_PAYMENT_API;
	}

	public function getPrefix() {
		return 'ips2016_weixin';
	}

	protected function configParams(&$params, $order_id, $direct_pay_extra_info) {
		$params['GatewayType'] = self::GATEWAY_TYPE_WEIXIN;
	}
