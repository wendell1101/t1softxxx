 ...
 */
class Payment_api_tonfords_weixin extends Abstract_payment_api_tonfords {

	public function getPlatformCode() {
		return TONFORDS_WEIXIN_PAYMENT_API;
	}

	public function getPrefix() {
		return 'tonfords_weixin';
    }
	...
	protected function configParams(&$params, $direct_pay_extra_info) {
		...
		return $params['pay_way'] = $payWay ? $payWay: self::PAYMENT_WAY_WEIXIN;
	}
