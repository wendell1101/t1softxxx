 ...
 * paybus
 *
 * * PAYBUS_JSTPAY_VIETTEL_PAY_PAYMENT_API, ID: 6605
 *
 * Field Values:
 * * URL: 
 * * Account: ## User ID ##
 ...
 */
class Payment_api_paybus_jstpay_viettel_pay extends Abstract_payment_api_paybus {

    const CHANNEL_JSTPAY_VIETTEL_PAY = 'jstpay.viettel_pay';

    public function getPlatformCode() {
        return PAYBUS_JSTPAY_VIETTEL_PAY_PAYMENT_API;
    }

    public function getPrefix() {
        return 'paybus_jstpay_viettel_pay';
    }
    ...
    protected function configParams(&$params, $direct_pay_extra_info) {
        ...
        $params['channel_input'] = json_decode(json_encode([
            self::CHANNEL_JSTPAY_VIETTEL_PAY => [
                "UID" => $username,
