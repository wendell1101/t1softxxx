<?php
require_once dirname(__FILE__) . '/abstract_payment_api_522zf.php';
 ...
 */
class Payment_api_522zf_alipay extends Abstract_payment_api_522zf {

	public function getPlatformCode() {
		return _522ZF_ALIPAY_PAYMENT_API;
	}
	...
	protected function configParams(&$params, $direct_pay_extra_info) {
		$params['paytype'] = self::PAY_TYPE_ALIPAY;
	}
