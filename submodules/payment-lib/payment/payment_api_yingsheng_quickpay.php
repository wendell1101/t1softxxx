 ...
 */
class Payment_api_yingsheng_quickpay extends Abstract_payment_api_yingsheng {

    public function getPlatformCode() {
        return YINGSHENG_QUICKPAY_PAYMENT_API;
    }

    public function getPrefix() {
        return 'yingsheng_quickpay';
    }

    protected function configParams(&$params, $direct_pay_extra_info) {
        $params['bank_code'] = '';
        $params['service_type'] = $this->getSystemInfo('servicetype',self::SERVICETYPE_QUICKPAY_H5);
    }
