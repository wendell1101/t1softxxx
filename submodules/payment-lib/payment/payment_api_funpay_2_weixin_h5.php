 ...
 * FUNPAY_2
 *
 * * FUNPAY_2_WEIXIN_H5_PAYMENT_API, ID: 5522
 *
 * Required Fields:
 * * URL
 * * Account
 ...
 *
 * Field Values:
 * * URL: http://paypaul.385mall.top/onlinepay/h5PayApi
 * * Account: ## User ID ##
 * * Key: ## Secret Key ##
 *
 *
 ...
 */
class Payment_api_funpay_2_weixin_h5 extends Abstract_payment_api_funpay_2
{
     public function getPlatformCode()
     {
          return FUNPAY_2_WEIXIN_H5_PAYMENT_API;
     }

     public function getPrefix()
     {
          return 'funpay_2_weixin_h5';
     }
