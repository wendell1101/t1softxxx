<?php
require_once dirname(__FILE__) . '/abstract_payment_api_yifutongvip.php';

/**
 *
 *
 * YIFUTONGVIP_WEIXIN_PAYMENT_API, ID: 5330
 *
 * Required Fields:
 * * URL
 * * Account
 ...
 */
class Payment_api_yifutongvip_weixin extends Abstract_payment_api_yifutongvip {

	public function getPlatformCode() {
		return YIFUTONGVIP_WEIXIN_PAYMENT_API;
	}

	public function getPrefix() {
		return 'yifutongvip_weixin';
	}

	protected function configParams(&$params, $direct_pay_extra_info) {
		if($this->CI->utils->is_mobile()) {
            $params['pay_type'] = self::PAYTYPE_WEIXIN_H5;
        }
        else {
