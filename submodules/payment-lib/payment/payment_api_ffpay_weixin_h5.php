 ...
 */
class Payment_api_ffpay_weixin_h5 extends Abstract_payment_api_ffpay {

    public function getPlatformCode() {
        return FFPAY_WEIXIN_H5_PAYMENT_API;
    }

    public function getPrefix() {
        return 'ffpay_weixin_h5';
    }

    protected function configParams(&$params, $direct_pay_extra_info) {
        $params['BankCode'] = self::BANKCODE_WEIXIN_H5;
    }
