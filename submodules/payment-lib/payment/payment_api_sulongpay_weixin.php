 ...
 */
class Payment_api_sulongpay_weixin extends Abstract_payment_api_sulongpay {

	public function getPlatformCode() {
		return SULONGPAY_WEIXIN_PAYMENT_API;
	}

	public function getPrefix() {
		return 'sulongpay_weixin';
	}

	protected function configParams(&$params, $direct_pay_extra_info) {
            $params['trade_type'] = self::PAYTYPE_WEIXIN;
	}
