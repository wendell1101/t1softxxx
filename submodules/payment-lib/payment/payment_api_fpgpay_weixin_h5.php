 ...
 * Field Values:
 * * Account: ## Merchant ID ##
 * * URL: https://api.fpglink.com/payment/otoSoft/v3/mweb.html
 * * Extra Info:
 * > {
 ...
 */
class Payment_api_fpgpay_weixin_h5 extends Abstract_payment_api_onepay {

    public function getPlatformCode() {
        return FPGPAY_WEIXIN_H5_PAYMENT_API;
    }

    public function getPrefix() {
        return 'fpgpay_weixin_h5';
    }
