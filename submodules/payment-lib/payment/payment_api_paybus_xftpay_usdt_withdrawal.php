 ...
 * PAYBUS_WITHDRAWAL
 *
 * * PAYBUS_XFTPAY_USDT_WITHDRAWAL_PAYMENT_API
 *
 * Field Values:
 * * Account: ## User ID ##
 * * Key: ## Secret Key ##
 ...
 */
class Payment_api_paybus_xftpay_usdt_withdrawal extends Abstract_payment_api_paybus {

    public function getPlatformCode() {
        return PAYBUS_XFTPAY_USDT_WITHDRAWAL_PAYMENT_API;
    }

    public function getPrefix() {
        return 'paybus_xftpay_usdt_withdrawal';
    }
    ...
    public function getWithdrawParams($bank, $accNum, $name, $amount, $transId) {
        ...
        $params['channel_input'] = json_decode(json_encode([
            self::CHANNEL_XFTPAY_USDT_WITHDRAWAL => [
                'type'      => $bankCode,
                "address"   => $accNum,
        ]]));
