 ...
 * 
 * 
 * * FEIFU8PAY_QQPAY_PAYMENT_API, ID: 756
 *
 * Required Fields:
 * * URL
 * * Account
 ...
 */
class Payment_api_feifu8pay_qqpay extends Abstract_payment_api_feifu8pay {

	public function getPlatformCode() {
		return FEIFU8PAY_QQPAY_PAYMENT_API;
	}

	public function getPrefix() {
		return 'feifu8pay_qqpay';
	}

	protected function configParams(&$params, $direct_pay_extra_info) {
        if($this->CI->utils->is_mobile()) {
	
            $params['pay_bankcode'] =($this->getSystemInfo('usepcqq')) ?self::SCANTYPE_QQPAY : self::SCANTYPE_QQPAY_H5;
		}
		else {
			$params['pay_bankcode'] = self::SCANTYPE_QQPAY;
		}
	}
