 ...
 *
 * Field Values:
 * * URL: http://api.coinmum.com/User_Huan_selectOrder.html
 * * Account: ## Merchant ID ##
 * * Key: ## Secret Key ##
 *
 *
 ...
 */
class Payment_api_hcpay_h5 extends Abstract_payment_api_hcpay {

    public function getPlatformCode() {
        return HCPAY_H5_PAYMENT_API;
    }
    ...
    protected function configParams(&$params, $direct_pay_extra_info) {
        $params['pay_passcode'] = $this->getSystemInfo('passcode_mobile', self::PASSCODE_ONLINEBANK);
    }
