 ...
 */
class Payment_api_tonfords_alipay_h5 extends Abstract_payment_api_tonfords {

	public function getPlatformCode() {
		return TONFORDS_ALIPAY_H5_PAYMENT_API;
	}

	public function getPrefix() {
		return 'tonfords_alipay_h5';
    }
	...
	protected function configParams(&$params, $direct_pay_extra_info) {
		...
		$payWay = $this->getSystemInfo('pay_way'); 
		 return $params['pay_way'] = $payWay ? $payWay: self::PAYMENT_WAY_ALIPAY_H5;
	}
