 ...
 */
class Payment_api_999pay_weixin extends Abstract_payment_api_999pay {

	public function getPlatformCode() {
		return _999PAY_WEIXIN_PAYMENT_API;
	}

	public function getPrefix() {
		return '999pay_weixin';
	}

	protected function configParams(&$params, $direct_pay_extra_info) {
		if($this->utils->is_mobile()) {
			$params['P_ChannelID'] = self::P_CHANNEL_WEIXIN_H5;
		}
		else {
