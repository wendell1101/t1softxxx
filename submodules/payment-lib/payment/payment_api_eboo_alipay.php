 ...
 */
class Payment_api_eboo_alipay extends Abstract_payment_api_eboo {

	public function getPlatformCode() {
		return EBOO_ALIPAY_PAYMENT_API;
	}
	...
	protected function getBankCode() {
        if($this->CI->utils->is_mobile()) {
    		return $this->getSystemInfo("mobile_bankcode", self::BANKCODE_ALIPAY_H5);
        }
        else{
