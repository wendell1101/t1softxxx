<?php
require_once dirname(__FILE__) . '/abstract_payment_api_tongbao.php';
/**
 * TONGBAO
 *
 * * TONGBAO_BANKCARD_PAYMENT_API, ID: 5803
 *
 * Required Fields:
 * * URL
 * * Account
 ...
 */
class Payment_api_tongbao_bankcard extends Abstract_payment_api_tongbao {

    public function getPlatformCode() {
        return TONGBAO_BANKCARD_PAYMENT_API;
    }

    public function getPrefix() {
        return 'tongbao_bankcard';
    }

    protected function configParams(&$params, $direct_pay_extra_info) {
        $params['payment_type'] = self::PAYMENT_TYPE_BANKCARD;
    }
