 ...
 */
class Payment_api_jm_alipay extends Abstract_payment_api_jm {

	public function getPlatformCode() {
		return JM_ALIPAY_PAYMENT_API;
	}
	...
	protected function configParams(&$params, $direct_pay_extra_info) {   // &$params 和 return $params 一樣      // & 代表:帶值且回傳
            $params['banktype'] = self::CODE_TYPE_ALIPAY;
	}
