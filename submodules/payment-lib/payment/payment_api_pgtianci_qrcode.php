 ...
 * PGTIANCI
 *
 * * PGTIANCI_QRCODE_PAYMENT_API, ID: 5828
 *
 * Required Fields:
 * * URL
 * * Key
 ...
 */
class Payment_api_pgtianci_qrcode extends Abstract_payment_api_pgtianci {

    public function getPlatformCode() {
        return PGTIANCI_QRCODE_PAYMENT_API;
    }

    public function getPrefix() {
        return 'pgtianci_qrcode';
    }
