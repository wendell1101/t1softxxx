 ...
 */
class Payment_api_bingopay_unionpay extends Abstract_payment_api_bingopay {

	public function getPlatformCode() {
		return BINGOPAY_UNIONPAY_PAYMENT_API;
	}

	public function getPrefix() {
		return 'bingopay_unionpay';
    }
	...
	protected function configParams(&$params,&$data, $direct_pay_extra_info) {
		...
		$params['bus_no'] = self::DEFAULTNANK_UNIONPAY;
