 ...
 * paybus
 *
 * * PAYBUS_ONEFORPAY_QRCODE_PAYMENT_API, ID: 6429
 *
 * Field Values:
 ...
 */
class Payment_api_paybus_oneforpay_qrcode extends Abstract_payment_api_paybus {

    public function getPlatformCode() {
        return PAYBUS_ONEFORPAY_QRCODE_PAYMENT_API;
    }

    public function getPrefix() {
        return 'paybus_oneforpay_qrcode';
    }
