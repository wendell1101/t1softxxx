 ...
 * VMPAY
 *
 * * VMPAY_ALIPAY_QRCODE_PAYMENT_API, ID: 5793
 *
 * Required Fields:
 * * URL
 * * Account
 ...
 */
class Payment_api_vmpay_alipay_qrcode extends Abstract_payment_api_vmpay {

    public function getPlatformCode() {
        return VMPAY_ALIPAY_QRCODE_PAYMENT_API;
    }

    public function getPrefix() {
        return 'vmpay_alipay_qrcode';
    }

    protected function configParams(&$params, $direct_pay_extra_info) {
        $params['paytype'] = self::PAYTYPE_ALIPAY_QRCODE;
    }
