...
class Payment_api_bthpay_alipay extends Abstract_payment_api_bthpay {

    public function getPlatformCode() {
        return BTHPAY_ALIPAY_PAYMENT_API;
    }

    public function getPrefix() {
        return 'bthpay_alipay';
    }

    protected function configParams(&$params, $direct_pay_extra_info) {
        $params['pay_type'] = self::PAY_TYPE_ALIPAY;
    }
