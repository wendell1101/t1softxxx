 ...
 * PAYBUS_WITHDRAWAL
 *
 * * PAYBUS_WEDPAY_BANK_WITHDRAWAL_PAYMENT_API
 *
 * Field Values:
 * * Account: ## User ID ##
 * * Key: ## Secret Key ##
 ...
 */
class Payment_api_paybus_wedpay_bank_withdrawal extends Abstract_payment_api_paybus {

    public function getPlatformCode() {
        return PAYBUS_WEDPAY_BANK_WITHDRAWAL_PAYMENT_API;
    }

    public function getPrefix() {
        return 'paybus_wedpay_bank_withdrawal';
    }
    ...
    public function getWithdrawParams($bank, $accNum, $name, $amount, $transId) {
        ...
        $params['channel_input'] = json_decode(json_encode([self::CHANNEL_WEDPAY_WITHDRAWAL => ['bank' => $bankCode,"account_name" =>$name,"account_number"=>$accNum]]));
    ...
    public function getBankInfo() {
        ...
        if(!empty($bankInfoArr)) {
            ...
            // TTB TMBThanachart Bank ธนาคารทหารไทย
            // Citibank
            // UOBT United Overseas Bank ธนาคารยูโอบี
            // BAY Bank of Ayudhya ธนาคารกรุงศรีอยุธยา
            // BAAC Bank for Agriculture and Agricultural Cooperatives ธนาคารเพื่อการเกษตรและสหกรณ์การเกษตร
            // BOC Bank of China (Thai) ธนาคารแห่งประเทศจีน
            // TISCO TISCO Bank ธนาคารทิสโก้
            // ICBCT ICBC Bank ธนาคารไอซีบีซี
            // LHFG LH Bank ธนาคารแลนด์ แอนด์ เฮาส์
            // SME SME Development Bank ธนาคารพัฒนาวิสาหกิจขนาดกลางและขนาดย่อมแห่งประเทศไทย
            $bankInfo =  array(
                "28"=>  array(
