...
class Cron_schedule extends BaseModel
{
	...
	{
        // $this->utils->debug_log('Cron_schedule::fromCronString', 'cronSpec: ' . $cronSpec . ', language: ' . $language);
		...
		$newCron = new Cron_schedule($language);
