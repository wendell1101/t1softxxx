...
condition:
{
    "class": "promo_rule_roulette_r33827_php",
    "allowed_date": {
        "start": "",
        "end": ""
    },
    ...
    "rouletteName": "r33827_php",
    "cmsId":5
}
*/
class Promo_rule_roulette_r33827_php extends Abstract_promo_rule
{
    ...
    {
        return 'Promo_rule_roulette_r33827_php';
    }
    ...
    private function checkCustomizeBonusCondition($fromDate, $toDate, &$extra_info, $description, &$errorMessageLang, $dry_run = false)
    {
        ...
        $errorMessageLang = '';
        $username = $this->player_model->getUsernameById($this->playerId);
        $rouletteName = $description['rouletteName'];
        $cmsId = $description['cmsId'];

        $this->appendToDebugLog(__METHOD__, ['username'=>$username, 'playerId'=>$this->playerId]);
