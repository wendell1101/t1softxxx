...
/**
 *
 * Bônus de 10% para o primeiro depósito todos o
 *
 * OGP-31348
 *
 * 优惠申请期限 , 存款优惠仅能是今日的存款
...
{
    "class": "promo_rule_sssbet_deposit_bonus_on_deposit_day"
}

 *
 *
 */
class Promo_rule_sssbet_deposit_bonus_on_deposit_day extends Abstract_promo_rule{
	...
	public function getClassName(){
		return 'Promo_rule_sssbet_deposit_bonus_on_deposit_day';
	}
