 ...
 * max_amount_limit: 符合存款金額300 ~ 2999
 * roulette_exclusion_promo_list: 排除有綁定list內優惠的存款
 *
condition:
{
    "class": "promo_rule_ole777id_r26255_roulette",
    "allowed_date": {
        "start": "",
        "end": ""
    },
    ...
    "cmsId":18,
    "pre_chech_cms_id":19,
    "max_amount_limit":2999,
    "roulette_exclusion_promo_list":[3]
}
*/
class Promo_rule_ole777id_r26255_roulette extends Abstract_promo_rule
{
    ...
    {
        return 'Promo_rule_ole777id_r26255_roulette';
    }
    ...
    private function checkCustomizeBonusCondition($fromDate, $toDate, &$extra_info, $description, &$errorMessageLang, $dry_run = false)
    {
        ...
        $max_amount_limit = isset($description['max_amount_limit']) ? $description['max_amount_limit'] : 2999;
        ...
        try{
            ...
            if ($spin_conditions) {
                ...
                $per_amount = isset($spin_conditions['per_amount'])? $spin_conditions['per_amount'] : 300;
                ...
                $this->appendToDebugLog('checkCustomizeBonusCondition check params detail', ['player_id' => $this->playerId, 'release_date' => $release_date, 'checkReleasedBonusToday' => $checkReleasedBonusToday, 'verification_amount_type' => $verification_amount_type, 'deposit_list' => $deposit_list, 'promoRuleId' => $promoRuleId, 'available_spin' => $available_spin, 'earn_times' => $earn_times]);
                ...
                if (! is_null($pre_chech_cms_id)) {
                    ...
                    $this->appendToDebugLog('pre chech other cmsId', ['pre_chech_cms_id' => $pre_chech_cms_id, 'promoruleChech' => $promoruleChech, 'promoChechCmsSettingId' => $promoChechCmsSettingId, 'checkReleasedBonusTodayByChechCmsId' => $checkReleasedBonusTodayByChechCmsId, 'promoRuleId' => $promoRuleId]);
