...
condition:
{
    ...
    "rouletteName": "normal_1",
    "cmsId":4
}
*/
class Promo_rule_smash_normal_roulette extends Abstract_promo_rule
{
    ...
    {
        return 'Promo_rule_smash_normal_roulette';
    }
        ...
        try{
            ...
            if ($spin_conditions) {
                ...
                foreach ($dateRangeArr as $dateRange) {
                    ...
                    list($betting_amount) = $this->callHelper('getBetsAndDepositByDate', [$dateRangeFrom, $dateRangeTo]);
                    $dateRange_verification_amount = (int) $betting_amount;
