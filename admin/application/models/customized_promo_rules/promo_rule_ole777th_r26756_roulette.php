 ...
 * per_amount: 符合存款金額 >= 2999
 * roulette_exclusion_promo_list: 排除有綁定list內優惠的存款
 *
condition:
{
    "class": "promo_rule_ole777th_r26756_roulette",
    "allowed_date": {
        "start": "",
        "end": ""
    },
...
*/
class Promo_rule_ole777th_r26756_roulette extends Abstract_promo_rule
{
    ...
    {
        return 'Promo_rule_ole777th_r26756_roulette';
    }
    ...
    private function checkCustomizeBonusCondition($fromDate, $toDate, &$extra_info, $description, &$errorMessageLang, $dry_run = false)
    {
        ...
        try{
            ...
            if (!empty($verify_res)) {
                ...
                // $per_amount = isset($spin_conditions['per_amount'])? $spin_conditions['per_amount'] : 2999;
