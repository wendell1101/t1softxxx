...
condition:
{
    "class": "promo_rule_smash_upgrade_level_bonus",
    "bonus_settings":{
 ...
 *
 */
class Promo_rule_smash_upgrade_level_bonus extends Abstract_promo_rule{
	...
	public function getClassName(){
		return 'Promo_rule_smash_upgrade_level_bonus';
	}
