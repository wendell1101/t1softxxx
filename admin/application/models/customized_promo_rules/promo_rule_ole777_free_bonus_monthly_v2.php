...
condition:
{
    "class": "promo_rule_ole777_free_bonus_monthly_v2",
    "allowed_date":{
        "start": "21",
        "end": "25"
    },
    ...
    "bonus_settings":{
        "18" : { "bonus_amount": 7
				, "last_month_deposit_amont":200
		},
        "74" : { "bonus_amount": 17
				, "last_month_deposit_amont":300
		},
        "75" : { "bonus_amount": 37
				, "last_month_deposit_amont":500
		},
        "76" : { "bonus_amount": 77
        ...
        "248" : { "bonus_amount": 777
				, "last_month_deposit_amont":30000
		},
        ...
        "252" : { "bonus_amount": 7777
				, "last_month_deposit_amont":500000
		}
    }
}
 ...
 *
 */
class Promo_rule_ole777_free_bonus_monthly_v2 extends Promo_rule_ole777_free_bonus_monthly{
	...
	public function getClassName(){
		return 'Promo_rule_ole777_free_bonus_monthly_v2';
	}
	...
	function isAllowedDate($allowed_date){
		...
		// Y-m-d
		$today = $this->utils->formatDateForMysql( new DateTime($get_date_type_now) ); // for allowed_date
