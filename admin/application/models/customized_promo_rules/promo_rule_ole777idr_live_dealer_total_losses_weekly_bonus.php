...
{
    "class": "promo_rule_ole777idr_live_dealer_total_losses_weekly_bonus",
    "min_bonus_amount": 30,
    "bonus_settings": {
        "VIP0" : {"bonus_percentage":     3, "max_bonus_amount":  500},
        "VIP1" : {"bonus_percentage":     3, "max_bonus_amount":  500},
        "VIP2" : {"bonus_percentage":     3, "max_bonus_amount":  500},
        "VIP3" : {"bonus_percentage":     3, "max_bonus_amount":  500},
        "VIP4" : {"bonus_percentage":     4, "max_bonus_amount": 1000},
        "VIP5" : {"bonus_percentage":     4, "max_bonus_amount": 1000},
        "VIP6" : {"bonus_percentage":     4, "max_bonus_amount": 1000},
        "VIP7" : {"bonus_percentage":     5, "max_bonus_amount": 2500},
        "VIP8" : {"bonus_percentage":     5, "max_bonus_amount": 3000},
        "VIP9" : {"bonus_percentage":     5, "max_bonus_amount": 5000}
    }
}

$config['auto_apply_for_ole777idr_live_dealer_total_losses_weekly_bonus_promocms_id'] = [
    // promo_cms_id => game_type_id
    "promo_cms_id" => 4, //live dealer
];

 *
 */
class Promo_rule_ole777idr_live_dealer_total_losses_weekly_bonus extends Abstract_promo_rule{
	...
	public function getClassName(){
		return 'Promo_rule_ole777idr_live_dealer_total_losses_weekly_bonus';
	}
    ...
    private function checkCustomizeBonusCondition($description, &$errorMessageLang){
        ...
        $promo_settings = $this->utils->getConfig('auto_apply_for_ole777idr_live_dealer_total_losses_weekly_bonus_promocms_id');
