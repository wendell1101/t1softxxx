...
condition:
{
    "class": "promo_rule_mission_registration_bonus",
	"allowed_date": {
        "start": "2023-08-22",
        "end": "2033-08-22"
    },
 ...
 *
 */
class Promo_rule_mission_registration_bonus extends Abstract_promo_rule_mission{

    const SUBTYPE = 'registration';
	...
	public function getClassName(){
		return 'promo_rule_mission_registration_bonus';
	}
	...
	protected function _checkCustomizeBounsCondition($description, &$extra_info, &$errorMessageLang){
        ...
        try{
            ...
            $subtype = isset($description['subtype'])? $description['subtype'] : 'registration';
            
            list($hit_mission, $current_total) = $this->checkMission($description);
            $isPeriodDaysAvailable = $this->checkPeriodDaysAvailable($period_days, $this->playerRegisterDate, $this->currentDate);
