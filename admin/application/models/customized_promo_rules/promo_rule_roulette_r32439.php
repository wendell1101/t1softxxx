...
/**
 *
 * OGP-32439 [customize] New roulette
 * 
 * 當日累積存10 拿到一次，累積存30 拿到第二次，累積存100 拿到第三次，累積存300 拿到第四次，累積存500 拿到第五次
 *
condition:
{
    "class": "promo_rule_roulette_r32439",
    "allowed_date": {
        "start": "",
        "end": ""
    },
    ...
    "spin_conditions": {
        ...
        "threshold": 10,
        "deposit_amount": [
            {"min_deposit": 10, "max_deposit": 29, "earn": 1},
            {"min_deposit": 30, "max_deposit": 99, "earn": 2},
            {"min_deposit": 100, "max_deposit": 299, "earn": 3},
            {"min_deposit": 300, "max_deposit": 499, "earn": 4},
...
*/
class Promo_rule_roulette_r32439 extends Abstract_promo_rule
{
    ...
    {
        return 'Promo_rule_roulette_r32439';
    }
