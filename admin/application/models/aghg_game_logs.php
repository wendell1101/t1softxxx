...
class Aghg_game_logs extends BaseModel {

	function __construct() {
		parent::__construct();
	}

	protected $tableName = "aghg_game_logs";
	 ...
	 * @return array
	 */
	function syncToAGHGGameLogs($data) {
	...
	function getAGHGGameLogStatistics($dateFrom, $dateTo) {
		$sql = <<<EOD
SELECT creationtime,
transferamount,
currentamount,
...
EOD;
		...
		$query = $this->db->query($sql, array(AGHG_API, $dateFrom, $dateTo));
