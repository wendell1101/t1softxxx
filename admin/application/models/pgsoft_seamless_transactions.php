...
class Pgsoft_seamless_transactions extends Base_game_logs_model {

	public $tableName = "pgsoft_seamless_wallet_transactions";
	...
	public function updateTransacionData($externalUniqueId, $data, $tableName = null) {
		if(!empty($tableName)){
	...
	public function isTransactionExist($transaction_id, $balance_adjustment_method) {
        $qry = $this->db->get_where($this->tableName, array('transaction_id' => $transaction_id, 'balance_adjustment_method' => $balance_adjustment_method ));
