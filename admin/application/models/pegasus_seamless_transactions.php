...
class Pegasus_seamless_transactions extends Base_game_logs_model {

	public $tableName = "pegasus_seamless_wallet_transactions";
	...
	public function flagBetTransactionSettled($tableName, $data){
		...
		->set('payout_amount', $data['payout_amount'])
		->set('valid_amount', $data['valid_amount'])
		->set('tax_amount', $data['tax_amount'])
		->set('settlement_time', $data['settlement_time'])
		->where("transaction_id", $data['transaction_id'])
		->where("trans_type", 'PlaceBet')
		;
    ...
    public function getExistingTransactionByTransactionId($tableName, $transaction_id, $trans_type) {
		if(!empty($tableName)){
            $this->tableName = $tableName;
        }
		$where = [
