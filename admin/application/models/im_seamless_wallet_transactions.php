...
class im_seamless_wallet_transactions extends Base_game_logs_model {

	public $tableName = "im_seamless_wallet_transactions";
	...
	public function getTransactionByBetId($bet_id) {
	...
	public function updateAfterBalance($transactionId, $afterBalance){
		$data = ['after_balance'=>$afterBalance];
		return $this->updateData('transaction_id', $transactionId, $this->tableName, $data);
	}

	public function updateUnsettleData($betId, $data){
		return $this->updateData('bet_id', $betId, $this->tableName, $data);
	}
