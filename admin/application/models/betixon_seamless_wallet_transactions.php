...
class Betixon_seamless_wallet_transactions extends Base_game_logs_model {

	public $tableName = "betixon_seamless_wallet_transactions";
...
UPDATE {$this->tableName}
    SET after_balance = ?, total_balance = ?
WHERE
external_uniqueid = ?
EOD;
