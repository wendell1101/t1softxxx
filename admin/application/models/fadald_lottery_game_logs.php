...
class Fadald_lottery_game_logs extends Base_game_logs_model {

    public function __construct() {
        parent::__construct();
    }

    protected $tableName = "fadald_lottery_game_logs";
    ...
    public function getGameLogStatistics($dateFrom, $dateTo) {
        ...
        $this->db->where('fadald_lottery_game_logs.bet_time >=', $dateFrom);
        $this->db->where('fadald_lottery_game_logs.bet_time <=', $dateTo);
    ...
    public function getLDLotteryGame() {
        ...
        $this->db->where('game_description.game_platform_id', FADA_LD_LOTTERY_API);
