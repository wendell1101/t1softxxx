...
$enable_custom_redemption_code = $this->utils->safeGetArray($static_settings, 'custom_code', false);
...
$_decimals = $this->utils->safeGetArray($static_settings, 'decimals', 0);
$step = $_controller->decimals2floatStep($_decimals);
?>
<style type="text/css">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="row">
                                ...
                                <!-- <div class="col-md-3">
                                    <div class="form-group required">
                                        <label for="quantity" class="control-label"><?= lang('redemptionCode.redemptionQuantity'); ?><span class="text-danger"></span></label>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group required">
                                        <label class="control-label"><?=lang('redemptionCode.totalRedeemable');?> <span class="text-danger"></span></label>
                                        <input type="number" name="totalRedeemable" class="form-control input-sm" id="totalRedeemable" min="1" step="1" value="1" required>
                                        <span class="text-danger help-block m-b-0 addCategoryAlert" id="totalRedeemableAlert" hide>*<?= lang('Quantity should be > 0'); ?></span>
                                    </div>
                                </div>
                        ...
                        <?php if($enable_custom_redemption_code === true): ?>
                        <!-- redemptionCode -->
                        <div class="col-md-6">
                            <label class="control-label"><?= lang('redemptionCode.redemptionCode'); ?> <span class="hide promocode-loading glyphicon glyphicon-refresh glyphicon-refresh-animate"></span> </label>
                            <div class="input-group">
                                <input type="text" name="redemptionCode" class="form-control input-sm" required="">
                                <div class="input-group-btn">
                                    <a href="javascript:void(0)" class="btn btn-default btn-scooter btn-sm random-code" style="border-radius: 0 !important;">
                                    <i class="glyphicon glyphicon-chevron-left"></i><?=lang('aff.ai38') ?></a>
                                </div>
                            </div>
                            <span class="text-danger help-block m-b-0 addCategoryAlert" id="redemptionCodeErrorMsg" hide>*<?= lang('Required'); ?></span>
                        </div>
                        <?php endif; ?>

                        <!-- bonus condition -->
                        <div class="col-md-12 withdraw_condition_block bonus_condition_block bonus_condition_block_betting">
                            <div class="col-md-8">
                                <fieldset>
                                    <legend>
                                        <h4>* <?= lang('cms.applyCondition') ?></h4>
                                    </legend>
                                    <div class="condition-item form-group required" id="bonusReleaseFixedAmountSec">
                                        ...
                                        <label for="bonus" class="control-label"><?= lang('cms.fixedBonusAmount'); ?><span class="text-danger"></span></label>
                                        <input type="number" name="bonus" class="form-control input-sm" id="bonus" required style="width:80px;">
                                        <span class="text-danger help-block m-b-0 addCategoryAlert" id="bonusAlert" hide>*<?= lang('redemptionCode.setup.bonusLimit'); ?></span>
                                    </div>
                                    <div class="condition-item form-group required" id="bonusReleasenonfixedAmountSec">
                                        <input type="radio" name="bonusReleaseTypeOption" id="bonusReleaseTypeNonFixedAmount" value="<?php echo Promorules::BONUS_RELEASE_RULE_CUSTOM; ?>">
                                        <label for="nonfixedBonusMinAmount" class="control-label"><?= lang('redemptionCode.bonus'); ?><span class="text-danger"></span></label>
                                        <input type="number" min='<?=$step?>' step='<?=$step?>' name="nonfixedBonusMinAmount" id="nonfixedBonusMinAmount" style="width:80;" class="form-control input-sm amount_only">
                                        <span class="text-danger help-block m-b-0 addCategoryAlert" id="nonfixedBonusMinAlert" hide>*<?= lang('redemptionCode.setup.condition.bonusLimitMin'); ?></span>
                                        <label class="control-label"><?=lang('to');?> </label>
                                        <input type="number" min='<?=$step?>' step='<?=$step?>' name="nonfixedBonusMaxAmount" id="nonfixedBonusMaxAmount" style="width:80;" class="form-control input-sm amount_only">
                                        <span class="text-danger help-block m-b-0 addCategoryAlert" id="nonfixedBonusMaxAlert" hide>*<?= lang('redemptionCode.setup.condition.bonusLimitMax'); ?></span>
                                        <span class="text-danger help-block m-b-0 addCategoryAlert" id="maxLessThanMinAlert" hide>*<?= lang('redemptionCode.setup.condition.bonusMaxLessThanMin'); ?></span>

                                        <!-- redemptionCode.bonusCap -->
                                        <label class="control-label"><?=lang('redemptionCode.bonusCap');?> </label>
                                        <input type="number" min='1' name="bonusCap" class="form-control input-sm" id="bonusCap" required style="width:80px;">
                                        <span class="text-danger help-block m-b-0 addCategoryAlert" id="bonusCapAlert" hide>*<?= lang('redemptionCode.setup.condition.capMin'); ?></span>
                                    </div>
                                    <?php if($enable_custom_deposit_condictions === true): ?>
                                    <hr>
                                    <div class="condition-item form-group">
                                        <input type="checkbox" name="enableSameDayDeposit" >
                                        <div class="control-label"><?=lang('redemptionCode.sameDayDeposit');?> >= </div>
                                        <input type="number" min='1' step='any' value="0" name="sameDayDepositAmount" style="width:80;" class="form-control input-sm amount_only">
                                    </div>
                                    <div class="condition-item form-group">
                                        <input type="checkbox" name="enablePastDayDeposit">
                                        <div class="control-label"><?=lang('redemptionCode.pastDayDeposit');?></div>
                                        <input type="number" min='1' step='any' value="0" name="pastDayDepositDays" style="width:80;" class="form-control input-sm amount_only">
                                        <div class="control-label">/ <?=lang("lang.daily");?> <?=lang('Amount');?> >= </div>
                                        <input type="number" min='0' step='any' value="0" name="pastDayDepositAmount" style="width:80;" class="form-control input-sm amount_only">
                                    </div>
                                    <div class="condition-item form-group">
                                        <input type="checkbox" name="enablePastDaysTotalDeposit">
                                        <div class="control-label"><?=lang('redemptionCode.pastDaysTotalDeposit');?></div>
                                        <input type="number" min='1' step='any' value="0" name="pastDaysTotalDeposit" style="width:80;" class="form-control input-sm amount_only">
                                        <div class="control-label"><?=lang('redemptionCode.pastDaysTotalDeposit.amount');?> >= </div>
                                        <input type="number" min='0' step='any' value="0" name="pastDaysTotalDepositAmount" style="width:80;" class="form-control input-sm amount_only">
                                    </div>
                                    <?php endif; ?>
                                </fieldset>
                            </div>
                        ...
                        <!-- #region -->
                        <?php if($enable_custom_condiction_player_level === true): ?>
                        <div class="col-md-12 allowed_players_wrapper" id="addAllowedPlayerLevel">
                            <div class="col-md-8">
                                <fieldset>
                                    <legend>
                                        <h4><?=lang('Allowed Player Levels');?>
                                        </h4>
                                    </legend>
                                    <div class="col-md-12 form-group">
                                        <label class="control-label" class="control-label" style="font-size:12px;"><?=lang('player_list.fields.vip_level');?>: </label>
                                        <select class="select2-player-level-list-ajax" id="add-player-levels" name="a_player_levels[]" multiple="multiple" style="width: 100%;">
                                        <?php if (!empty($levels)): ?>
                        ...
                        <!-- **********************
                            | allowed affiliates |
                            ********************** -->
                        <?php if($enable_custom_condiction_under_affiliate === true): ?>
                        <div class="col-md-12 allowed_players_wrapper" id="addAllowedAffiliate">
                            <div class="col-md-8">
                                <fieldset>
                                    <legend>
                                        <h4><?=lang('Allowed Affiliates');?>
                                        </h4>
                                    </legend>
                                    <div class="col-md-12 form-group">
                                        <label class="control-label" class="control-label" style="font-size:12px;"><?=lang('Affiliates');?>: </label>
                                        <select class="select2-affiliate-list-ajax" id="add-affiliates" name="a_affiliates[]" multiple="multiple" style="width: 100%;">

                                        </select>
                                        <button type="button" id="allowed_clear_player_select" title="" class="btn btn-chestnutrose" style="display: none;"><fa class="glyphicon glyphicon-remove"></fa><?=lang('lang.clear.selections')?></button>
                        ...
                        <!-- *******************
                            | allowed players |
                            ******************* -->
                        <?php if($enable_custom_condiction_under_player === true): ?>
                        <div class="col-md-12 allowed_players_wrapper" id="addAllowedPlayers">
                            <div class="col-md-8">
                                <fieldset>
                                    <legend>
                                        <h4><?=lang('Allowed Referred Players');?>
                                        </h4>
                                    </legend>
                                    <div class="col-md-12 form-group">
                                        <label class="control-label" class="control-label" style="font-size:12px;"><?=lang('Player');?>: </label>
                                        <select class="select2-player-list-ajax" id="add-players" name="a_players[]" multiple="multiple" style="width: 100%;">
                                            <!-- <option value="7" selected="selected">test002</option> -->
                                        </select>
                                        <button type="button" id="allowed_clear_player_select" title="" class="btn btn-chestnutrose" style="display: none;"><fa class="glyphicon glyphicon-remove"></fa><?=lang('lang.clear.selections')?></button>
                        ...
                        <div class="col-md-12 m-t-25">
                            <div class="default_err_msg">
                                <span class="text-danger help-block m-b-0 addCategoryAlert" id="defaultErrMsg" hide></span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group required">
                                        <label class="control-label"><?=lang('redemptionCode.totalRedeemable');?> <span class="text-danger"></span></label>
                                        <input type="number" name="totalRedeemable" class="form-control input-sm" id="edit-totalRedeemable" min="1" step="1" value="1" required>
                                        <span class="text-danger help-block m-b-0 editCategoryAlert" id="edit-totalRedeemableAlert" hide>*<?= lang('Quantity should be > 0'); ?></span>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group required">
                                        ...
                                        <span class="text-danger help-block m-b-0 editCategoryAlert" id="edit-categoryNameErrorMsg" hide>*<?= lang('Required'); ?></span>
                                    </div>
                                    <div class="input-group form-group">
                        ...
                        <div class="col-md-12">
                            <?php if(!$enable_custom_redemption_code === true): ?>
                            <div class="col-md-3">
                                <label class="control-label"><?= lang('redemptionCode.redemptionCode'); ?> </label>
                                <input type="text" name="redemptionCode" class="form-control input-sm" id="redemptionCode" readonly>
                            </div>
                            <?php else: ?>
                            <div class="col-md-6">
                                <label class="control-label"><?= lang('redemptionCode.redemptionCode'); ?> <span class="hide promocode-loading glyphicon glyphicon-refresh glyphicon-refresh-animate"></span> </label>
                                ...
                                <span class="text-danger help-block m-b-0 editCategoryAlert" id="edit-redemptionCodeErrorMsg" hide>*<?= lang('Required'); ?></span>
                            </div>
                            <?php endif; ?>
                        </div>
                        ...
                        <div class="col-md-12 withdraw_condition_block bonus_condition_block bonus_condition_block_betting">
                            <div class="col-md-8">
                                <fieldset>
                                    ...
                                    <div class="condition-item form-group required" id="edit-bonusReleaseFixedAmountSec">
                                        <input type="radio" name="bonusReleaseTypeOption" id="edit-bonusReleaseTypeFixedAmount" value="<?php echo Promorules::BONUS_RELEASE_RULE_FIXED_AMOUNT; ?>">

                                        <label for="bonus" class="control-label"><?= lang('cms.fixedBonusAmount'); ?><span class="text-danger"></span></label>
                                        <input type="number" name="bonus" class="form-control input-sm" id="edit-bonus" required style="width:80px;">
                                        <span class="text-danger help-block m-b-0 editCategoryAlert" id="edit-bonusAlert" hide>*<?= lang('redemptionCode.setup.bonusLimit'); ?></span>
                                    </div>
                                    <div class="condition-item form-group required" id="bonusReleasenonfixedAmountSec">
                                        <input type="radio" name="bonusReleaseTypeOption" id="edit-bonusReleaseTypeNonFixedAmount" value="<?php echo Promorules::BONUS_RELEASE_RULE_CUSTOM; ?>">
                                        <label for="nonfixedBonusMinAmount" class="control-label"><?= lang('redemptionCode.bonus'); ?><span class="text-danger"></span></label>

                                        <input type="number" min='<?=$step?>' step='<?=$step?>' name="nonfixedBonusMinAmount" id="edit-nonfixedBonusMinAmount" style="width:80;" class="form-control input-sm amount_only">
                                        <span class="text-danger help-block m-b-0 editCategoryAlert" id="edit-nonfixedBonusMinAlert" hide>*<?= lang('redemptionCode.setup.condition.bonusLimitMin'); ?></span>
                                        <label class="control-label"><?=lang('to');?> </label>
                                        <input type="number" min='<?=$step?>' step='<?=$step?>' name="nonfixedBonusMaxAmount" id="edit-nonfixedBonusMaxAmount" style="width:80;" class="form-control input-sm amount_only">
                                        <span class="text-danger help-block m-b-0 editCategoryAlert" id="edit-nonfixedBonusMaxAlert" hide>*<?= lang('redemptionCode.setup.condition.bonusLimitMax'); ?></span>
                                        <span class="text-danger help-block m-b-0 editCategoryAlert" id="edit-maxLessThanMinAlert" hide>*<?= lang('redemptionCode.setup.condition.bonusMaxLessThanMin'); ?></span>

                                        <!-- redemptionCode.bonusCap -->
                                        <label class="control-label"><?=lang('redemptionCode.bonusCap');?> </label>
                                        <input type="number" min='1' name="bonusCap" class="form-control input-sm" id="edit-bonusCap" required style="width:80px;">
                                        <span class="text-danger help-block m-b-0 editCategoryAlert" id="edit-bonusCapAlert" hide>*<?= lang('redemptionCode.setup.condition.capMin'); ?></span>
                                    </div>
                                    <?php if($enable_custom_deposit_condictions === true): ?>
                                    <hr>
                                    <div class="condition-item form-group">
                        ...
                        <div class="col-md-12 allowed_players_wrapper" id="addAllowedPlayerLevel">
                            <div class="col-md-8">
                                <fieldset>
                                    ...
                                    <div class="col-md-12 form-group">
                                        <label class="control-label" class="control-label" style="font-size:12px;"><?=lang('player_list.fields.vip_level');?>: </label>
                                        <select class="select2-player-level-list-ajax" id="edit-player-levels" name="e_player_levels[]" multiple="multiple" style="width: 100%;">
                                        <?php if (!empty($levels)): ?>
                                            <?php foreach ($levels as $levelId => $levelName): ?>
                                                <option value="<?=$levelId?>"><?=$levelName?></option>
                                            <?php endforeach ?>
                        ...
                        <div class="col-md-12 allowed_players_wrapper" id="addAllowedAffiliate">
                            <div class="col-md-8">
                                <fieldset>
                                    ...
                                    <div class="col-md-12 form-group">
                                        <label class="control-label" class="control-label" style="font-size:12px;"><?=lang('Affiliates');?>: </label>
                                        <select class="select2-affiliate-list-ajax" id="edit-affiliates" name="e_affiliates[]" multiple="multiple" style="width: 100%;">
                        ...
                        <div class="col-md-12 allowed_players_wrapper" id="addAllowedPlayers">
                            <div class="col-md-8">
                                <fieldset>
                                    ...
                                    <div class="col-md-12 form-group">
                                        <label class="control-label" class="control-label" style="font-size:12px;"><?=lang('Player');?>: </label>
                                        <select class="select2-player-list-ajax" id="edit-players" name="e_players[]" multiple="multiple" style="width: 100%;">
                                            <!-- <option value="7" selected="selected">test002</option> -->
                                        </select>
                                        <button type="button" id="allowed_clear_player_select" title="" class="btn btn-chestnutrose" style="display: none;"><fa class="glyphicon glyphicon-remove"></fa><?=lang('lang.clear.selections')?></button>
                                        <p class="help-block players-help-block pull-left"><i style="font-size:12px;color:#919191;"><?=lang('Applicable Players for this Promotion');?></i></p>
                        ...
                        <div class="col-md-12 m-t-25">
                            <div class="default_err_msg">
                                <span class="text-danger help-block m-b-0 editCategoryAlert" id="defaultErrMsg" hide></span>
                            </div>
                        </div>
                    </div>
                </div>
...
<div id="process-type-modal" class="modal fade" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content generate_code_content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body generate_code_form_content">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade in active" id="byMessage">
                        <form id="generate_code_by_message_form" action="/marketing_management/generateStaticCodeWithInternalMessage" method="POST" accept-charset="utf-8" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                <div class="modal-footer generate_code_footer">
                                    <button type="button" class="btn btn-linkwater" data-dismiss="modal"><?= lang('lang.cancel'); ?></button>
                                    <button type="submit" class="btn btn-portage" id="submitGenerateCodeByMessageForm"><?= lang('redemptionCode.messagesToPlayers'); ?></button>
                                </div>
                            </div>
                        </form>
                    </div>
