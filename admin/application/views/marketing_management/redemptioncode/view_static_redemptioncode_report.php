...
<div class="panel panel-primary">
	...
	<div id="collapsePlayerGradeReport" class="panel-collapse">
		<div class="panel-body">
			<form id="form-filter" class="form-horizontal" method="get" action="<?= site_url('/marketing_management/staticRedemptionCodeList'); ?>">
				<div class="row">
					<div class="col-md-3">
...
<div class="panel panel-primary">
	<div class="panel-heading">
		<h4 class="panel-title"><i class="fa fa-list"></i> <?= lang('redemptionCode.staticRedemptionCodeList') ?>
		</h4>
	</div>
	<div class="panel-body">
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('#staticRedemptionCodeList').addClass('active');
		...
		var dataTable = $('#myTable').DataTable({
			...
			buttons: [{
				...
				<?php if ($export_report_permission) : ?>, {
						...
						action: function(e, dt, node, config) {
							...
							utils.safelog(d);
							$("#_export_excel_queue_form").attr('action', site_url('/export_data/staticRedemptionCodeReport'));
			...
			ajax: function(data, callback, settings) {
				...
				$.post(base_url + "api/getStaticRedemptionCodeList", data, function(data) {
					callback(data);
					initEvent()
				}, 'json');
			},
		...
		$('.export_excel').click(function() {
			...
			$.post(site_url('/export_data/staticRedemptionCodeReport'), d, function(data) {
