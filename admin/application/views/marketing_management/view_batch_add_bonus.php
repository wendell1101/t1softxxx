...
<div class="container-fluid">
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
                <form class="form-horizontal" action="<?php echo site_url('/marketing_management/post_manually_batch_bonus');?>"
                    method="post" onsubmit="return submitForm();" accept-charset="utf-8" enctype="multipart/form-data">
                <div class="form-group">
                    <label class="col-md-12"><?=lang('hint.batch_add_bonus')?></label>
                </div>
                <div class="form-group">
                    <label class="col-md-3"><?=lang('pay.transactionType')?></label>
                    <div class="col-md-9">
                        <span class="bg-danger"><?=lang('Batch Add Bonus');?></span>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-9 form-inline">
                        <div >
                            <input type="file" name="csv_file" class="form-control input-sm" required="required" accept=".csv"/>
                        </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9 form-inline">
    <!--                    <label class="radio-inline"><input type="radio" name="status" value="0" required="required" aria-required="true">--><?//=lang('sale_orders.status.3')?><!--</label>-->
                        <label class="radio-inline"><input type="radio" name="status" value="1" required="required" checked="checked" required="required" aria-required="true"><?=lang('sale_orders.status.5')?></label>
                    </div>
                </div>
