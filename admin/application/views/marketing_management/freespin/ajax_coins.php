...
<form action="<?=site_url('marketing_management/addFreeround')?>" method="POST">
    <input type="hidden" name="name" value="<?=$name?>" />
    <input type="hidden" name="games" value="<?=implode(',', $game_ids)?>" />
...
?>"><?=implode(',', $coins['CNY'])?></label></span>
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="col-md-2">
                <input type="submit" value="<?=lang('Confirm')?>" class="btn btn-primary btn-sm btn-block">
            </div>
            <div class="col-md-5">
            </div>
        </div>
