<div class="container">
    <div class="panel panel-primary">
        <div class="panel-heading">
            <h4 class="panel-title"><span style="font-weight: bold;"><?php echo lang('batch.batch_subtract_bonus_result');?></span></h4>
        </div>
        ...
        <table class="table table-condensed">
            <tbody>
                ...
                <tr>
                    <td><?=lang('batch.batch_subtract_bonus_result') ?></td>
    ...
    if(data['queue_result']){
        ...
        if(queue_result.progress === undefined){
           ...
           $('.progresslabel').html("");
            ...
            var failCount = parseInt(queue_result.failedCnt);
