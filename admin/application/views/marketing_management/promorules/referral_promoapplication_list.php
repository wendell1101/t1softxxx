        ...
        <label style="display: block; cursor: pointer; margin-bottom: 0;">
            <div class="col-md-3">
                ...
                <div class="dashboard-stat curiousblue panel_<?php echo Player_promo::TRANS_STATUS_REQUEST; ?> <?php echo $conditions['status'] == Player_promo::TRANS_STATUS_REQUEST ? 'checked' : '' ?>">
                    ...
                    <div class="details">
                        <div class="number">
                            <span><?php echo number_format($countAllStatus[Player_promo::TRANS_STATUS_REQUEST]); ?></span>
                        </div>
        ...
        <label style="display: block; cursor: pointer; margin-bottom: 0;">
            <div class="col-md-3">
                ...
                <div class="dashboard-stat bermuda panel_<?php echo Player_promo::TRANS_STATUS_APPROVED; ?> <?php echo $conditions['status'] == Player_promo::TRANS_STATUS_APPROVED ? 'checked' : '' ?>">
                    ...
                    <div class="details">
                        <div class="number">
                            <span><?php echo number_format($countAllStatus[Player_promo::TRANS_STATUS_APPROVED]); ?></span>
                        </div>
        ...
        <label style="display: block; cursor: pointer; margin-bottom: 0;">
            <div class="col-md-3">
                ...
                <div class="dashboard-stat curiousblue panel_<?php echo Player_promo::TRANS_STATUS_FINISHED_WITHDRAW_CONDITION; ?> <?php echo $conditions['status'] == Player_promo::TRANS_STATUS_FINISHED_WITHDRAW_CONDITION ? 'checked' : '' ?>">
                    ...
                    <div class="details">
                        <div class="number">
                            <span><?php echo number_format($countAllStatus[Player_promo::TRANS_STATUS_FINISHED_WITHDRAW_CONDITION]); ?></span>
                        </div>
        ...
        <label style="display: block; cursor: pointer; margin-bottom: 0;">
            <div class="col-md-3">
                ...
                <div class="dashboard-stat charm panel_<?php echo Player_promo::TRANS_STATUS_DECLINED; ?> <?php echo $conditions['status'] == Player_promo::TRANS_STATUS_DECLINED ? 'checked' : '' ?>">
                    ...
                    <div class="details">
                        <div class="number">
                            <span><?php echo number_format($countAllStatus[Player_promo::TRANS_STATUS_DECLINED]); ?></span>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12 text-right">
                    <span class="pull-right">
                        ...
                        <input type="hidden" class="isClickSearch" name="isClickSearch" val="<?=$conditions['isClickSearch']?>">
...
<script type="text/javascript">
       ...
       var dataTable = $('#promo-application-table').DataTable({
           ...
           buttons: [
                ...
                // },

                    {
                        ...
                        action: function ( e, dt, node, config ) {
                            ...
                            <?php if($this->utils->isEnabledFeature('export_excel_on_queue')){?>
                                $("#_export_excel_queue_form").attr('action', site_url('/export_data/referralPromoApplicationList'));
                                $("#_export_excel_queue_form [name=json_search]").val(JSON.stringify(d));
                                $("#_export_excel_queue_form").submit();
                            <?php }else{?>

                            $.post(site_url('/export_data/referralPromoApplicationList/true'), d, function(data){
                                // utils.safelog(data);
            ...
            ajax: function (data, callback, settings) {
                ...
                var _ajax = $.post("<?=site_url('api/referralPromoApplicationList') ?>", data, function(data) {
                    // console.log(data);
                    callback(data);
        ...
        $('#username, #promoCmsSettingId, #vipsettingcashbackruleId, #search_transaction_date, #player_promo_status, #search_by_date, #transRequestTime, #transProcessTime').click(function(){
            $('.dashboard-stat.checked').removeClass('checked');
        });
    ...
    function releasePromoWithZero(playerpromoId){
    ...
    function ajaxDeclinePromo(promoId, reason) {
        $.ajax({
            ...
            'type' : 'POST',
            'data': {declinePlayerPromoId: promoId, reasonToCancel: reason},
            'cache' : false,
            'dataType' : "json",
            // "async" : false
        }).done(function(data){
