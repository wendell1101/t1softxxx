					...
					<table class="table table-striped table-hover" style="margin: 0px 0 0 0; width: 100%;" id="incomeTable">
						<thead>
							<tr>
								...
								<th class="input-sm"><?= lang('report.in10'); ?></th>
								...
								<th class="input-sm"><?= lang('report.in09'); ?></th>
								<th class="input-sm"><?= lang('report.in12'); ?></th>
								<th class="input-sm"><?= lang('report.in13'); ?></th>
								<th class="input-sm"><?= lang('report.in14'); ?></th>
								<th class="input-sm"><?= lang('report.in15'); ?></th>
								<th class="input-sm"><?= lang('report.in16'); ?></th>
								<th class="input-sm"><?= lang('report.in17'); ?></th>
								<th class="input-sm"><?= lang('report.in18'); ?></th>
								<th class="input-sm"><?= lang('report.in19'); ?></th>			
							</tr>
						</thead>
