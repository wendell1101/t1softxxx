									...
									<tr>
										...
										<td class="input-sm">
											<?php if ($start_date == $end_date) {?>
												<a href="<?=BASEURL . 'report_management/viewGamesReportToday/' . urlencode($start_date)?>">
													<?=$value['date']?>
												</a>
											<?php } else {?>
												<a href="<?=BASEURL . 'report_management/viewGamesReportDaily/' . urlencode($start_date) . "/" . urlencode($end_date)?>">
													<?=$value['date']?>
												</a>
											<?php }
		?>
