                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-lg-4">
                       <label class="control-label" for="group_by"><?=lang('Date')?> </label>
                        <input class="form-control dateInput normal-font-weight " id="datetime_range" data-start="#datetime_from" data-end="#datetime_to" data-time="false"/>
                    ...
                    <div class="col-md-3">
                        ...
                        <select name="group_by" id="group_by" class="form-control input-sm normal-font-weight">
     ...
     //---------------------Multi select search  end----------------------------
       ...
       var dataTable = $('#myTable').DataTable({
            ...
            ajax: function (data, callback, settings) {
                ...
                $.post(base_url + "api/oneworksGameReports", data, function(data) {
                 if(data.recordsTotal > 0){
