					...
					<table class="table table-striped table-hover" style="margin: 0px 0 0 0; width: 100%;" id="playerTable">
						<thead>
							<tr>
								...
								<th class="input-sm"><?= lang('report.sum15'); ?></th>	
								<th class="input-sm"><?= lang('player.uc02'); ?></th>			
							</tr>
						</thead>
							...
							<?php if(!empty($player)) { ?>
								...
								?>
									<tr>
										...
										<td class="input-sm"><?= ($value['receivedOn'] == null) ? lang('lang.norecord'):$value['receivedOn']  ?></td>
									</tr>
							<?php
									}
								}
