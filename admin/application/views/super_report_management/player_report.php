    ...
    <div class="panel-body">
        <table class="table table-condensed table-bordered table-hover" id="reportTable" data-searching="false" data-ordering="true data-page-length="10">
            ...
            <tr>
                ...
                <th><?=lang('report.pr05')?></th>
                <th><?=lang('report.pr15')?></th>
                <th><?=lang('report.pr16')?></th>
                <th><?=lang('report.pr17')?></th>
                <th><?=lang('report.pr18')?></th>
                <th><?=lang('report.pr19')?></th>
                <th><?=lang('report.pr20')?></th>
    ...
    $(document).ready(function(){
        ...
        var dataTable = $('#reportTable').DataTable({
            ...
            ajax: function (data, callback, settings) {
                ...
                $.post(base_url + "api/super_player_report", data, function(data) {
                    callback(data);
            ...
            buttons: [
                ...
                ,{
                    ...
                    action: function ( e, dt, node, config ) {
                        ...
                        utils.safelog(d);  
                        $("#_export_excel_queue_form").attr('action', site_url('/export_data/export_super_player_report'));
