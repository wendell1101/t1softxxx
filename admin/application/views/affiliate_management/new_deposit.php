		...
		<div class="panel panel-primary">
			<div class="panel-heading">
				<h3 class="panel-title">
					<i class="fa fa-plus"></i> <?=lang('Deposit Affiliate')?>
				</h3>
			</div>
			<div class="panel-body">
				...
				<form id="form" method="post" autocomplete="off">
					...
					<div class="form-group required">
						<label for="amount" class="control-label"><?=lang('Wallet')?></label>
			...
			<div class="panel-footer">
				<div class="text-right">
					<button type="submit" form="form" class="btn <?=$this->utils->getConfig('use_new_sbe_color') ? 'btn-portage' : 'btn-primary'?>"><i class="fa fa-plus-circle"></i>
					<?=lang('Deposit Affiliate')?></button>
				</div>
			</div>
		</div>
	</div>
