        ...
        <!-- <div class="table-responsive" id="statisticsList" style="overflow:auto"> -->
            <table class="table table-striped table-hover" id="statisticsTable" style="width:100%">
                <thead>
                    <tr>
                        <th></th>
                        <th class="input-sm"><?= lang('aff.as19'); ?></th>
                        <th class="input-sm"><?= lang('aff.as04'); ?></th>
                        ...
                        <th class="input-sm"><?= lang('aff.as10'); ?></th>
                        <th class="input-sm"><?= lang('aff.as11'); ?></th>
                        <th class="input-sm"><?= lang('aff.as20'); ?></th>
                        <th class="input-sm"><?= lang('aff.as21'); ?></th>
                    </tr>
                </thead>
                ...
                <tbody>
                    ...
                    ?>
                                    <tr>
                                        <td></td>
                                        <td class="input-sm"><?= $row['username'] ?></td>
                                        <td class="input-sm"><?= $row['realname'] ?></td>
                                        <td class="input-sm"><?= $row['pt_bets'] ?></td>
                                        <td class="input-sm"><?= $row['ag_bets'] ?></td>
                                        <td class="input-sm"><?= $row['total_bets'] ?></td>
                                        <td class="input-sm"><?= $row['pt_wins'] ?></td>
                                        <td class="input-sm"><?= $row['ag_wins'] ?></td>
                                        <td class="input-sm"><?= $row['total_wins'] ?></td>
                                        ...
                                        <!-- <td class="input-sm"><?= $row['total_net_income'] ?></td> -->
                                        <td class="input-sm"><?= ($row['location'] == null) ? lang('lang.norecord'):$row['location'] ?></td>
                                        <td class="input-sm"><?= ($row['ip_address'] == null) ? lang('lang.norecord'):$row['ip_address'] ?></td>
                                        <td class="input-sm"><?= ($row['lastLoginTime'] == null) ? lang('lang.norecord'):$row['lastLoginTime'] ?></td>
                                        <td class="input-sm"><?= ($row['lastLoginIp'] == null) ? lang('lang.norecord'):$row['lastLoginIp'] ?></td>
                                    </tr>
                    <?php       }
                            }
                    ?>
