...
if (!empty($statistics)) {
	foreach ($statistics as $row) {
		...
		?>
                                    <tr>
                                        <td></td>
                                        <td class="input-sm"><a href="<?=BASEURL . 'affiliate_management/viewAffiliateStatisticsWeekly/' . urlencode($row['first_date']) . '/' . urlencode($row['last_date'])?>"><?=date('F Y', strtotime($row['first_date']))?></a></td>
