	...
	<div class="col-md-12" id="toggleView">
		<div class="panel panel-primary">
			...
			<div class="panel panel-body" id="affiliate_panel_body">
				<form method="POST" action="<?= BASEURL . 'affiliate_management/verifyEditAffiliate/' . $affiliate_id . '/' . $affiliate_payout_id ?>" accept-charset="utf-8">
					<!-- Personal Info -->
					<!-- <div class="panel panel-info">
						...
						<div class="panel-body">
							...
							<div class="row">
								...
								<div class="col-md-4 col-md-offset-0">
									<input type="text" name="zip" id="zip" class="form-control" value="<?= set_value('zip'); ?>">
								...
								<div class="col-md-4 col-md-offset-0">
									<select name="country" id="country" class="form-control">
										...
										<?php foreach (unserialize(COUNTRY_LIST) as $key) {  ?>
			                                <option value="<?= $key?>" <?= (set_value('country') == $key) ? 'selected':'' ?>><?= $key?></option>
			                            <?php } ?>
									</select>
							...
							<div class="row">
								...
								<div class="col-md-4 col-md-offset-0">
									<input type="text" name="im" id="im" class="form-control" value="<?= set_value('im'); ?>">
								...
								<div class="col-md-4 col-md-offset-0">
									<input type="text" name="imtype" id="imtype" class="form-control" value="<?= set_value('imtype'); ?>">
							...
							<div class="row">
								...
								<div class="col-md-4 col-md-offset-0">
									<select name="mode_of_contact" id="mode_of_contact" class="form-control">
										...
										<option value="email" <?= (set_value('mode_of_contact') == "email") ? "selected":""?> >Email</option>
										<option value="phone" <?= (set_value('mode_of_contact') == "phone") ? "selected":""?> >Phone</option>
										<option value="mobile" <?= (set_value('mode_of_contact') == "mobile") ? "selected":""?> >Mobile Phone</option>
										<option value="im" <?= (set_value('mode_of_contact') == "im") ? "selected":""?> >Instant Message</option>
									</select>
								...
								<div class="col-md-4 col-md-offset-0">
									<input type="text" name="website" id="website" class="form-control" value="<?= set_value('website'); ?>">
							...
							<div class="row">
								...
								<div class="col-md-4 col-md-offset-0">
									<select name="currency" id="currency" class="form-control">
										...
										<option value="CNY" <?= (set_value('currency') == 'CNY') ? 'selected':'' ?> >CNY</option>
										<option value="USD" <?= (set_value('currency') == 'USD') ? 'selected':'' ?> >USD</option>
									</select>
									<label style="color: red; font-size: 12px;"><?php echo form_error('currency'); ?></label>
								</div>
							</div>
							<input type="hidden" name="currency" id="currency" value="<?= set_value('currency') ?>">
						</div>
					</div> -->
							...
							<div class="row">
								...
								<div class="col-md-4 col-md-offset-0">
									<select name="payment_method" id="payment_method" class="form-control">
										...
										<option value="Wire Transfer" <?= (set_value('payment_method') == "Wire Transfer") ? "selected":"" ?> >Wire Transfer</option>
									</select>
					...
					<div class="panel panel-info">
						...
						<div class="panel-body">
								...
								<div class="col-md-6 col-md-offset-0">
									<table class="table">
										<thead>
											...
											<th><input type="checkbox" name="check_percentage" id="check_percentage" <?= (set_value('check_percentage') == 'on') ? "checked":"" ?> onclick="percentage();"> <?= lang('aff.ai33'); ?> (%)</th>
										</thead>
										<tbody>
							...
							<div class="row">
								<!-- <div class="col-md-2 col-md-offset-0">
									<input type="checkbox" name="check_percentage" id="check_percentage" <?= (set_value('check_percentage') == 'on') ? "checked":"" ?> onclick="percentage();"> Percentage (%)
								</div> -->

								<!-- <div class="col-md-1 col-md-offset-0">
									<input type="text" name="percentage" id="percentage" class="form-control" value="<?= set_value('percentage') ?>">
								</div> -->

								<div class="col-md-3 col-md-offset-0">
									<input type="checkbox" name="check_active_player" id="check_active_player" <?= (set_value('check_active_player') == 'on') ? "checked":"" ?>> <?= lang('aff.ai65'); ?>
								</div>

								<!-- <div class="col-md-1 col-md-offset-0">
									<input type="checkbox" name="check_cpa" id="check_cpa" <?= (set_value('check_cpa') == 'on') ? "checked":"" ?>> CPA
								</div>

								<div class="col-md-1 col-md-offset-0">
									<input type="text" name="cpa" id="cpa" class="form-control" value="<?= set_value('cpa') ?>">
								</div> -->
							</div>
					...
					<div class="panel panel-info">
						...
						<div class="panel-body">
							<div class="row">
								...
								<div class="col-md-4 col-md-offset-0">
									<input type="text" name="minimum" id="minimum" class="form-control" value="<?= set_value('minimum') ?>">
							...
							<div class="row">
								...
								<div class="col-md-4 col-md-offset-0">
									<input type="text" name="maximum" id="maximum" class="form-control" value="<?= set_value('maximum') ?>">
							...
							<div class="row">
								...
								<div class="col-md-4 col-md-offset-0">
									<!-- <select name="payment_options" id="payment_options" class="form-control" disabled>
										<option value="" >Click to Select</option>
										<option value="Daily" <?= (set_value('payment_options') == 'Daily') ? 'selected':'' ?> >Daily</option>
										<option value="Weekly" <?= (set_value('payment_options') == 'Weekly') ? 'selected':'' ?> >Weekly</option>
										<option value="Monthly" <?= (set_value('payment_options') == 'Monthly') ? 'selected':'' ?> >Monthly</option>
										<option value="Yearly" <?= (set_value('payment_options') == 'Yearly') ? 'selected':'' ?> >Yearly</option>
									</select> -->
						...
						<div class="panel-body">
							<div class="row">
								<div class="col-md-2 col-md-offset-0">
									...
									<input type="checkbox" name="frozen" id="frozen" <?= (set_value('status') == 'on') ? 'checked':'' ?>>
								</div>

								<!-- <div class="col-md-3 col-md-offset-0">
									<label for="internal_account">Internal Account: </label> &nbsp;&nbsp;
									<input type="checkbox" name="internal_account" id="internal_account" <?= (set_value('internal_account') == 'on') ? 'checked':'' ?>>
								</div> -->
							</div>	
						</div>
					</div>
