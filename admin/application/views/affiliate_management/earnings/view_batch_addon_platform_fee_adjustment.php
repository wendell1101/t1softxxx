    ...
    <div class="panel panel-primary">
        <div class="panel-heading">
            <h4 class="panel-title">
                <?php echo lang('Batch Addon Platform Fee Adjustment'); ?>
            </h4>
        </div>
        <div class="panel-body">
            <form class="form-horizontal" action="<?php echo site_url('/affiliate_management/post_batch_addon_platform_fee_adjustment');?>"
                method="post" onsubmit="return submitForm();" accept-charset="utf-8" enctype="multipart/form-data">
                <div class="form-group">
                    <label class="col-md-12"><?=lang('hint.batch_addon_platform_fee_adjustment')?></label>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9 form-inline">
                        <div class="">
                            <input type="file" name="batch_addon_platform_fee_adjustment_csv_file" class="form-control input-sm" required="required" accept=".csv">
                        </div>
