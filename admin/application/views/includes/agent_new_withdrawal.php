	...
	<div class="col-md-offset-4 col-md-4">
		<div class="panel panel-primary">
			<div class="panel-heading">
				<h3 class="panel-title"><?=lang('Agent Withdraw')?>
				</h3>
			</div>
			<div class="panel-body">
				...
				<form id="form" method="post" autocomplete="off">
					...
					<div class="form-group required">
						<label for="username" class="control-label"><?=lang('Agent Main Wallet')?></label>
						<input id="balance" class="form-control" type="text" value="0.00" readonly="readonly" tabindex="-1" />
					</div>
					<?php }else{ ?>
					<div class="form-group required">
						<label for="username" class="control-label"><?=lang('Agent Locked Wallet')?></label>
						<input id="balance" class="form-control" type="text" value="0.00" readonly="readonly" tabindex="-1" />
					</div>
					<?php }?>
					<div class="form-group required">
			...
			<div class="panel-footer">
				<div class="text-right">
					<button type="submit" form="form" class="btn btn-primary"><i class="fa fa-minus"></i> <?=lang('Agent Withdraw')?></button>
...
<script type="text/javascript">
	...
	$( function() {
		...
		$( '#username' ).change( function() {
			...
			$.post('/api/get_agent_wallet_balance', data, function(response) {
				if (response.balance) {
