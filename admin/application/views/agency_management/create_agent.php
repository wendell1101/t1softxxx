...
if(!is_array($conditions['settlement_period'])){
    $conditions['settlement_period']=[];
}
...
<form method="POST" id="agency_main_form"
    action="<?=site_url('agency_management/verify_agent')?>" accept-charset="utf-8">
    ...
    <div class="panel panel-primary ">
        ...
        <div class="panel-heading">
            ...
            <div class="pull-right">
                <?php echo lang('Fields with');?> (<font style="color:red;">*</font>) <?php echo lang('are required.');?>
            </div>
        ...
        <div class="panel panel-body" id="create-agent_panel_body">
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-3 fields">
                    ...
                    maxlength="20" value="<?=set_value('tracking_code');?>" data-toggle="tooltip"
            ...
            <div class="col-md-12">
                ...
                <fieldset>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                data-toggle="tooltip" title="<?=lang('Agent Level');?>" readonly>
                            </div>
                        </div>
                    ...
                    value="<?=$conditions['allowed_level_names']?>" />
                    <!-- input agent_level  }}}4 -->
