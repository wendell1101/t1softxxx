<?php
/**
 *   filename:   agent_bank_account.php
 *   date:       2016-05-03
    ...
    <div class="col-md-12" id="toggleView">
        <div class="panel panel-primary">
            ...
            <div class="panel-body" id="bank_info">
                <!-- Personal Info -->
                <form method="POST" action="<?= BASEURL . 'agency_management/verify_bank_account' ?>" 
