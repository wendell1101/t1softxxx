...
<form method="POST" id="agency_main_form"
    action="<?=site_url('agency_management/verify_update_agent/'. $check)?>" accept-charset="utf-8">
        ...
        <div class="panel panel-body" id="edit-agent_panel_body">
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-3 fields">
                    ...
                    maxlength="20" value="<?=$conditions['tracking_code'];?>" data-toggle="tooltip"
                    title="<?=lang('Tracking Code');?>">

                    <span class="errors"><?php echo form_error('tracking_code'); ?></span>
                    <span id="error-tracking_code" class="errors"></span>
                </div> <!-- input tracking_code (required) }}}4 -->
            </div>
            <div class="col-md-12">
                <!-- select currency {{{4 -->
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                data-toggle="tooltip" title="<?=lang('Allowed Level');?>" readonly>
                            </div>
                        </div>
                        <span class="errors"><?php echo form_error('agent_level'); ?></span>
                        <span id="error-agent_level" class="errors"></span>
                    </div>
                    <!-- All allowed level names are stored in agent_level_name -->
                    <input type="hidden" name="agent_level_name" id="agent_level_name"
                    value="<?=$conditions['agent_level_name']?>" />
                    <!-- input agent_level  }}}4 -->
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-6" style="padding: 10px;">
                    <?php $reset_url=site_url('agency_management/edit_agent/'.$agent_id);?>
