<div class="container">
    <div class="panel panel-primary">
        <div class="panel-heading">
            <h4 class="panel-title"><span style="font-weight: bold;"><?php echo lang('Bulk Import Player Tags Result');?></span></h4>
        </div>
        ...
        <table class="table table-condensed">
            <tbody>
                ...
                <tr>
                    <td><?=lang('Success with Failure') ?></td>
                    <td><strong><span class="text-danger" id="successWithFailCount">0</span></strong></td>
                </tr>
                <tr>
    ...
    if(data['queue_result']){
        ...
        if(queue_result.progress === undefined){
           ...
           $('.progresslabel').html("");
            ...
            $('#successWithFailCount').html(addCommas(queue_result.successWithFailCnt));
