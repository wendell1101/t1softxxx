<div id="adjustment_history_panel" data-file-info="ajax_ui_adjustment_history_tab.php" data-datatable-selector="#adjustment_history">
    ...
    <hr/>
    <div class="clearfix">
        <table id="adjustment_history" class="table table-bordered">
            <thead>
                <tr>
...
<script type="text/javascript">
    function adjustmentHistory() {
        var dataTable = $('#adjustment_history').DataTable({
            ...
            ajax: function (data, callback, settings) {
                ...
                $.post('/api/adjustment_history_tab/' + playerId, data, function(data) {
                    callback(data);
                },'json');
            }
        });
        ...
        ATTACH_DATATABLE_BAR_LOADER.init('adjustment_history');
    }
</script>