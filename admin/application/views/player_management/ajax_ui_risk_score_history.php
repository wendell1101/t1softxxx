<div data-file-info="ajax_ui_risk_score_history.php" data-datatable-selector="#kycHistory-table">
    ...
    <div class="clearfix">
        <table id="kycHistory-table" class="table table-bordered">
            <thead>
                ...
                <th><?=lang('Result Changes');?></th>
                <th><?=lang('Change of Score');?></th>
                <th><?=lang('Change of Total Score');?></th>
                <th><?=lang('Risk Score Level');?></th>
            </thead>
        </table>
    </div>
</div>
    ...
    function riskScoreHistory() {
        var dataTable = $('#kycHistory-table').DataTable({
            ...
            ajax: function (data, callback, settings) {
                ...
                $.post(base_url + 'api/risk_score_history/' + playerId, data, function(data) {
                    callback(data);
                },'json');
            }
        });
