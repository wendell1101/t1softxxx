<table class="table table-striped table-hover" id="bonusTable" style="margin: 0px 0 0 0; width: 100%;">
	<thead>
		<tr>
			<th></th>
	...
	?>
		...
		?>
				<tr>
					...
					<td><?=$playerpromo['currentBet'][0]->totalBetAmount == '' ? '<i>No Bet Yet</i>' : $playerpromo['currentBet'][0]->totalBetAmount;?></td>
                                                    <?php
