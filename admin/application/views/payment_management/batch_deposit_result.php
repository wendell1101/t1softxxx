	...
	<div class="col-md-4 col-md-offset-4">
		<div class="panel panel-primary">
			<div class="panel-heading">
				<h4 class="panel-title">Batch Deposit Result</h4>
			</div>
			<div class="panel-body">
				...
				<hr/>
				<a href="<?=site_url('payment_management/batchDeposit')?>" class="btn btn-primary btn-block">Return to Batch Deposit</a>
			</div>
		</div>
	</div>
</div>
...
$(function(){
	window.onbeforeunload = function() {
	    window.location = "<?=site_url('payment_management/batchDeposit')?>";
	}
});
