...
$lang['system_feature_desc_enable_deposit_page_make_manual_deposit_upload_helptext_always_showing'] = "如果启用, 存款页面手动存款上传帮助文本始终显示。 <ul><li>出纳中心 &gt; 存款 tab &gt; 银行存款 &gt; 上传文件</li></ul>";
$lang['system_feature_desc_enable_display_manual_deposit_datetime_step_hint'] = "如果启用,<b>存款日期与时间</b>的提示将会显示在公司存款页面。";
...
$lang['system_feature_desc_hide_deposit_selected_bank_and_text_for_ole777'] = "If enabled, selected bank in Player Center deposit page will be hidden. <br><b>Note:</b> enable_deposit_category_view should be enabled for this to work as expected.";
...
$lang['system_feature_desc_enable_display_manual_deposit_upload_documents_step_hint'] = "If enabled,upload document step hint will show in manual deposit page <br><b>Note:</b> enable_deposit_upload_documents must be enabled first for this to work as expected.";
$lang['system_feature_desc_enable_display_manual_deposit_note_step_hint'] = "如果启用,<b>备注</b>的提示将会显示在公司存款页面。";
...
/* Withdrawal Tab
/* -------------------------------------------------------------- */
$lang['system_feature_desc_auto_deduct_withdraw_condition_from_bet']='自动从返水投注额中减去取款条件，仅限于要求减去的优惠规则=不与返水共享流水';
...
$lang['system_feature_desc_check_withdrawal_conditions_foreach'] = "If enabled, player will not be able to continue withdrawal unless all bet amount withdrawal condition has been met. All Withdrawal Condition's status should be Ready.<br> <ul><li>SBE > Player tab > All Players > Search Username > Player Information > Withdrawal Condition > Bet Amount Withdrawal Condition (check each if met)</li></ul>";
...
If enabled, all Player balance should automatically be</br>
<ul><li><b>i.</b> Transferred from Main Wallet to Game Wallet as soon as the game has been accessed.</li>
<li><b>ii.</b> Transferred back to Main Wallet once Withdrawal is successfully requested.</li></ul>
<b>Note:</b></br>
<ul><li><b>i.</b> No. ii will still be working even if this feature is not ticked as long as enabled_single_wallet_switch is enabled.</li>
<li><b>ii.</b> The whole Transfer tab would be hidden.</li>
<li><b>iii.</b> This System Feature should be enabled first before game access to show immediate result. If no changes, try to reload game and refresh Cashier Center page.</li></ul>
<ul><li> Player Center > Cashier Center Sidebar > Game Wallet </li></ul>";
$lang['system_feature_desc_disable_account_transfer_when_balance_check_fails'] = "If enabled, whenever query balance on game API failed, player shouldn't be able to transfer from sub wallet to sub wallet or main wallet to sub wallet and vice versa.";
...
$lang['system_feature_desc_duplicate_bank_account_number_verify_status_active'] = 'If enabled, Duplicated bank account number verification will append verify status is active. <ul><li>Player Center &gt; Cashier Center &gt; Bank Info tab &gt; Deposit/Withdraw Bank tab</li></ul>';
...
$lang['system_feature_desc_enabled_transfer_condition'] = 'If enabled, Generate Transfer Condition step should be shown in Edit/Create Promo Rule and Transfer Condition panel should be shown in Player Information.<ul><li>1. SBE > Marketing tab > Promo Rules Settings sidebar > Add New Promo Rule or Edit Promo Rule</li><li>2. SBE > Player tab > Player List > Player List > Click any player > Player Information > Transfer Condition tab</li></ul>';
...
$lang['system_feature_desc_disable_player_multiple_upgrade'] = 'If enabled, player should not be able to have multiple upgrade in VIP level even if he/she meets the upgrade condition for a higher vip level.<ul><li>1. Player Center > VIP Level portion 2. SBE > Player tab > VIP Settings sidebar > VIP Group > Edit Settings >  Level Up/Down Setting</li></ul>';
...
$lang['system_feature_desc_disabled_player_to_change_security_question'] = 'If disabled, will hidden Change Security Question after filled out Security Question in Player Center. <ul><li>Player Center > Security Tab > Security Question > Change Secret Question</li></ul>';
...
$lang['system_feature_desc_hidden_bet_amount_col_on_the_referral_report'] = '隐藏总投注字段于好友推荐状态报表';
$lang['system_feature_desc_disabled_display_sub_total_row_in_player_center_game_history_report'] = 'If disabled, will hidden the Sub Total row in player center game history repor.<ul><li>Player Center > Account History Sidebar > Game History</li></ul>';
$lang['system_feature_desc_hidden_bonus_col_on_the_referral_report'] = '隐藏奖金字段于好友推荐状态报表';
...
$lang['system_feature_desc_enable_player_message_request_form'] = 'If enabled, request form button for message function should be seen floating on the lower right corner of the Player Center and Request Form tab on Messages Settings under CS Management tab on SBE.<ul type = "1"><li>Player Center > Request Form button (floating button on the lower right</li><li>SBE > CS tab > Messages sidebar > Messages panel heading > Messages Settings button > Request Form tab</li></ul>';
...
$lang['system_feature_desc_force_refresh_all_subwallets'] = "If enabled, when player loads or refreshes their wallet balances, all subwallet balances will be updated.<br><b>Note:</b> This one is more of backend, you will not be sure whether a force update happened</br>";
...
$lang['system_feature_desc_enabled_switch_www_to_https'] = 'If enabled, Client site should be switched to "https" from "www"</br><b>Note:</b> The og_config should be set for this to work as expected
<ul><li>Player Center > Home</li></ul>';
...
$lang['system_feature_desc_agency_hide_binding_player'] = 'If enabled, binding player should not be shown.<ul><li>SBE > Agency Tab > Agent List > Search Agent Username > Click on Agent Username > Agent Information</li></ul>';
$lang['system_feature_desc_agency_hide_sub_agent_list_action'] = 'If enabled, icons/action buttons under Actions/Operating column should not be shown.<ul><li>Agency Page > Lists tab > Sub-Agent List (Proxy List) > Action (Operating) Column</li></ul>';
$lang['system_feature_desc_agency_information_self_edit'] = 'If enabled, agent should be able to reset his own account and withdrawal passwords and should be able sub-agent information (except for the sub-agent username).<ul><li>Agency Page > Settings tab > Account Information</li></ul>';
...
$lang['system_feature_desc_agent_hide_export'] = 'If enabled, Export Report in CSV button should not be shown in<ul><li>1. Agent Report</li><li>2. Player Report</li><li>3. Agent Settlement List</li><li>4. Games Report</li></ul>Agency Page > Report ><ul><li>1. Agent Report</li><li>2. Player Report</li><li>3. Agent Settlement List</li><li>4. Games Report</li></ul>';
...
$lang['system_feature_desc_agent_player_cannot_use_deposit_withdraw'] = "If enabled, the deposit, withdrawal, and bank info tab should be hidden from player center.<ul><li>Player Center > Cashier Center</li></ul>";
...
$lang['system_feature_desc_settlement_include_all_downline'] = 'if enabled, generate settlement will include all downline of agent.<br><ul><li>Upon generating agent settlement</li></ul>';
...
$lang['system_feature_use_deposit_withdraw_fee'] = 'If enabled, <i>Transaction Fee</i> setting will be replaced with <i>Deposit Fee</i> and Withdraw Fee</i> setting.';
$lang['system_feature_desc_allow_transfer_wallet_balance_to_binding_player'] = 'If enabled, agents can transfer their wallet balance to main wallet of its binding player account, so they can withdraw money using player\'s withdrawal facility.';
$lang['system_feature_enable_agency_prefix_for_game_account']='每个游戏API有不同的玩家前缀, 只影响代理下的玩家';
$lang['system_feature_desc_hide_reg_page_for_subagent_link_if_parent_agent_cannot_have_subagents'] = "当信用代理的子代理权限停用时，<ul>
<li><b>啟用</b>本功能：此信用代理的次级代理链接将无法打开信用代理注册页。</li>
<li><b>停用</b>本功能：次级代理链接仍可打开信用代理注册页，但由该链接注册的新代理不会成为该信用代理的子代理。</li>";
...
$lang['system_feature_desc_aff_show_real_name_on_reports'] ="If enabled. Real Name Column will appeared in Player Report Table. <ul><li>Aff &gt; (Access through : http://aff.og.local/affiliate/affiliate_player_report)</li></ul>";
...
$lang['system_feature_desc_enable_sub_affiliate_commission_breakdown'] = 'If enabled, the sub affiliate commission will be clickable and will display the breakdown of sub-affiliate commission. <ul><li>SBE &gt; Affiliate &gt; Earnings Report</li></ul>';
...
$lang['system_feature_desc_enable_player_benefit_fee'] = "
1. If enabled, the player's benefit fee column will display in Earnings Report and Affiliate Earnings under Affiliate Information</br>
2. If enabled, Batch Benefit Fee Adjustment should be shown in Affiliate tab
<ul><li>SBE > Affiliate > Earnings Report</li>
<li>Aff BO > Report > Earnings</li>
<li>SBE > Affiliate tab > Affiliate List > Affiliate Information > Affiliate Earnings panel</li>
<li>SBE > Affiliate > Batch Benefit Fee Adjustment</li></ul>";
$lang['system_feature_desc_enable_addon_affiliate_platform_fee'] = "
1. If enabled, the add-on platform fee column will display in the Affiliate Earnings Report</br>
2. If enabled, Batch Add-on Platform Fee Adjustment Function should be shown under Affiliate tab.</br>
1. SBE > Affiliate tab > Earnings Report</br>
2. SBE > Affiliate tab > Batch Addon Platform Fee";
...
$lang['system_feature_desc_show_player_contact_on_aff'] = 'If enabled, email address will be masked.';
...
$lang['system_feature_desc_individual_affiliate_term'] = "Individual affiliate term.";
...
$lang['system_feature_desc_show_cashback_and_bonus_on_aff_player_report'] = 'If enabled, Total Cashback and Total Bonus column in Player Report Table.<ul><li>Aff > Report > Player Report</li></ul>';
...
$lang['system_feature_desc_masked_affiliate_username_on_affiliate'] = "Masked affiliate username on affiliate.";
$lang['system_feature_desc_masked_player_username_on_affiliate'] = 'If enabled, Linked Account Details portion should be shown in Player Information.<ul><li>Affiliate > Player list<br>Note: to verify this enable both features.<ul><li>show_player_info_on_affiliate & masked_player_username_on_affiliate</li></ul></li></ul>';
...
$lang['system_feature_desc_disable_aff_gross_rev_formula_dep_minus_withdraw'] = "Disable affiliate gross rev formula deposit minus withdraw";
...
$lang['system_feature_desc_hide_affiliate_message_login_form'] = 'Hide the notification message in affiliate login form after the successful registration of affiliate user. <ul><li>Affiliate &gt; Registration</li></ul>';
...
$lang['system_feature_desc_masked_affiliate_username_on_affiliate'] = 'If enabled, the affiliate username will be masked (showing only the first four letter) in the Sub Affliate Tab.<ul><li>Affiliate Program &gt; Sub-affiliate Tab</li></ul>';
...
$lang['system_feature_desc_only_compute_fees_from_bet_of_valid_game_platforms'] = 'If enabled, affiliate calculation under \'Commission Computation By Tier\' setting will not count those games not ticketed under \'Select Game Platform\' checkboxes.';
...
$lang['system_feature_desc_enable_c6_acuris_api_authentication'] = "<b>Case #1:</b> If enabled, C6 Authentication button must be shown provided that 'show_c6_authentication' system feature is also enabled.
...
$lang['system_feature_desc_batch_decline_promo'] = "If enabled, &quot;Batch Decline Promo&quot; action button must be visible above the Promo Request List table if Pending Request portlet is clicked.<br><b>Note:</b> This is only accessible under Pending Requests tab and Declined tab. For it to be accessible under Declined tab, the system feature <b>&quot;declined_forever_promotion&quot;</b> must be enabled first, and the action button labeled as <b>&quot;Batch Forever Decline Promo&quot;</b> should be shown.<ol><li>SBE > Marketing Tab > Promo Request List sidebar > Pending Request portlet</li><li>SBE > Marketing Tab > Promo Request List sidebar > Declined portlet</li></ol>";
...
$lang['system_feature_desc_disable_frequently_use_country_in_registration']="If enabled, frequently used countries will not be shown on top of the list. <ul><li>Player Center &gt; Free Registration &gt; Select Country</li></ul>";
$lang['system_feature_desc_disable_mobile_access_comp_link'] = 'If enabled, footer of mobile website will have link "<b>Access computer version</b>". <ul><li>In Mobile Version website footer.</li></ul>';
...
</ol>";$lang['system_feature_desc_enable_batch_approve_and_decline'] = "If enabled, Approve Selected, Decline Selected buttons and checkbox (under Action column) will be shown in Deposit Request List.
...
$lang['system_feature_desc_show_bet_time_column'] = 'If enabled, the Bet Time column will appear it Game History Table.<ul><li>SBE &gt; Marketing Tab &gt; Game Logs</li></ul>';
...
$lang['system_feature_desc_disabled_withdraw_condition_share_betting_amount'] = 'If disabled, withdrawal condition will not share betting amount. <ul><li>SBE > All Players > Search Username > Player Information > Withdraw Condition > Betting Amount.</li></ul>';
...
$lang['system_feature_desc_disable_responsible_gaming_auto_approve'] = 'If disabled, responsible Gaming section will disable auto approve responsible gaming\'s request';
...
$lang['system_feature_desc_hide_bonus_group_on_agency']='Hide Bonus Group on Agency, will use old sub-agency link and player link';
$lang['system_feature_desc_masked_player_username_on_affiliate'] = 'If enabled, Linked Account Details portion should be shown in Player Information.<ul><li>Affiliate > Player list<br>Note: to verify this enable both features.<ul><li>show_player_info_on_affiliate & masked_player_username_on_affiliate</li></ul></li></ul>';
$lang['system_feature_desc_match_wild_char_on_affiliate_domain'] = 'if enabled. will get tracking code via Affiliate Domain Name or Affiliate Tracking Link.<ul><li>Upon registration in affiliate</li></ul>';
$lang['system_feature_desc_switch_old_aff_stats_report_to_new'] = 'If enabled, he affiliate statistics report 2 will show. <ul><li>1. SBE > Affiliate > Affiliate Statistics 2 </li></ul>';
...
$lang['system_feature_desc_ignore_player_analysis_permissions'] = "If enabled, whatever was set for viewing permissions for password, verification question, and verification answer, will all be disregarded.";
...
$lang['system_feature_desc_enable_income_access'] = "If enabled, Income Access integration will run for the system, including BTAG tracking and uploading of daily registration and sales report to specified SFTP server.";
$lang['system_feature_desc_enabled_switch_language_also_set_to_static_site'] = "執行語言設定時，也一併設定 www / m 網站。";
...
$lang['system_feature_desc_use_pwa_loader'] = "使用PWA模式加速网络";
$lang['system_feature_desc_enable_otp_on_adminusers'] = 'If enabled, two-factor authentication settings will be shown under Personal Settings and Reset 2FA buttons under VIew Users in SBE.<br><ul type = "1"><li>SBE > Marketing Tab > Promo Manager > Add New / Edit Promo</li></ul>';
$lang['system_feature_desc_enable_otp_on_player']='玩家启用二次验证功能';
$lang['system_feature_desc_enable_otp_on_agency']='信用代理启用二次验证功能';
$lang['system_feature_desc_enable_otp_on_affiliate']='广告代理启用二次验证功能';
...
$lang['system_feature_desc_enabled_backendapi'] = "启用后台API";
...
$lang['system_feature_desc_refresh_player_balance_before_userinformation_load'] = "If enabled, refresh balance of player before on load of user information page.";
$lang['operator_settings.iovation_api_list.enabled_iovation_in_affiliate_registration'] = "Enabled Iovation in Affiliate Registration";
$lang['operator_settings.iovation_api_list.enabled_iovation_in_affiliate_login'] = "Enabled Iovation in Affiliate Login";
$lang['operator_settings.iovation_api_list.enabled_auto_block_affiliate_if_denied_registration'] = "Auto Block Affiliate if Denied in registration";
$lang['operator_settings.iovation_api_list.enabled_auto_block_affiliate_if_denied_login'] = "Auto Block Affiliate if Denied in Login";
