 ...
 */
class Roulette_api_r26872 extends Abstract_roulette_api {

	const DAILY_SPIN_TIMES = 10;
	const CONSUMPTION = 50000;
	const MAX_AMOUNT_LIMIT = 9999999999;
	const API_PREFIX_R26872 = 'r26872';
	...
	public function getPlatformCode(){
		return self::R26872_API;
	}

	public function getPrefix() {
		return self::API_PREFIX_R26872;
	}

	public function getRouletteType($roulette_name){
		$type = '';
		switch ($roulette_name) {
			case self::API_PREFIX_R26872:
