 ...
 */
class Roulette_api_r26256 extends Abstract_roulette_api {

	const DAILY_SPIN_TIMES = 5;
	const CONSUMPTION = 3000;
	const MAX_AMOUNT_LIMIT = 3000;
	const API_PREFIX_R26256 = 'r26256';
	...
	public function getPlatformCode(){
		return self::R26256_API;
	}

	public function getPrefix() {
		return self::API_PREFIX_R26256;
	}

	public function getRouletteType($roulette_name){
		$type = '';
		switch ($roulette_name) {
			case self::API_PREFIX_R26256:
