 ...
 */
class Roulette_api_r26756 extends Abstract_roulette_api {

	const DAILY_SPIN_TIMES = 5;
	const CONSUMPTION = 2999;
	const MAX_AMOUNT_LIMIT = 2999;
	const API_PREFIX_R26756 = 'r26756';
	const PRE_CHECH_CMS_ID = '18';
	const TYPE_MANULLY_ADD = self::API_PREFIX_R26756.'_manully_add';
	...
	public function getPlatformCode(){
		return self::R26756_API;
	}

	public function getPrefix() {
		return self::API_PREFIX_R26756;
	}

	public function getRouletteType($roulette_name){
		$type = '';
		switch ($roulette_name) {
			case self::API_PREFIX_R26756:
	...
	public function generatePlayerRoulette($start_date, $end_date, $player_id, $promo_cms_id){
		...
		$deposit_list = $this->listDepositTransactions($player_id, $start_date, $end_date, $consumption);
