 ...
 */
class Roulette_api_normal_2 extends Abstract_roulette_api {

	const DAILY_SPIN_TIMES = 50;
	const CONSUMPTION = 50000;
    const API_PREFIX_NORMAL_2 = 'normal_2';
	...
	public function getPlatformCode(){
		return self::NORMAL_API_2;
	}

	public function getPrefix() {
		return self::API_PREFIX_NORMAL_2;
	}

	public function getRouletteType($roulette_name){
		$type = '';
		switch ($roulette_name) {
			case self::API_PREFIX_NORMAL_2:
