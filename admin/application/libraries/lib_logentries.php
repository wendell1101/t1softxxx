...
*
* Usage:
* $log = Logentries::getLogger('ad43g-dfd34-df3ed-3d3d3');
...
class Lib_logentries
{
	...
	public static function getLogger($token, $persistent, $ssl, $severity, $datahubEnabled, $datahubIPAddress, $datahubPort, $host_id, $host_name, $host_name_enabled, $add_local_timestamp)
	{
		...
		{
			self::$m_instance[$token] = new Lib_logentries($token, $persistent, $ssl, $severity, $datahubEnabled, $datahubIPAddress, $datahubPort, $host_id, $host_name, $host_name_enabled, $add_local_timestamp);
		}
