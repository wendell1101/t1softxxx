 ...
 */
class Clockwork_controller extends CI_Controller {
	...
	public function index($id = null, $last = null) {
		...
		// $this->output->set_content_type('application/json')->set_output(Clockwork\Support\CodeIgniter\Hook::getStorage()->retrieveAsJson($id, $last));
	}
