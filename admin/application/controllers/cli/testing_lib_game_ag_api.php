...
class Testing_lib_game_ag_api extends BaseTesting {
	...
	public function testAll() {
		...
		//$this->testPlayerBalanceAG();
		//$this->testWithdrawalToAG();
		//$this->blockPlayer();
		//$this->unblockPlayer();
	...
	private function testCreatePlayer() {
		...
		// $this->test($password, $player['password'], 'test create player for AG');
	}
	...
	private function testDepositToAG() {
		...
		$this->test($balResult['success'], true, 'Test Player Deposit to AG');
	}

	private function testWithdrawalToAG() {
		$playerName = 'asriinew2';
		$balResult = $this->game_platform_manager->withdrawFromGame($playerName, 5);
		log_message("error", var_export($balResult, true));
		$this->test($balResult['success'], true, 'Test Player Withdrawal to AG');
	}
	...
	private function testSyncGameLogs() {
		...
		$token = 'abc123';
		$dateTimeFrom = new DateTime('2016-10-23 00:00:00');
		$dateTimeTo = new DateTime('2016-10-29 23:59:59');
		//$playerName = 'asriinew2';
		$playerName = null;
		$gameName = '';
