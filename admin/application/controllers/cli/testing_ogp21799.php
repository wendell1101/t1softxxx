 ...
 * http://admin.og.local/cli/testing_ogp21799/index/test_getCombinedCaseList/1/1
 *
 * - List the players for the testing at last 180 days and limit 5.
 * http://admin.og.local/cli/testing_ogp21799/index/searchTestPlayerList/180/5
 *
 * - Execute the testing with plauyer_id=5357, limit 3 test cases.
 * http://admin.og.local/cli/testing_ogp21799/index/test_DowngradeFromCronjob/5357/3
 *
 *
 * Execute the testing via cli,
 * <code>
 * vagrant@default_og_livestablemdb-PHP7:~/Code/og/admin$ php public/index.php cli/testing_ogp21799/index/test_DowngradeFromCronjob 5357 3 | w3m -T text/html > ../logs/ogp21799.5357.test_DowngradeFromCronjob.log &
 * </code>
 *
 * To moniter the testing process via cli,
 * <code>
 * vagrant@default_og_livestablemdb-PHP7:~/Code/og/admin$ tail -f ../logs/testing_ogp21799-index.log|grep 'caseTotalAmount'
 * </code>
 * And check the keyword,"caseTotalAmount" and "keyNumber".
 *
 */
class Testing_ogp21799 extends BaseTestingOGP {
	...
	public function init(){
		...
		$this->appendFixBegin = '//// Begin append by testing_ogp21799 ////';
		$this->appendFixEnd = '//// End append by testing_ogp21799 ////';
...
EOF;
	...
	/**
	 * [TESTED] URI,
	 * http://admin.og.local/cli/testing_ogp21799/index/searchTestPlayerByPlayerId/5357
	 *
	 ...
	 * http://admin.og.local/cli/testing_ogp21799/index/test_DowngradeFromCronjob/5357/3
	 * Cli,
	 * php public/index.php cli/testing_ogp21799/index/test_DowngradeFromCronjob 5357 3 | w3m -T text/html > ../logs/ogp21799.5357.test_DowngradeFromCronjob.log
	 *
	...
	public function test_DowngradeFromCronjob( $theTestPlayerInfo = [] // # 1
		...
		$_combinedCaseList = [];
		//
		// issue case, CACB.EmptyPeriodMode.PeriodNotMet.OnLevelMaintainEnable.OverMaintainTime.IsMetLevelMaintainCondition.NoAccumulation.OGP21799
		// $_combinedCaseList[] = 'CACB.EmptyPeriodMode.PeriodNotMet.OnLevelMaintainEnable.OverMaintainTime.IsMetLevelMaintainCondition.NoAccumulation';
		//
		$doOutputHtml = false;
	...
	public function _tryDowngradeSuccessTriggerFromCronjobV2( $theTestPlayerInfo = [] // # 1
		...
		if( ! empty( $theTestPlayerInfo ) ){
			...
			$rlt = $this->utils4testogp->_preSetupAccumulationAndBettingTo($isAccumulationSeparated, $isBettingSeparated, $appendFixBegin, $appendFixEnd);
...
// var_dump($theLogFileList);
			...
			// $isOGP21799 = $this->_pos($generatedCallTrace, 'OGP21799');
			// if( $isOGP21799 ){
...
EOF;
	 ...
	 * [TESTED]
	 * http://admin.og.local/cli/testing_ogp21799/index/getCombinWithPeriodModeCaseListAndPeriodIsMetCaseListAndLevelMaintainTimeCaseList
	 *
	 * @return array
	 */
	...
	public function _getPeriodModeAndPeriodValueAndTEB_DateTimeAndEnableLevelMaintainFnFromCombinedCase( $thePlayerId
		...
		// gen by the URI, http://admin.og.local/cli/testing_ogp21799/index/getCombinWithPeriodModeCaseListAndPeriodIsMetCaseListAndLevelMaintainTimeCaseList
// ====
