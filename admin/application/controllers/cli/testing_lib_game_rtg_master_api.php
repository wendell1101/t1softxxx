...
class Testing_lib_game_rtg_master_api extends BaseTesting {

	private $platformCode = RTG_MASTER_API;
	private $platformName = 'RTG_MASTER_API';
	...
	private function testSyncGameLogs() {
		...
		$token = 'abc123d';
		$dateTimeFrom = new DateTime('2018-08-02 17:00:00');
		$dateTimeTo = new DateTime('2018-08-02 23:30:00');
	...
	private function testDeposit() { 
	    ...
	    $playerName = 'testlocal2';
	    $depositAmount = 1;
		$rlt = $this->api->depositToGame($playerName, $depositAmount,'test2');
		echo "<pre>";print_r($rlt);exit;
