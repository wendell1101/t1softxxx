...
class Testing_lib_game_beteast_api extends BaseTesting {

	private $platformCode = BETEAST_API;
	private $platformName = 'BETEAST_API';
	...
	private function testSyncGameLogs() {
		...
		$token = 'abc123d';
		$dateTimeFrom = new DateTime('2016-11-17 00:00:00');
		$dateTimeTo = new DateTime('2017-11-17 23:59:59');
	...
	private function testCreatePlayer() { 
		...
		$rlt = $this->api->createPlayer($username,'111','password');
		echo "<pre>";print_r($rlt);exit;
	}
	...
	private function testLoginPlayer() { 
		...
		$username = 'testgar1'; 
		$this->utils->debug_log("create player", $username);
		$rlt = $this->api->login($username,'146','password');
		echo "<pre>";print_r($rlt);exit;
	}
