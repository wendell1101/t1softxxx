...
class Testing_lib_game_og_v2_api extends BaseTesting {

	private $platformCode = OG_V2_API;
	private $platformName = 'OG_V2_API';
	...
	private function testSyncMergeToGameLogs() {
		...
		$token = 'abc123d';
		$dateTimeFrom = new DateTime('2019-01-18 00:34:00');
		$dateTimeTo = new DateTime('2019-01-18 23:50:00');
	...
	private function testSyncGameLogs() {
		$token = 'abc123d';
		$dateTimeFrom = new DateTime('2019-01-18 13:34:00');
		$dateTimeTo = new DateTime('2019-01-18 13:50:00');
