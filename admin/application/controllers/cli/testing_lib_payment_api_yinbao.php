...
class Testing_lib_payment_api_yinbao extends BaseTesting {

	private $platformCode = YINBAO_PAYMENT_API;
	private $api = null;
	...
	private function testCallbackSign() {
		...
		$json='{"partner":"17261","ordernumber":"D808531032805","orderstatus":"1","paymoney":"1.0000","sysnumber":"201611051730352354106590000","attach":"","sign":"3d825a576b97cc14f58bda648f6ed851"}';

		$data=json_decode($json, true);
		// $sign=$this->api->verify($data);

		// $this->utils->debug_log('data', $data, 'sign', $sign);
		// $this->test($sign, $data['sign'], 'Test API sign');

		$this->test($this->api->verify($data, $data['sign']), true, 'Test API callback sign');
