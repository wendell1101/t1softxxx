...
class Testing_lib_payment_api_rfupay extends BaseTesting {

	private $platformCode = RFUPAY_PAYMENT_API;
	private $api = null;
	...
	public function init() {
		...
		$this->test($apiClassName, 'payment_api_rfupay', 'Test loaded API\'s class name. Expected: payment_api_rfupay');
		...
		$this->test($this->api->getPrefix(), 'rfupay', 'Test loaded API\'s prefix. Expected: rfupay');
	...
	private function testCallback(){
		...
		$orderId='16963';
		$params=['partyId'=>'gateway_W00532', 'appType'=>'WECHAT', 'orderNo'=>'WESD738146191783', 'orderAmount'=>'100',
			'goods'=>'WES', 'encodeType'=>'Md5', 'signMD5'=>'1ab1d69aa1e0b7d958af9c940dde02cb',
			'tradeNo'=>'8800000003286682','bankBillNo'=>'8800000003286682','succ'=>'Y'];

		$this->api->callbackFromServer($orderId, $params);
