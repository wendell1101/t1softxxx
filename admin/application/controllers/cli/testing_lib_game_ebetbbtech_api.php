...
class Testing_lib_game_ebetbbtech_api extends BaseTesting {

	private $platformCode = EBET_BBTECH_API;
	private $platformName = 'EBET_BBTECH_API';
	...
	private function testSyncGameLogs() {
		...
		$token = 'abc123d';
		$dateTimeFrom = new DateTime('2017-07-27 20:00:00');
		$dateTimeTo = new DateTime('2017-07-27 20:10:59');
	...
	private function testSyncMergeToGameLogs() {
		...
		$dateTimeTo = new DateTime('2018-01-01 20:10:59');
		$this->api->syncInfo[$token] = array("dateTimeFrom" => $dateTimeFrom, "dateTimeTo" => $dateTimeTo);
