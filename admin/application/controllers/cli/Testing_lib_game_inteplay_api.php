...
class Testing_lib_game_inteplay_api extends BaseTesting {

	private $platformCode = INTEPLAY_API;
	private $platformName = 'INTEPLAY';
	private $api = null;
	...
	public function init() {
		...
		$username = 'testinteplay' . random_string('numeric');
	...
	public function testAll() {
		...
		// $rlt = $this->testIsPlayerExist();
		// var_dump(['testIsPlayerExist' => $rlt]);
