...
class Testing_lib_payment_api_dinpay extends BaseTesting {

	private $platformCode = DINPAY_PAYMENT_API;
	private $api = null;
	...
	public function init() {
		...
		$this->test($apiClassName, 'payment_api_dinpay', 'Test loaded API\'s class name. Expected: payment_api_dinpay');
		...
		$this->test($this->api->getPrefix(), 'dinpay', 'Test loaded API\'s prefix. Expected: dinpay');
	}
	...
	private function testCreateUrlAndCallback() {
		...
		$params = array(
			'merchant_code' => $this->api->getSystemInfo('dinpay_merchant_code'),
			'interface_version' => $this->api->getSystemInfo('dinpay_interface_version'),
	...
	private function testResultXML(){
		$xml="<?xml version=\"1.0\" encoding=\"UTF-8\" ?><dinpay><response><resp_code>ILLEGAL_PAY_BUSINESS</resp_code><resp_desc>业务未开启，请联系业务人员</resp_desc><sign_type>RSA-S</sign_type><sign>etsR5F3mGJfIKwrflGW0lxQfqNoQU5er/lVRLsvZIiS7miO6Lnk5ELi2XghKKfDVgaTQ3QPju7T9HOMUCLdyWjU+dTx0MUBdwRDx7v937NnMLTmuLvvdPiyIWMQrDyDWzpDv71zIoVIy8Ky/SewlqTH3jnLhRwn968ZOmwf5HCE=</sign><trade></trade></response></dinpay>";
		...
		$this->test($arr["dinpay"]["response"]["resp_code"], "ILLEGAL_PAY_BUSINESS",
			'Test result xml');
	}
