...
class Testing_lib_game_uc_api extends BaseTesting {

	private $platformCode = UC_API;
	private $platformName = 'UC_API';
	...
	private function testSyncGameLogs() {
		...
		$token = 'abc123d';
		$dateTimeFrom = new DateTime('2016-10-24 00:00:00');
		$dateTimeTo = new DateTime('2017-10-24 23:59:59');
