...
class Testing_lib_payment_api_truegateway extends BaseTesting {

	private $platformCode = TRUEGATEWAY_PAYMENT_API;
	private $api = null;
	...
	public function init() {
		...
		$this->test($apiClassName, 'payment_api_truegateway', 'Test loaded API\'s class name. Expected: payment_api_truegateway');
		...
		$this->test($this->api->getPrefix(), 'truegateway', 'Test loaded API\'s prefix. Expected: truegateway');
