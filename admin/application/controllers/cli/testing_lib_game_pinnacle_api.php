...
class Testing_lib_game_pinnacle_api extends BaseTesting {

    private $platformCode = PINNACLE_API;
    private $platformName = 'PINNACLE_API';
    ...
    private function testSyncGameLogs() {
        $token = 'okd.testdan02';
        $dateTimeFrom = new DateTime('2017-11-01');
        $dateTimeTo = new DateTime('2017-12-05');
    ...
    private function testSyncMergeToGameLogs() {
        ...
        $token = 'okd.testdan02';
        $dateTimeFrom = new DateTime('2017-10-01');
        $dateTimeTo = new DateTime('2017-11-30');
