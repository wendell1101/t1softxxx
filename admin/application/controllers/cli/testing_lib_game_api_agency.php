...
class Testing_lib_game_api_agency extends BaseTesting {

	private $platformCode = AGENCY_API;
	private $platformName = 'Agency';
	private $api = null;
	...
	public function init() {
		...
		$this->test_player->password = '123123';
	}
	...
	private function testSyncOriginalGameLogs() {
		...
		$token = 'IMPT123';
		$dateTimeFrom = new DateTime(date('Y-m-d', strtotime('2016-09-24 00:00:00')));
		$dateTimeTo = new DateTime(date('Y-m-d', strtotime('2016-09-24 23:59:59')));
