...
class Testing_lib_game_imslots_api extends BaseTesting {

	private $platformCode = IMSLOTS_API;
	private $platformName = 'IMSLOTS';
	private $api = null;
	...
	private function testSyncOriginalGameLogs() {
		...
		$token = 'IMSLOTS123';
		$dateTimeFrom = new DateTime(date('Y-m-d H:i:s', strtotime('2016-10-20 00:00:00')));
		$dateTimeTo = new DateTime(date('Y-m-d H:i:s', strtotime('2016-10-20 23:59:59')));

		$this->api->syncInfo[$token] = array("dateTimeFrom" => $dateTimeFrom, "dateTimeTo" => $dateTimeTo);
		$rlt = $this->api->syncOriginalGameLogs($token);
		$this->utils->debug_log('syncOriginalGameLogs', $rlt);
		$this->test($rlt['success'], true, 'Test Player Withdraw to IMSLOTS');
		return $rlt;
	}
	...
	private function testCreatePlayer() {
		...
		$this->test($rlt['success'], true, 'Test createPlayer to IMSLOTS');
		return $rlt;
	}
	...
	private function testDeposit() {
		...
		$this->test($rlt['success'], true, 'Test Player Deposit to IMSLOTS');
		return $rlt;
	}
