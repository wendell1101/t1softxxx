...
class Response implements ResponseInterface
{
	...
	public function __construct($status = 200, array $headers = [], $body = null, $version = '1.1', $reason = null)
	{
		...
		if (null === $reason && array_key_exists($this->statusCode, self::PHRASES)) {
			$this->reasonPhrase = self::PHRASES[$status];
		} else {
			$this->reasonPhrase = $reason!=null ? $reason : '';
		}
	...
	public function withStatus($code, $reasonPhrase = '')
	{
		...
		$new = clone $this;
		$new->statusCode = $code;
		if ((null === $reasonPhrase || '' === $reasonPhrase) && array_key_exists($new->statusCode, self::PHRASES)) {
