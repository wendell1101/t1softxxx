...
echo "$PHP_PATH $OG_BASEPATH/shell/ci_cli.php cli/sync_game_records/merge_game_logs_and_total_stats \"$2\" \"$3\" \"$4\""

$PHP_PATH $OG_BASEPATH/shell/ci_cli.php cli/sync_game_records/merge_game_logs_and_total_stats "$2" "$3" "$4"
