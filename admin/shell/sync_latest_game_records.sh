...
# sleep 1
echo "$PHP_PATH $OG_BASEPATH/shell/ci_cli.php cli/sync_latest_game_records/sync_game_records_latest \"$1\" \"$2\""

$PHP_PATH $OG_BASEPATH/shell/ci_cli.php cli/sync_latest_game_records/sync_game_records_latest "$1" "$2"
