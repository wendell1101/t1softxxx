...
# sleep 1
	echo "$PHP_PATH $OG_BASEPATH/shell/ci_cli.php cli/sync_get_reponse_data/sync_getreponse_data \"$1\" \"$2\""

	$PHP_PATH $OG_BASEPATH/shell/ci_cli.php cli/sync_get_reponse_data/sync_getreponse_data "$1" "$2"
