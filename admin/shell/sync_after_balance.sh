...
for i in $myarr ; do {
	...
	# sleep 1
	echo "$PHP_PATH $OG_BASEPATH/shell/ci_cli.php cli/sync_after_balance/sync_game_logs_afterbalance $i \"$2\" \"$3\""

	$PHP_PATH $OG_BASEPATH/shell/ci_cli.php cli/sync_after_balance/sync_game_logs_afterbalance "$i" "$2" "$3"
