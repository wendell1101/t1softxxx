...
for i in $myarr ; do {
	...
	# sleep 1
	echo "$PHP_PATH $OG_BASEPATH/shell/ci_cli.php cli/sync_batch_payout/sync_seamless_game_batch_payout_redis $i \"$2\" \"$3\""

	$PHP_PATH $OG_BASEPATH/shell/ci_cli.php cli/sync_batch_payout/sync_seamless_game_batch_payout_redis "$i" "$2" "$3"
