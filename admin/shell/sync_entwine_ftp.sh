...
mirror -F $REMOTE_DIR -F $REMOTE_DIR2 --dereference --use-cache --verbose --no-umask --parallel=5 --newer-than='now-7days' --log=/var/log/sync_entwine_ftp_mirror.log --exclude-glob .svn;
