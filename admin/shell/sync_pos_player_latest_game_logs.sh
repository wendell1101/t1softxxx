...
# sleep 1
echo "$PHP_PATH $OG_BASEPATH/shell/ci_cli.php cli/sync_pos_player_latest_game_logs/sync \"$1\" \"$2\""

$PHP_PATH $OG_BASEPATH/shell/ci_cli.php cli/sync_pos_player_latest_game_logs/sync "$1" "$2"
