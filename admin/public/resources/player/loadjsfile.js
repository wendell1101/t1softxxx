...
var _smartbackend = {
    ...
    safelog: function(msg){
        ...
        if(this.debugLog && typeof(console)!='undefined' && console.log){
            console.log(msg);
        }
    },
    init: function(){
    	var urlArr=this.urlName.split('.');
    	if(urlArr.length>0){
    		//remove first
    		urlArr.shift();
    		this.urlName=urlArr.join('.');
    	}
		//if (this.urlName == 'og.local'){
		//    this.prefix = this.protocol+'//';
		//}
		this.playerSiteUrl = this.prefix+this.urlName;
		this.playerMainJsUrl=this.playerSiteUrl+"/pub/"+this.siteName+"/player_main.js";
...
// if (_smartbackend.urlName == 'design.dwyl777.com'){
//     _smartbackend.urlName = _smartbackend.urlName.replace('design.','');
//     _smartbackend.prefix = 'http://player.staging.'
// }

// if (_smartbackend.urlName == 'dw777.com'){
//     _smartbackend.siteName = 'dw777'
// }

// if (_smartbackend.urlName == 'og.local'){
//     _smartbackend.prefix = 'http://'
// }

// _smartbackend.fileref=document.createElement('script')
// _smartbackend.fileref.setAttribute("type","text/javascript")
// _smartbackend.fileref.setAttribute("data-main",_smartbackend.prefix+_smartbackend.urlName+"/pub/"+_smartbackend.siteName+"/player_main")
// _smartbackend.fileref.setAttribute("src", _smartbackend.prefix+_smartbackend.urlName+"/resources/js/require.js")
// _smartbackend.fileref.setAttribute("async", true)
// document.body.appendChild(_smartbackend.fileref);
...
requirejs([_smartbackend.playerMainJsUrl]);
