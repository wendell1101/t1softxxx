    ...
    'fnClickHandler': function(e) {
        ...
        switch (sPage){
            case 'first':
                ...
                break;
            case 'previous':
                sPage = oSettings._iCurrentPage - 2;
                break;
            case 'next':
                sPage = oSettings._iCurrentPage;
                break;
            case 'last':
                sPage = oSettings._iTotalPages - 1;
                break;
            default:
                sPage = sPage - 1;
                break;
    ...
    'fnUpdate': function(oSettings, fnCallbackDraw) {
        ...
        for (i = oSettings._iFirstPage; i <= oSettings._iLastPage; i++) {
            ...
            if (oSettings._iCurrentPage === i) {
                ...
                oNumber.click({ 'fnCallbackDraw': fnCallbackDraw, 'oSettings': oSettings, 'sPage': i }, that.fnClickHandler);
            }
