(
    function () {
        ...
        var getRefreshUrl = 'https://admin.idr.seamlessgateway.t1t.in/whl_bti_service_api/refresh';  //must be https and return format is {"status":"success","balance":"100.00"} or {"status":"failure","balance":"0"} 
