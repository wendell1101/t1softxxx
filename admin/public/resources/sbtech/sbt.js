...
whl.prototype.status = function (callback) {
    ...
    $.ajax({
        type: "POST",
        url: "https://l8b8mlgb8.lebo.t1t.in/callback/game/484/status?r=" + new Date().getTime(),
        data: { token: strToken },
        crossDomain: true,
        contentType: "jsonp",
        dataType: "jsonp",
...
whl.prototype.refreshSession = function (callback) {
    ...
    $.ajax({
        type: "POST",
        url: "https://l8b8mlgb8.lebo.t1t.in/callback/game/484/refresh_session?r=" + new Date().getTime(),
        data: { token: strToken },
        crossDomain: true,
        contentType: "jsonp",
        dataType: "jsonp",
