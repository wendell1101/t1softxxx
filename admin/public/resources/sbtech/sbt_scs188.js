...
whl.prototype.status = function (callback) {
    ...
    $.ajax({
        type: "POST",
        url: "https://admin.scs188.t1t.in/callback/game/969/status?r=" + new Date().getTime(),
        data: { token: strToken },
        crossDomain: true,
        contentType: "jsonp",
        dataType: "jsonp",
...
whl.prototype.refreshSession = function (callback) {
    ...
    $.ajax({
        type: "POST",
        url: "https://admin.scs188.t1t.in/callback/game/969/refresh_session?r=" + new Date().getTime(),
        data: { token: strToken },
        crossDomain: true,
        contentType: "jsonp",
        dataType: "jsonp",
