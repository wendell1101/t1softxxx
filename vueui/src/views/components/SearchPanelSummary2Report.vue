<template>
  <div>
    ...
    <el-row :gutter="10">
      ...
      <el-col :span="2">
        <el-button @click="handleExport">{{ $t('normal.exportCSV') }}</el-button>
      </el-col>
    </el-row>
  </div>
</template>
...
<script>
export default {
  name: 'SearchPanelSummary2Report',
  props: {
    reportType: String,
  },
  methods: {
    handleExport() {
      this.$log('export csv', this.searchDate);
      ...
      this.$store.dispatch('remoteExportSuperReport', {
